...
const file_chalk_expression_v1_expression_proto_rawDesc = "" +
	...
	"blockingFn\x12B\n" +
	"\targuments\x18\x02 \x03(\v2$.chalk.expression.v1.LogicalExprNodeR\targuments\"d\n" +
	"\x10BlockingFunction\x12E\n" +
	"\fcatalog_call\x18\x01 \x01(\v2 .chalk.expression.v1.CatalogCallH\x00R\vcatalogCallB\t\n" +
	"\afn_type\"\xac\x01\n" +
	"\vCatalogCall\x12%\n" +
...
var file_chalk_expression_v1_expression_proto_msgTypes = make([]protoimpl.MessageInfo, 59)
var file_chalk_expression_v1_expression_proto_goTypes = []any{
	...
	(*ExprLiteral)(nil),           // 15: chalk.expression.v1.ExprLiteral
	(*LogicalExprNode)(nil),       // 16: chalk.expression.v1.LogicalExprNode
	(*ColumnRelation)(nil),        // 17: chalk.expression.v1.ColumnRelation
	(*Column)(nil),                // 18: chalk.expression.v1.Column
	(*Wildcard)(nil),              // 19: chalk.expression.v1.Wildcard
	(*PlaceholderNode)(nil),       // 20: chalk.expression.v1.PlaceholderNode
	(*LogicalExprList)(nil),       // 21: chalk.expression.v1.LogicalExprList
	(*GroupingSetNode)(nil),       // 22: chalk.expression.v1.GroupingSetNode
	(*CubeNode)(nil),              // 23: chalk.expression.v1.CubeNode
	(*RollupNode)(nil),            // 24: chalk.expression.v1.RollupNode
	(*NamedStructField)(nil),      // 25: chalk.expression.v1.NamedStructField
	(*ListIndex)(nil),             // 26: chalk.expression.v1.ListIndex
	(*ListRange)(nil),             // 27: chalk.expression.v1.ListRange
	(*GetIndexedField)(nil),       // 28: chalk.expression.v1.GetIndexedField
	(*IsNull)(nil),                // 29: chalk.expression.v1.IsNull
	(*IsNotNull)(nil),             // 30: chalk.expression.v1.IsNotNull
	(*IsTrue)(nil),                // 31: chalk.expression.v1.IsTrue
	(*IsFalse)(nil),               // 32: chalk.expression.v1.IsFalse
	(*IsUnknown)(nil),             // 33: chalk.expression.v1.IsUnknown
	(*IsNotTrue)(nil),             // 34: chalk.expression.v1.IsNotTrue
	(*IsNotFalse)(nil),            // 35: chalk.expression.v1.IsNotFalse
	(*IsNotUnknown)(nil),          // 36: chalk.expression.v1.IsNotUnknown
	(*Not)(nil),                   // 37: chalk.expression.v1.Not
	(*AliasNode)(nil),             // 38: chalk.expression.v1.AliasNode
	(*BareTableReference)(nil),    // 39: chalk.expression.v1.BareTableReference
	(*PartialTableReference)(nil), // 40: chalk.expression.v1.PartialTableReference
	(*FullTableReference)(nil),    // 41: chalk.expression.v1.FullTableReference
	(*OwnedTableReference)(nil),   // 42: chalk.expression.v1.OwnedTableReference
	(*BinaryExprNode)(nil),        // 43: chalk.expression.v1.BinaryExprNode
	(*NegativeNode)(nil),          // 44: chalk.expression.v1.NegativeNode
	(*InListNode)(nil),            // 45: chalk.expression.v1.InListNode
	(*ScalarFunctionNode)(nil),    // 46: chalk.expression.v1.ScalarFunctionNode
	(*AggregateExprNode)(nil),     // 47: chalk.expression.v1.AggregateExprNode
	(*AggregateUDFExprNode)(nil),  // 48: chalk.expression.v1.AggregateUDFExprNode
	(*ScalarUDFExprNode)(nil),     // 49: chalk.expression.v1.ScalarUDFExprNode
	(*WindowExprNode)(nil),        // 50: chalk.expression.v1.WindowExprNode
	(*BetweenNode)(nil),           // 51: chalk.expression.v1.BetweenNode
	(*LikeNode)(nil),              // 52: chalk.expression.v1.LikeNode
	(*ILikeNode)(nil),             // 53: chalk.expression.v1.ILikeNode
	(*SimilarToNode)(nil),         // 54: chalk.expression.v1.SimilarToNode
	(*CaseNode)(nil),              // 55: chalk.expression.v1.CaseNode
	(*WhenThen)(nil),              // 56: chalk.expression.v1.WhenThen
	(*CastNode)(nil),              // 57: chalk.expression.v1.CastNode
	(*TryCastNode)(nil),           // 58: chalk.expression.v1.TryCastNode
	(*SortExprNode)(nil),          // 59: chalk.expression.v1.SortExprNode
	(*WindowFrame)(nil),           // 60: chalk.expression.v1.WindowFrame
	(*WindowFrameBound)(nil),      // 61: chalk.expression.v1.WindowFrameBound
	nil,                           // 62: chalk.expression.v1.ExprCall.KwargsEntry
	nil,                           // 63: chalk.expression.v1.ExprPolicy.ParamsEntry
	nil,                           // 64: chalk.expression.v1.AggregateUDFExprNode.KwargsEntry
	(*v1.ArrowType)(nil),          // 65: chalk.arrow.v1.ArrowType
	(*v1.ScalarValue)(nil),        // 66: chalk.arrow.v1.ScalarValue
}
var file_chalk_expression_v1_expression_proto_depIdxs = []int32{
	65,  // 0: chalk.expression.v1.TypedIdentifier.type:type_name -> chalk.arrow.v1.ArrowType
	16,  // 1: chalk.expression.v1.ExprGetAttribute.parent:type_name -> chalk.expression.v1.LogicalExprNode
	6,   // 2: chalk.expression.v1.ExprGetAttribute.attribute:type_name -> chalk.expression.v1.Identifier
	16,  // 3: chalk.expression.v1.ExprGetSubscript.parent:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 4: chalk.expression.v1.ExprGetSubscript.subscript:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 5: chalk.expression.v1.ExprCall.func:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 6: chalk.expression.v1.ExprCall.args:type_name -> chalk.expression.v1.LogicalExprNode
	62,  // 7: chalk.expression.v1.ExprCall.kwargs:type_name -> chalk.expression.v1.ExprCall.KwargsEntry
	...
	63,  // 10: chalk.expression.v1.ExprPolicy.params:type_name -> chalk.expression.v1.ExprPolicy.ParamsEntry
	13,  // 11: chalk.expression.v1.ExprBlockingCall.blocking_fn:type_name -> chalk.expression.v1.BlockingFunction
	16,  // 12: chalk.expression.v1.ExprBlockingCall.arguments:type_name -> chalk.expression.v1.LogicalExprNode
	14,  // 13: chalk.expression.v1.BlockingFunction.catalog_call:type_name -> chalk.expression.v1.CatalogCall
	65,  // 14: chalk.expression.v1.CatalogCall.input_types:type_name -> chalk.arrow.v1.ArrowType
	65,  // 15: chalk.expression.v1.CatalogCall.output_type:type_name -> chalk.arrow.v1.ArrowType
	66,  // 16: chalk.expression.v1.ExprLiteral.value:type_name -> chalk.arrow.v1.ScalarValue
	6,   // 17: chalk.expression.v1.LogicalExprNode.identifier:type_name -> chalk.expression.v1.Identifier
	8,   // 18: chalk.expression.v1.LogicalExprNode.get_attribute:type_name -> chalk.expression.v1.ExprGetAttribute
	9,   // 19: chalk.expression.v1.LogicalExprNode.get_subscript:type_name -> chalk.expression.v1.ExprGetSubscript
	10,  // 20: chalk.expression.v1.LogicalExprNode.call:type_name -> chalk.expression.v1.ExprCall
	15,  // 21: chalk.expression.v1.LogicalExprNode.literal_value:type_name -> chalk.expression.v1.ExprLiteral
	7,   // 22: chalk.expression.v1.LogicalExprNode.typed_identifier:type_name -> chalk.expression.v1.TypedIdentifier
	12,  // 23: chalk.expression.v1.LogicalExprNode.blocking_call:type_name -> chalk.expression.v1.ExprBlockingCall
	18,  // 24: chalk.expression.v1.LogicalExprNode.column:type_name -> chalk.expression.v1.Column
	38,  // 25: chalk.expression.v1.LogicalExprNode.alias:type_name -> chalk.expression.v1.AliasNode
	66,  // 26: chalk.expression.v1.LogicalExprNode.literal:type_name -> chalk.arrow.v1.ScalarValue
	43,  // 27: chalk.expression.v1.LogicalExprNode.binary_expr:type_name -> chalk.expression.v1.BinaryExprNode
	47,  // 28: chalk.expression.v1.LogicalExprNode.aggregate_expr:type_name -> chalk.expression.v1.AggregateExprNode
	29,  // 29: chalk.expression.v1.LogicalExprNode.is_null_expr:type_name -> chalk.expression.v1.IsNull
	30,  // 30: chalk.expression.v1.LogicalExprNode.is_not_null_expr:type_name -> chalk.expression.v1.IsNotNull
	37,  // 31: chalk.expression.v1.LogicalExprNode.not_expr:type_name -> chalk.expression.v1.Not
	51,  // 32: chalk.expression.v1.LogicalExprNode.between:type_name -> chalk.expression.v1.BetweenNode
	55,  // 33: chalk.expression.v1.LogicalExprNode.case:type_name -> chalk.expression.v1.CaseNode
	57,  // 34: chalk.expression.v1.LogicalExprNode.cast:type_name -> chalk.expression.v1.CastNode
	59,  // 35: chalk.expression.v1.LogicalExprNode.sort:type_name -> chalk.expression.v1.SortExprNode
	44,  // 36: chalk.expression.v1.LogicalExprNode.negative:type_name -> chalk.expression.v1.NegativeNode
	45,  // 37: chalk.expression.v1.LogicalExprNode.in_list:type_name -> chalk.expression.v1.InListNode
	19,  // 38: chalk.expression.v1.LogicalExprNode.wildcard:type_name -> chalk.expression.v1.Wildcard
	46,  // 39: chalk.expression.v1.LogicalExprNode.scalar_function:type_name -> chalk.expression.v1.ScalarFunctionNode
	58,  // 40: chalk.expression.v1.LogicalExprNode.try_cast:type_name -> chalk.expression.v1.TryCastNode
	50,  // 41: chalk.expression.v1.LogicalExprNode.window_expr:type_name -> chalk.expression.v1.WindowExprNode
	48,  // 42: chalk.expression.v1.LogicalExprNode.aggregate_udf_expr:type_name -> chalk.expression.v1.AggregateUDFExprNode
	49,  // 43: chalk.expression.v1.LogicalExprNode.scalar_udf_expr:type_name -> chalk.expression.v1.ScalarUDFExprNode
	28,  // 44: chalk.expression.v1.LogicalExprNode.get_indexed_field:type_name -> chalk.expression.v1.GetIndexedField
	22,  // 45: chalk.expression.v1.LogicalExprNode.grouping_set:type_name -> chalk.expression.v1.GroupingSetNode
	23,  // 46: chalk.expression.v1.LogicalExprNode.cube:type_name -> chalk.expression.v1.CubeNode
	24,  // 47: chalk.expression.v1.LogicalExprNode.rollup:type_name -> chalk.expression.v1.RollupNode
	31,  // 48: chalk.expression.v1.LogicalExprNode.is_true:type_name -> chalk.expression.v1.IsTrue
	32,  // 49: chalk.expression.v1.LogicalExprNode.is_false:type_name -> chalk.expression.v1.IsFalse
	33,  // 50: chalk.expression.v1.LogicalExprNode.is_unknown:type_name -> chalk.expression.v1.IsUnknown
	34,  // 51: chalk.expression.v1.LogicalExprNode.is_not_true:type_name -> chalk.expression.v1.IsNotTrue
	35,  // 52: chalk.expression.v1.LogicalExprNode.is_not_false:type_name -> chalk.expression.v1.IsNotFalse
	36,  // 53: chalk.expression.v1.LogicalExprNode.is_not_unknown:type_name -> chalk.expression.v1.IsNotUnknown
	52,  // 54: chalk.expression.v1.LogicalExprNode.like:type_name -> chalk.expression.v1.LikeNode
	53,  // 55: chalk.expression.v1.LogicalExprNode.ilike:type_name -> chalk.expression.v1.ILikeNode
	54,  // 56: chalk.expression.v1.LogicalExprNode.similar_to:type_name -> chalk.expression.v1.SimilarToNode
	20,  // 57: chalk.expression.v1.LogicalExprNode.placeholder:type_name -> chalk.expression.v1.PlaceholderNode
	17,  // 58: chalk.expression.v1.Column.relation:type_name -> chalk.expression.v1.ColumnRelation
	65,  // 59: chalk.expression.v1.PlaceholderNode.data_type:type_name -> chalk.arrow.v1.ArrowType
	16,  // 60: chalk.expression.v1.LogicalExprList.expr:type_name -> chalk.expression.v1.LogicalExprNode
	21,  // 61: chalk.expression.v1.GroupingSetNode.expr:type_name -> chalk.expression.v1.LogicalExprList
	16,  // 62: chalk.expression.v1.CubeNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 63: chalk.expression.v1.RollupNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	66,  // 64: chalk.expression.v1.NamedStructField.name:type_name -> chalk.arrow.v1.ScalarValue
	16,  // 65: chalk.expression.v1.ListIndex.key:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 66: chalk.expression.v1.ListRange.start:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 67: chalk.expression.v1.ListRange.stop:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 68: chalk.expression.v1.GetIndexedField.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 69: chalk.expression.v1.GetIndexedField.named_struct_field:type_name -> chalk.expression.v1.NamedStructField
	26,  // 70: chalk.expression.v1.GetIndexedField.list_index:type_name -> chalk.expression.v1.ListIndex
	27,  // 71: chalk.expression.v1.GetIndexedField.list_range:type_name -> chalk.expression.v1.ListRange
	16,  // 72: chalk.expression.v1.IsNull.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 73: chalk.expression.v1.IsNotNull.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 74: chalk.expression.v1.IsTrue.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 75: chalk.expression.v1.IsFalse.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 76: chalk.expression.v1.IsUnknown.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 77: chalk.expression.v1.IsNotTrue.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 78: chalk.expression.v1.IsNotFalse.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 79: chalk.expression.v1.IsNotUnknown.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 80: chalk.expression.v1.Not.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 81: chalk.expression.v1.AliasNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	42,  // 82: chalk.expression.v1.AliasNode.relation:type_name -> chalk.expression.v1.OwnedTableReference
	39,  // 83: chalk.expression.v1.OwnedTableReference.bare:type_name -> chalk.expression.v1.BareTableReference
	40,  // 84: chalk.expression.v1.OwnedTableReference.partial:type_name -> chalk.expression.v1.PartialTableReference
	41,  // 85: chalk.expression.v1.OwnedTableReference.full:type_name -> chalk.expression.v1.FullTableReference
	16,  // 86: chalk.expression.v1.BinaryExprNode.operands:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 87: chalk.expression.v1.NegativeNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 88: chalk.expression.v1.InListNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 89: chalk.expression.v1.InListNode.list:type_name -> chalk.expression.v1.LogicalExprNode
	1,   // 90: chalk.expression.v1.ScalarFunctionNode.fun:type_name -> chalk.expression.v1.ScalarFunction
	16,  // 91: chalk.expression.v1.ScalarFunctionNode.args:type_name -> chalk.expression.v1.LogicalExprNode
	2,   // 92: chalk.expression.v1.AggregateExprNode.aggr_function:type_name -> chalk.expression.v1.AggregateFunction
	16,  // 93: chalk.expression.v1.AggregateExprNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 94: chalk.expression.v1.AggregateExprNode.filter:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 95: chalk.expression.v1.AggregateExprNode.order_by:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 96: chalk.expression.v1.AggregateUDFExprNode.args:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 97: chalk.expression.v1.AggregateUDFExprNode.filter:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 98: chalk.expression.v1.AggregateUDFExprNode.order_by:type_name -> chalk.expression.v1.LogicalExprNode
	64,  // 99: chalk.expression.v1.AggregateUDFExprNode.kwargs:type_name -> chalk.expression.v1.AggregateUDFExprNode.KwargsEntry
	16,  // 100: chalk.expression.v1.ScalarUDFExprNode.args:type_name -> chalk.expression.v1.LogicalExprNode
	2,   // 101: chalk.expression.v1.WindowExprNode.aggr_function:type_name -> chalk.expression.v1.AggregateFunction
	3,   // 102: chalk.expression.v1.WindowExprNode.built_in_function:type_name -> chalk.expression.v1.BuiltInWindowFunction
	16,  // 103: chalk.expression.v1.WindowExprNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 104: chalk.expression.v1.WindowExprNode.partition_by:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 105: chalk.expression.v1.WindowExprNode.order_by:type_name -> chalk.expression.v1.LogicalExprNode
	60,  // 106: chalk.expression.v1.WindowExprNode.window_frame:type_name -> chalk.expression.v1.WindowFrame
	16,  // 107: chalk.expression.v1.BetweenNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 108: chalk.expression.v1.BetweenNode.low:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 109: chalk.expression.v1.BetweenNode.high:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 110: chalk.expression.v1.LikeNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 111: chalk.expression.v1.LikeNode.pattern:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 112: chalk.expression.v1.ILikeNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 113: chalk.expression.v1.ILikeNode.pattern:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 114: chalk.expression.v1.SimilarToNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 115: chalk.expression.v1.SimilarToNode.pattern:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 116: chalk.expression.v1.CaseNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	56,  // 117: chalk.expression.v1.CaseNode.when_then_expr:type_name -> chalk.expression.v1.WhenThen
	16,  // 118: chalk.expression.v1.CaseNode.else_expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 119: chalk.expression.v1.WhenThen.when_expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 120: chalk.expression.v1.WhenThen.then_expr:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 121: chalk.expression.v1.CastNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	65,  // 122: chalk.expression.v1.CastNode.arrow_type:type_name -> chalk.arrow.v1.ArrowType
	16,  // 123: chalk.expression.v1.TryCastNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	65,  // 124: chalk.expression.v1.TryCastNode.arrow_type:type_name -> chalk.arrow.v1.ArrowType
	16,  // 125: chalk.expression.v1.SortExprNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	4,   // 126: chalk.expression.v1.WindowFrame.window_frame_units:type_name -> chalk.expression.v1.WindowFrameUnits
	61,  // 127: chalk.expression.v1.WindowFrame.start_bound:type_name -> chalk.expression.v1.WindowFrameBound
	61,  // 128: chalk.expression.v1.WindowFrame.bound:type_name -> chalk.expression.v1.WindowFrameBound
	5,   // 129: chalk.expression.v1.WindowFrameBound.window_frame_bound_type:type_name -> chalk.expression.v1.WindowFrameBoundType
	66,  // 130: chalk.expression.v1.WindowFrameBound.bound_value:type_name -> chalk.arrow.v1.ScalarValue
	16,  // 131: chalk.expression.v1.ExprCall.KwargsEntry.value:type_name -> chalk.expression.v1.LogicalExprNode
	16,  // 132: chalk.expression.v1.AggregateUDFExprNode.KwargsEntry.value:type_name -> chalk.expression.v1.LogicalExprNode
...
func file_chalk_expression_v1_expression_proto_init() {
	...
	file_chalk_expression_v1_expression_proto_msgTypes[10].OneofWrappers = []any{
