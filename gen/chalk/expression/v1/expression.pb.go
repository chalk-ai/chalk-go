...
type ExprCall struct {
	...
	// Blocking expression policies (concurrency, rate limiting, retry, logging, cache).
...
const file_chalk_expression_v1_expression_proto_rawDesc = "" +
	...
	"\x10ExprBlockingCall\x12F\n" +
	"\vblocking_fn\x18\x01 \x01(\v2%.chalk.expression.v1.BlockingFunctionR\n" +
	"blockingFn\x12B\n" +
	"\targuments\x18\x02 \x03(\v2$.chalk.expression.v1.LogicalExprNodeR\targuments\"\xf5\x01\n" +
	...
	"\fhttp_request\x18\x03 \x01(\v2 .chalk.expression.v1.HttpRequestH\x00R\vhttpRequestB\t\n" +
	"\afn_type\"\r\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12;\n" +
	"\x05value\x18\x02 \x01(\v2%.chalk.expression.v1.BatchUDFArgumentR\x05value:\x028\x01\"\x9f\x03\n" +
	...
	"ItemsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12;\n" +
	"\x05value\x18\x02 \x01(\v2%.chalk.expression.v1.BatchUDFArgumentR\x05value:\x028\x01\"\xc5\x01\n" +
	"\bPyObject\x12B\n" +
	...
	"\tpy_string\x18\x04 \x01(\tH\x00R\bpyStringB\x05\n" +
	"\x03obj\"1\n" +
	"\n" +
	"PyCallable\x12#\n" +
	"\rcallable_name\x18\x01 \x01(\tR\fcallableName\"\x8d\x02\n" +
	"\x06PyCall\x125\n" +
	...
	"\x16EXPR_POLICY_KIND_CACHE\x10\x05*\xa0\x1f\n" +
...
var file_chalk_expression_v1_expression_proto_msgTypes = make([]protoimpl.MessageInfo, 71)
var file_chalk_expression_v1_expression_proto_goTypes = []any{
	...
	(*HttpRequest)(nil),           // 14: chalk.expression.v1.HttpRequest
	(*CatalogCall)(nil),           // 15: chalk.expression.v1.CatalogCall
	(*CallResolver)(nil),          // 16: chalk.expression.v1.CallResolver
	(*BatchUDF)(nil),              // 17: chalk.expression.v1.BatchUDF
	(*BatchUDFArgument)(nil),      // 18: chalk.expression.v1.BatchUDFArgument
	(*BatchUDFArgumentList)(nil),  // 19: chalk.expression.v1.BatchUDFArgumentList
	(*BatchUDFUnorderedDict)(nil), // 20: chalk.expression.v1.BatchUDFUnorderedDict
	(*PyObject)(nil),              // 21: chalk.expression.v1.PyObject
	(*PyCallable)(nil),            // 22: chalk.expression.v1.PyCallable
	(*PyCall)(nil),                // 23: chalk.expression.v1.PyCall
	(*ExprLiteral)(nil),           // 24: chalk.expression.v1.ExprLiteral
	(*LogicalExprNode)(nil),       // 25: chalk.expression.v1.LogicalExprNode
	(*ColumnRelation)(nil),        // 26: chalk.expression.v1.ColumnRelation
	(*Column)(nil),                // 27: chalk.expression.v1.Column
	(*Wildcard)(nil),              // 28: chalk.expression.v1.Wildcard
	(*PlaceholderNode)(nil),       // 29: chalk.expression.v1.PlaceholderNode
	(*LogicalExprList)(nil),       // 30: chalk.expression.v1.LogicalExprList
	(*GroupingSetNode)(nil),       // 31: chalk.expression.v1.GroupingSetNode
	(*CubeNode)(nil),              // 32: chalk.expression.v1.CubeNode
	(*RollupNode)(nil),            // 33: chalk.expression.v1.RollupNode
	(*NamedStructField)(nil),      // 34: chalk.expression.v1.NamedStructField
	(*ListIndex)(nil),             // 35: chalk.expression.v1.ListIndex
	(*ListRange)(nil),             // 36: chalk.expression.v1.ListRange
	(*GetIndexedField)(nil),       // 37: chalk.expression.v1.GetIndexedField
	(*IsNull)(nil),                // 38: chalk.expression.v1.IsNull
	(*IsNotNull)(nil),             // 39: chalk.expression.v1.IsNotNull
	(*IsTrue)(nil),                // 40: chalk.expression.v1.IsTrue
	(*IsFalse)(nil),               // 41: chalk.expression.v1.IsFalse
	(*IsUnknown)(nil),             // 42: chalk.expression.v1.IsUnknown
	(*IsNotTrue)(nil),             // 43: chalk.expression.v1.IsNotTrue
	(*IsNotFalse)(nil),            // 44: chalk.expression.v1.IsNotFalse
	(*IsNotUnknown)(nil),          // 45: chalk.expression.v1.IsNotUnknown
	(*Not)(nil),                   // 46: chalk.expression.v1.Not
	(*AliasNode)(nil),             // 47: chalk.expression.v1.AliasNode
	(*BareTableReference)(nil),    // 48: chalk.expression.v1.BareTableReference
	(*PartialTableReference)(nil), // 49: chalk.expression.v1.PartialTableReference
	(*FullTableReference)(nil),    // 50: chalk.expression.v1.FullTableReference
	(*OwnedTableReference)(nil),   // 51: chalk.expression.v1.OwnedTableReference
	(*BinaryExprNode)(nil),        // 52: chalk.expression.v1.BinaryExprNode
	(*NegativeNode)(nil),          // 53: chalk.expression.v1.NegativeNode
	(*InListNode)(nil),            // 54: chalk.expression.v1.InListNode
	(*ScalarFunctionNode)(nil),    // 55: chalk.expression.v1.ScalarFunctionNode
	(*AggregateExprNode)(nil),     // 56: chalk.expression.v1.AggregateExprNode
	(*AggregateUDFExprNode)(nil),  // 57: chalk.expression.v1.AggregateUDFExprNode
	(*ScalarUDFExprNode)(nil),     // 58: chalk.expression.v1.ScalarUDFExprNode
	(*WindowExprNode)(nil),        // 59: chalk.expression.v1.WindowExprNode
	(*BetweenNode)(nil),           // 60: chalk.expression.v1.BetweenNode
	(*LikeNode)(nil),              // 61: chalk.expression.v1.LikeNode
	(*ILikeNode)(nil),             // 62: chalk.expression.v1.ILikeNode
	(*SimilarToNode)(nil),         // 63: chalk.expression.v1.SimilarToNode
	(*CaseNode)(nil),              // 64: chalk.expression.v1.CaseNode
	(*WhenThen)(nil),              // 65: chalk.expression.v1.WhenThen
	(*CastNode)(nil),              // 66: chalk.expression.v1.CastNode
	(*TryCastNode)(nil),           // 67: chalk.expression.v1.TryCastNode
	(*SortExprNode)(nil),          // 68: chalk.expression.v1.SortExprNode
	(*WindowFrame)(nil),           // 69: chalk.expression.v1.WindowFrame
	(*WindowFrameBound)(nil),      // 70: chalk.expression.v1.WindowFrameBound
	nil,                           // 71: chalk.expression.v1.ExprCall.KwargsEntry
	nil,                           // 72: chalk.expression.v1.ExprPolicy.ParamsEntry
	nil,                           // 73: chalk.expression.v1.BatchUDF.ArgumentsEntry
	nil,                           // 74: chalk.expression.v1.BatchUDFUnorderedDict.ItemsEntry
	nil,                           // 75: chalk.expression.v1.PyCall.KwargsEntry
	nil,                           // 76: chalk.expression.v1.AggregateUDFExprNode.KwargsEntry
	(*v1.ArrowType)(nil),          // 77: chalk.arrow.v1.ArrowType
	(*v11.Primitive)(nil),         // 78: chalk.primitive.v1.Primitive
	(*v1.ScalarValue)(nil),        // 79: chalk.arrow.v1.ScalarValue
}
var file_chalk_expression_v1_expression_proto_depIdxs = []int32{
	77,  // 0: chalk.expression.v1.TypedIdentifier.type:type_name -> chalk.arrow.v1.ArrowType
	25,  // 1: chalk.expression.v1.ExprGetAttribute.parent:type_name -> chalk.expression.v1.LogicalExprNode
	6,   // 2: chalk.expression.v1.ExprGetAttribute.attribute:type_name -> chalk.expression.v1.Identifier
	25,  // 3: chalk.expression.v1.ExprGetSubscript.parent:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 4: chalk.expression.v1.ExprGetSubscript.subscript:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 5: chalk.expression.v1.ExprCall.func:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 6: chalk.expression.v1.ExprCall.args:type_name -> chalk.expression.v1.LogicalExprNode
	71,  // 7: chalk.expression.v1.ExprCall.kwargs:type_name -> chalk.expression.v1.ExprCall.KwargsEntry
	...
	72,  // 10: chalk.expression.v1.ExprPolicy.params:type_name -> chalk.expression.v1.ExprPolicy.ParamsEntry
	13,  // 11: chalk.expression.v1.ExprBlockingCall.blocking_fn:type_name -> chalk.expression.v1.BlockingFunction
	25,  // 12: chalk.expression.v1.ExprBlockingCall.arguments:type_name -> chalk.expression.v1.LogicalExprNode
	15,  // 13: chalk.expression.v1.BlockingFunction.catalog_call:type_name -> chalk.expression.v1.CatalogCall
	16,  // 14: chalk.expression.v1.BlockingFunction.call_resolver:type_name -> chalk.expression.v1.CallResolver
	14,  // 15: chalk.expression.v1.BlockingFunction.http_request:type_name -> chalk.expression.v1.HttpRequest
	77,  // 16: chalk.expression.v1.CatalogCall.input_types:type_name -> chalk.arrow.v1.ArrowType
	77,  // 17: chalk.expression.v1.CatalogCall.output_type:type_name -> chalk.arrow.v1.ArrowType
	77,  // 18: chalk.expression.v1.CallResolver.output_type:type_name -> chalk.arrow.v1.ArrowType
	73,  // 19: chalk.expression.v1.BatchUDF.arguments:type_name -> chalk.expression.v1.BatchUDF.ArgumentsEntry
	78,  // 20: chalk.expression.v1.BatchUDFArgument.primitive_value:type_name -> chalk.primitive.v1.Primitive
	25,  // 21: chalk.expression.v1.BatchUDFArgument.expr_value:type_name -> chalk.expression.v1.LogicalExprNode
	21,  // 22: chalk.expression.v1.BatchUDFArgument.py_object_value:type_name -> chalk.expression.v1.PyObject
	19,  // 23: chalk.expression.v1.BatchUDFArgument.list_value:type_name -> chalk.expression.v1.BatchUDFArgumentList
	20,  // 24: chalk.expression.v1.BatchUDFArgument.unordered_dict_value:type_name -> chalk.expression.v1.BatchUDFUnorderedDict
	18,  // 25: chalk.expression.v1.BatchUDFArgumentList.values:type_name -> chalk.expression.v1.BatchUDFArgument
	74,  // 26: chalk.expression.v1.BatchUDFUnorderedDict.items:type_name -> chalk.expression.v1.BatchUDFUnorderedDict.ItemsEntry
	22,  // 27: chalk.expression.v1.PyObject.py_callable:type_name -> chalk.expression.v1.PyCallable
	23,  // 28: chalk.expression.v1.PyObject.py_call:type_name -> chalk.expression.v1.PyCall
	21,  // 29: chalk.expression.v1.PyCall.callee:type_name -> chalk.expression.v1.PyObject
	21,  // 30: chalk.expression.v1.PyCall.args:type_name -> chalk.expression.v1.PyObject
	75,  // 31: chalk.expression.v1.PyCall.kwargs:type_name -> chalk.expression.v1.PyCall.KwargsEntry
	79,  // 32: chalk.expression.v1.ExprLiteral.value:type_name -> chalk.arrow.v1.ScalarValue
	6,   // 33: chalk.expression.v1.LogicalExprNode.identifier:type_name -> chalk.expression.v1.Identifier
	8,   // 34: chalk.expression.v1.LogicalExprNode.get_attribute:type_name -> chalk.expression.v1.ExprGetAttribute
	9,   // 35: chalk.expression.v1.LogicalExprNode.get_subscript:type_name -> chalk.expression.v1.ExprGetSubscript
	10,  // 36: chalk.expression.v1.LogicalExprNode.call:type_name -> chalk.expression.v1.ExprCall
	24,  // 37: chalk.expression.v1.LogicalExprNode.literal_value:type_name -> chalk.expression.v1.ExprLiteral
	7,   // 38: chalk.expression.v1.LogicalExprNode.typed_identifier:type_name -> chalk.expression.v1.TypedIdentifier
	12,  // 39: chalk.expression.v1.LogicalExprNode.blocking_call:type_name -> chalk.expression.v1.ExprBlockingCall
	27,  // 40: chalk.expression.v1.LogicalExprNode.column:type_name -> chalk.expression.v1.Column
	47,  // 41: chalk.expression.v1.LogicalExprNode.alias:type_name -> chalk.expression.v1.AliasNode
	79,  // 42: chalk.expression.v1.LogicalExprNode.literal:type_name -> chalk.arrow.v1.ScalarValue
	52,  // 43: chalk.expression.v1.LogicalExprNode.binary_expr:type_name -> chalk.expression.v1.BinaryExprNode
	56,  // 44: chalk.expression.v1.LogicalExprNode.aggregate_expr:type_name -> chalk.expression.v1.AggregateExprNode
	38,  // 45: chalk.expression.v1.LogicalExprNode.is_null_expr:type_name -> chalk.expression.v1.IsNull
	39,  // 46: chalk.expression.v1.LogicalExprNode.is_not_null_expr:type_name -> chalk.expression.v1.IsNotNull
	46,  // 47: chalk.expression.v1.LogicalExprNode.not_expr:type_name -> chalk.expression.v1.Not
	60,  // 48: chalk.expression.v1.LogicalExprNode.between:type_name -> chalk.expression.v1.BetweenNode
	64,  // 49: chalk.expression.v1.LogicalExprNode.case:type_name -> chalk.expression.v1.CaseNode
	66,  // 50: chalk.expression.v1.LogicalExprNode.cast:type_name -> chalk.expression.v1.CastNode
	68,  // 51: chalk.expression.v1.LogicalExprNode.sort:type_name -> chalk.expression.v1.SortExprNode
	53,  // 52: chalk.expression.v1.LogicalExprNode.negative:type_name -> chalk.expression.v1.NegativeNode
	54,  // 53: chalk.expression.v1.LogicalExprNode.in_list:type_name -> chalk.expression.v1.InListNode
	28,  // 54: chalk.expression.v1.LogicalExprNode.wildcard:type_name -> chalk.expression.v1.Wildcard
	55,  // 55: chalk.expression.v1.LogicalExprNode.scalar_function:type_name -> chalk.expression.v1.ScalarFunctionNode
	67,  // 56: chalk.expression.v1.LogicalExprNode.try_cast:type_name -> chalk.expression.v1.TryCastNode
	59,  // 57: chalk.expression.v1.LogicalExprNode.window_expr:type_name -> chalk.expression.v1.WindowExprNode
	57,  // 58: chalk.expression.v1.LogicalExprNode.aggregate_udf_expr:type_name -> chalk.expression.v1.AggregateUDFExprNode
	58,  // 59: chalk.expression.v1.LogicalExprNode.scalar_udf_expr:type_name -> chalk.expression.v1.ScalarUDFExprNode
	37,  // 60: chalk.expression.v1.LogicalExprNode.get_indexed_field:type_name -> chalk.expression.v1.GetIndexedField
	31,  // 61: chalk.expression.v1.LogicalExprNode.grouping_set:type_name -> chalk.expression.v1.GroupingSetNode
	32,  // 62: chalk.expression.v1.LogicalExprNode.cube:type_name -> chalk.expression.v1.CubeNode
	33,  // 63: chalk.expression.v1.LogicalExprNode.rollup:type_name -> chalk.expression.v1.RollupNode
	40,  // 64: chalk.expression.v1.LogicalExprNode.is_true:type_name -> chalk.expression.v1.IsTrue
	41,  // 65: chalk.expression.v1.LogicalExprNode.is_false:type_name -> chalk.expression.v1.IsFalse
	42,  // 66: chalk.expression.v1.LogicalExprNode.is_unknown:type_name -> chalk.expression.v1.IsUnknown
	43,  // 67: chalk.expression.v1.LogicalExprNode.is_not_true:type_name -> chalk.expression.v1.IsNotTrue
	44,  // 68: chalk.expression.v1.LogicalExprNode.is_not_false:type_name -> chalk.expression.v1.IsNotFalse
	45,  // 69: chalk.expression.v1.LogicalExprNode.is_not_unknown:type_name -> chalk.expression.v1.IsNotUnknown
	61,  // 70: chalk.expression.v1.LogicalExprNode.like:type_name -> chalk.expression.v1.LikeNode
	62,  // 71: chalk.expression.v1.LogicalExprNode.ilike:type_name -> chalk.expression.v1.ILikeNode
	63,  // 72: chalk.expression.v1.LogicalExprNode.similar_to:type_name -> chalk.expression.v1.SimilarToNode
	29,  // 73: chalk.expression.v1.LogicalExprNode.placeholder:type_name -> chalk.expression.v1.PlaceholderNode
	26,  // 74: chalk.expression.v1.Column.relation:type_name -> chalk.expression.v1.ColumnRelation
	77,  // 75: chalk.expression.v1.PlaceholderNode.data_type:type_name -> chalk.arrow.v1.ArrowType
	25,  // 76: chalk.expression.v1.LogicalExprList.expr:type_name -> chalk.expression.v1.LogicalExprNode
	30,  // 77: chalk.expression.v1.GroupingSetNode.expr:type_name -> chalk.expression.v1.LogicalExprList
	25,  // 78: chalk.expression.v1.CubeNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 79: chalk.expression.v1.RollupNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	79,  // 80: chalk.expression.v1.NamedStructField.name:type_name -> chalk.arrow.v1.ScalarValue
	25,  // 81: chalk.expression.v1.ListIndex.key:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 82: chalk.expression.v1.ListRange.start:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 83: chalk.expression.v1.ListRange.stop:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 84: chalk.expression.v1.GetIndexedField.expr:type_name -> chalk.expression.v1.LogicalExprNode
	34,  // 85: chalk.expression.v1.GetIndexedField.named_struct_field:type_name -> chalk.expression.v1.NamedStructField
	35,  // 86: chalk.expression.v1.GetIndexedField.list_index:type_name -> chalk.expression.v1.ListIndex
	36,  // 87: chalk.expression.v1.GetIndexedField.list_range:type_name -> chalk.expression.v1.ListRange
	25,  // 88: chalk.expression.v1.IsNull.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 89: chalk.expression.v1.IsNotNull.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 90: chalk.expression.v1.IsTrue.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 91: chalk.expression.v1.IsFalse.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 92: chalk.expression.v1.IsUnknown.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 93: chalk.expression.v1.IsNotTrue.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 94: chalk.expression.v1.IsNotFalse.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 95: chalk.expression.v1.IsNotUnknown.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 96: chalk.expression.v1.Not.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 97: chalk.expression.v1.AliasNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	51,  // 98: chalk.expression.v1.AliasNode.relation:type_name -> chalk.expression.v1.OwnedTableReference
	48,  // 99: chalk.expression.v1.OwnedTableReference.bare:type_name -> chalk.expression.v1.BareTableReference
	49,  // 100: chalk.expression.v1.OwnedTableReference.partial:type_name -> chalk.expression.v1.PartialTableReference
	50,  // 101: chalk.expression.v1.OwnedTableReference.full:type_name -> chalk.expression.v1.FullTableReference
	25,  // 102: chalk.expression.v1.BinaryExprNode.operands:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 103: chalk.expression.v1.NegativeNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 104: chalk.expression.v1.InListNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 105: chalk.expression.v1.InListNode.list:type_name -> chalk.expression.v1.LogicalExprNode
	1,   // 106: chalk.expression.v1.ScalarFunctionNode.fun:type_name -> chalk.expression.v1.ScalarFunction
	25,  // 107: chalk.expression.v1.ScalarFunctionNode.args:type_name -> chalk.expression.v1.LogicalExprNode
	2,   // 108: chalk.expression.v1.AggregateExprNode.aggr_function:type_name -> chalk.expression.v1.AggregateFunction
	25,  // 109: chalk.expression.v1.AggregateExprNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 110: chalk.expression.v1.AggregateExprNode.filter:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 111: chalk.expression.v1.AggregateExprNode.order_by:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 112: chalk.expression.v1.AggregateUDFExprNode.args:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 113: chalk.expression.v1.AggregateUDFExprNode.filter:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 114: chalk.expression.v1.AggregateUDFExprNode.order_by:type_name -> chalk.expression.v1.LogicalExprNode
	76,  // 115: chalk.expression.v1.AggregateUDFExprNode.kwargs:type_name -> chalk.expression.v1.AggregateUDFExprNode.KwargsEntry
	25,  // 116: chalk.expression.v1.ScalarUDFExprNode.args:type_name -> chalk.expression.v1.LogicalExprNode
	2,   // 117: chalk.expression.v1.WindowExprNode.aggr_function:type_name -> chalk.expression.v1.AggregateFunction
	3,   // 118: chalk.expression.v1.WindowExprNode.built_in_function:type_name -> chalk.expression.v1.BuiltInWindowFunction
	25,  // 119: chalk.expression.v1.WindowExprNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 120: chalk.expression.v1.WindowExprNode.partition_by:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 121: chalk.expression.v1.WindowExprNode.order_by:type_name -> chalk.expression.v1.LogicalExprNode
	69,  // 122: chalk.expression.v1.WindowExprNode.window_frame:type_name -> chalk.expression.v1.WindowFrame
	25,  // 123: chalk.expression.v1.BetweenNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 124: chalk.expression.v1.BetweenNode.low:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 125: chalk.expression.v1.BetweenNode.high:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 126: chalk.expression.v1.LikeNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 127: chalk.expression.v1.LikeNode.pattern:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 128: chalk.expression.v1.ILikeNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 129: chalk.expression.v1.ILikeNode.pattern:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 130: chalk.expression.v1.SimilarToNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 131: chalk.expression.v1.SimilarToNode.pattern:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 132: chalk.expression.v1.CaseNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	65,  // 133: chalk.expression.v1.CaseNode.when_then_expr:type_name -> chalk.expression.v1.WhenThen
	25,  // 134: chalk.expression.v1.CaseNode.else_expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 135: chalk.expression.v1.WhenThen.when_expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 136: chalk.expression.v1.WhenThen.then_expr:type_name -> chalk.expression.v1.LogicalExprNode
	25,  // 137: chalk.expression.v1.CastNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	77,  // 138: chalk.expression.v1.CastNode.arrow_type:type_name -> chalk.arrow.v1.ArrowType
	25,  // 139: chalk.expression.v1.TryCastNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	77,  // 140: chalk.expression.v1.TryCastNode.arrow_type:type_name -> chalk.arrow.v1.ArrowType
	25,  // 141: chalk.expression.v1.SortExprNode.expr:type_name -> chalk.expression.v1.LogicalExprNode
	4,   // 142: chalk.expression.v1.WindowFrame.window_frame_units:type_name -> chalk.expression.v1.WindowFrameUnits
	70,  // 143: chalk.expression.v1.WindowFrame.start_bound:type_name -> chalk.expression.v1.WindowFrameBound
	70,  // 144: chalk.expression.v1.WindowFrame.bound:type_name -> chalk.expression.v1.WindowFrameBound
	5,   // 145: chalk.expression.v1.WindowFrameBound.window_frame_bound_type:type_name -> chalk.expression.v1.WindowFrameBoundType
	79,  // 146: chalk.expression.v1.WindowFrameBound.bound_value:type_name -> chalk.arrow.v1.ScalarValue
	25,  // 147: chalk.expression.v1.ExprCall.KwargsEntry.value:type_name -> chalk.expression.v1.LogicalExprNode
	18,  // 148: chalk.expression.v1.BatchUDF.ArgumentsEntry.value:type_name -> chalk.expression.v1.BatchUDFArgument
	18,  // 149: chalk.expression.v1.BatchUDFUnorderedDict.ItemsEntry.value:type_name -> chalk.expression.v1.BatchUDFArgument
	21,  // 150: chalk.expression.v1.PyCall.KwargsEntry.value:type_name -> chalk.expression.v1.PyObject
	25,  // 151: chalk.expression.v1.AggregateUDFExprNode.KwargsEntry.value:type_name -> chalk.expression.v1.LogicalExprNode
...
func file_chalk_expression_v1_expression_proto_init() {
	...
	file_chalk_expression_v1_expression_proto_msgTypes[22].OneofWrappers = []any{}
	...
	file_chalk_expression_v1_expression_proto_msgTypes[63].OneofWrappers = []any{}
	type x struct{}
