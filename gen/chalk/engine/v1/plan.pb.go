...
const file_chalk_engine_v1_plan_proto_rawDesc = "" +
	"\n" +
	"\x1achalk/engine/v1/plan.proto\x12\x0fchalk.engine.v1\x1a\x1achalk/arrow/v1/arrow.proto\"\"\n" +
	"\fRawColumnKey\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\"-\n" +
	"\x10FeatureColumnKey\x12\x19\n" +
	"\broot_fqn\x18\x01 \x01(\tR\arootFqn\"Z\n" +
	"\x11HasManyFeatureKey\x12\x19\n" +
	"\broot_fqn\x18\x01 \x01(\tR\arootFqn\x12*\n" +
	"\x02df\x18\x02 \x01(\v2\x1a.chalk.engine.v1.DataFrameR\x02df\"h\n" +
	"\x13DataFrameFeatureKey\x12%\n" +
	"\x0eroot_namespace\x18\x01 \x01(\tR\rrootNamespace\x12*\n" +
	"\x02df\x18\x02 \x01(\v2\x1a.chalk.engine.v1.DataFrameR\x02df\"\xcc\x01\n" +
	"\tDataFrame\x12L\n" +
	"\x10optional_columns\x18\x01 \x03(\v2!.chalk.engine.v1.FeatureColumnKeyR\x0foptionalColumns\x12L\n" +
	"\x10required_columns\x18\x02 \x03(\v2!.chalk.engine.v1.FeatureColumnKeyR\x0frequiredColumns\x12\x19\n" +
	"\x05limit\x18\x03 \x01(\x04H\x00R\x05limit\x88\x01\x01B\b\n" +
	"\x06_limit\"\x84\x01\n" +
	"\tColumnKey\x12=\n" +
	"\afeature\x18\x01 \x01(\v2!.chalk.engine.v1.FeatureColumnKeyH\x00R\afeature\x121\n" +
	"\x03raw\x18\x02 \x01(\v2\x1d.chalk.engine.v1.RawColumnKeyH\x00R\x03rawB\x05\n" +
	"\x03key\"\x99\x01\n" +
	"\bTableKey\x12?\n" +
	"\bhas_many\x18\x01 \x01(\v2\".chalk.engine.v1.HasManyFeatureKeyH\x00R\ahasMany\x12E\n" +
	"\n" +
	"data_frame\x18\x02 \x01(\v2$.chalk.engine.v1.DataFrameFeatureKeyH\x00R\tdataFrameB\x05\n" +
	"\x03key\"\x91\x02\n" +
	"\x03Key\x12>\n" +
	"\n" +
	"raw_column\x18\x01 \x01(\v2\x1d.chalk.engine.v1.RawColumnKeyH\x00R\trawColumn\x12;\n" +
	"\x06scalar\x18\x02 \x01(\v2!.chalk.engine.v1.FeatureColumnKeyH\x00R\x06scalar\x12?\n" +
	"\bhas_many\x18\x03 \x01(\v2\".chalk.engine.v1.HasManyFeatureKeyH\x00R\ahasMany\x12D\n" +
	"\tdataframe\x18\x04 \x01(\v2$.chalk.engine.v1.DataFrameFeatureKeyH\x00R\tdataframeB\x06\n" +
	"\x04impl\"\xee\x03\n" +
	"\rPyArrowSchema\x12E\n" +
	"\ascalars\x18\x01 \x03(\v2+.chalk.engine.v1.PyArrowSchema.ColumnSchemaR\ascalars\x12B\n" +
	"\x06groups\x18\x02 \x03(\v2*.chalk.engine.v1.PyArrowSchema.TableSchemaR\x06groups\x1a\xe0\x01\n" +
	"\vTableSchema\x12+\n" +
	"\x03key\x18\x01 \x01(\v2\x19.chalk.engine.v1.TableKeyR\x03key\x12N\n" +
	"\x06schema\x18\x02 \x03(\v26.chalk.engine.v1.PyArrowSchema.TableSchema.SchemaEntryR\x06schema\x1aT\n" +
	"\vSchemaEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12/\n" +
	"\x05value\x18\x02 \x01(\v2\x19.chalk.arrow.v1.ArrowTypeR\x05value:\x028\x01\x1ao\n" +
	"\fColumnSchema\x12,\n" +
	"\x03key\x18\x01 \x01(\v2\x1a.chalk.engine.v1.ColumnKeyR\x03key\x121\n" +
	"\x06schema\x18\x02 \x01(\v2\x19.chalk.arrow.v1.ArrowTypeR\x06schema\"\x9e\x01\n" +
	"\x04Plan\x12+\n" +
	"\x05nodes\x18\x01 \x03(\v2\x15.chalk.engine.v1.NodeR\x05nodes\x12\"\n" +
	"\rroot_node_idx\x18\x02 \x01(\rR\vrootNodeIdx\x12E\n" +
	"\x0epyarrow_schema\x18\x03 \x01(\v2\x1e.chalk.engine.v1.PyArrowSchemaR\rpyarrowSchema\"`\n" +
	"\x04Node\x12)\n" +
	"\x10children_indices\x18\x01 \x03(\rR\x0fchildrenIndices\x12-\n" +
	"\x04impl\x18\x02 \x01(\v2\x19.chalk.engine.v1.NodeImplR\x04impl\"\xd7\x02\n" +
	"\bNodeImpl\x128\n" +
	"\aunknown\x18\x01 \x01(\v2\x1c.chalk.engine.v1.UnknownNodeH\x00R\aunknown\x12>\n" +
	"\vgivens_scan\x18\x02 \x01(\v2\x1b.chalk.engine.v1.GivensScanH\x00R\n" +
	"givensScan\x124\n" +
	"\aproject\x18\x03 \x01(\v2\x18.chalk.engine.v1.ProjectH\x00R\aproject\x12D\n" +
	"\rchalk_project\x18\x04 \x01(\v2\x1d.chalk.engine.v1.ChalkProjectH\x00R\fchalkProject\x12M\n" +
	"\x10default_injector\x18\x05 \x01(\v2 .chalk.engine.v1.DefaultInjectorH\x00R\x0fdefaultInjectorB\x06\n" +
	"\x04impl\"*\n" +
	"\vUnknownNode\x12\x1b\n" +
	"\ttype_name\x18\x01 \x01(\tR\btypeName\":\n" +
	"\n" +
	"GivensScan\x12,\n" +
	"\x06fields\x18\x01 \x03(\v2\x14.chalk.engine.v1.KeyR\x06fields\"x\n" +
	"\fChalkProject\x12,\n" +
	"\x06fields\x18\x01 \x03(\v2\x14.chalk.engine.v1.KeyR\x06fields\x12:\n" +
	"\x1apromote_ts_to_feature_time\x18\x02 \x01(\bR\x16promoteTsToFeatureTime\"7\n" +
	"\aProject\x12,\n" +
	"\x06fields\x18\x01 \x03(\v2\x14.chalk.engine.v1.KeyR\x06fields\"X\n" +
	"\x0fDefaultInjector\x12E\n" +
	"\x13defaulting_features\x18\x01 \x03(\v2\x14.chalk.engine.v1.KeyR\x12defaultingFeaturesB\xb9\x01\n" +
	"\x13com.chalk.engine.v1B\tPlanProtoP\x01Z9github.com/chalk-ai/chalk-go/gen/chalk/engine/v1;enginev1\xa2\x02\x03CEX\xaa\x02\x0fChalk.Engine.V1\xca\x02\x0fChalk\\Engine\\V1\xe2\x02\x1bChalk\\Engine\\V1\\GPBMetadata\xea\x02\x11Chalk::Engine::V1b\x06proto3"

var (
	file_chalk_engine_v1_plan_proto_rawDescOnce sync.Once
	file_chalk_engine_v1_plan_proto_rawDescData []byte
)

func file_chalk_engine_v1_plan_proto_rawDescGZIP() []byte {
	file_chalk_engine_v1_plan_proto_rawDescOnce.Do(func() {
		file_chalk_engine_v1_plan_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chalk_engine_v1_plan_proto_rawDesc), len(file_chalk_engine_v1_plan_proto_rawDesc)))
	})
...
func file_chalk_engine_v1_plan_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chalk_engine_v1_plan_proto_rawDesc), len(file_chalk_engine_v1_plan_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   20,
			NumExtensions: 0,
			NumServices:   0,
