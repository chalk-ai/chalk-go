...
var file_chalk_engine_v1_query_server_proto_rawDesc = []byte{
	...
	0x75, 0x6d, 0x18, 0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x03, 0x6e, 0x75, 0x6d, 0x32, 0x8d, 0x03,
	...
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x03, 0x80, 0x7d, 0x03, 0x42, 0xc0, 0x01,
...
var file_chalk_engine_v1_query_server_proto_goTypes = []any{
	...
	(*v1.OnlineQueryResponse)(nil),      // 5: chalk.common.v1.OnlineQueryResponse
	(*v1.OnlineQueryBulkResponse)(nil),  // 6: chalk.common.v1.OnlineQueryBulkResponse
	(*v1.OnlineQueryMultiResponse)(nil), // 7: chalk.common.v1.OnlineQueryMultiResponse
}
var file_chalk_engine_v1_query_server_proto_depIdxs = []int32{
	...
	1, // 4: chalk.engine.v1.QueryService.Ping:output_type -> chalk.engine.v1.PingResponse
	5, // 5: chalk.engine.v1.QueryService.OnlineQuery:output_type -> chalk.common.v1.OnlineQueryResponse
	6, // 6: chalk.engine.v1.QueryService.OnlineQueryBulk:output_type -> chalk.common.v1.OnlineQueryBulkResponse
	7, // 7: chalk.engine.v1.QueryService.OnlineQueryMulti:output_type -> chalk.common.v1.OnlineQueryMultiResponse
