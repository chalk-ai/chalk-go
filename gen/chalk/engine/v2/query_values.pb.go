...
const file_chalk_engine_v2_query_values_proto_rawDesc = "" +
	"\n" +
	"\"chalk/engine/v2/query_values.proto\x12\x0fchalk.engine.v2\x1a\x1fchalk/common/v1/query_log.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"?\n" +
	...
	"\afilters\x18\x02 \x01(\v2 .chalk.common.v1.QueryLogFiltersR\afilters\"\xad\x01\n" +
	...
	"\n" +
	"row_id_hwm\x18\x03 \x01(\x03R\browIdHwm\"\xd6\x04\n" +
	"\x15GetQueryValuesRequest\x12e\n" +
	"\x17operation_id_identifier\x18\x01 \x01(\v2+.chalk.engine.v2.OperationIdTableIdentifierH\x00R\x15operationIdIdentifier\x12_\n" +
	"\x15table_name_identifier\x18\x02 \x01(\v2).chalk.engine.v2.TableNameTableIdentifierH\x00R\x13tableNameIdentifier\x12l\n" +
	...
	"\n" +
	"page_token\x18\b \x01(\tR\tpageTokenB\x12\n" +
	...
	"\aparquet\x18\x02 \x01(\fH\x00R\aparquetB\t\n" +
	"\apayloadB\xc0\x01\n" +
	"\x13com.chalk.engine.v2B\x10QueryValuesProtoP\x01Z9github.com/chalk-ai/chalk-go/gen/chalk/engine/v2;enginev2\xa2\x02\x03CEX\xaa\x02\x0fChalk.Engine.V2\xca\x02\x0fChalk\\Engine\\V2\xe2\x02\x1bChalk\\Engine\\V2\\GPBMetadata\xea\x02\x11Chalk::Engine::V2b\x06proto3"

var (
	file_chalk_engine_v2_query_values_proto_rawDescOnce sync.Once
	file_chalk_engine_v2_query_values_proto_rawDescData []byte
)

func file_chalk_engine_v2_query_values_proto_rawDescGZIP() []byte {
	file_chalk_engine_v2_query_values_proto_rawDescOnce.Do(func() {
		file_chalk_engine_v2_query_values_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chalk_engine_v2_query_values_proto_rawDesc), len(file_chalk_engine_v2_query_values_proto_rawDesc)))
	})
...
func file_chalk_engine_v2_query_values_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chalk_engine_v2_query_values_proto_rawDesc), len(file_chalk_engine_v2_query_values_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
