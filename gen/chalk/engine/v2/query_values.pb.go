...
func (x *OperationIdTableIdentifier) Reset() {
	*x = OperationIdTableIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chalk_engine_v2_query_values_proto_msgTypes[0]
...
func (*OperationIdTableIdentifier) Descriptor() ([]byte, []int) {
	return file_chalk_engine_v2_query_values_proto_rawDescGZIP(), []int{0}
}
...
type TableNameTableIdentifier struct {
	...
	Filters *v1.QueryLogFilters `protobuf:"bytes,2,opt,name=filters,proto3" json:"filters,omitempty"`
}

func (x *TableNameTableIdentifier) Reset() {
	*x = TableNameTableIdentifier{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chalk_engine_v2_query_values_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*TableNameTableIdentifier) Descriptor() ([]byte, []int) {
	return file_chalk_engine_v2_query_values_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetQueryValuesPageToken) Reset() {
	*x = GetQueryValuesPageToken{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chalk_engine_v2_query_values_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetQueryValuesPageToken) Descriptor() ([]byte, []int) {
	return file_chalk_engine_v2_query_values_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetQueryValuesRequest) Reset() {
	*x = GetQueryValuesRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chalk_engine_v2_query_values_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetQueryValuesRequest) Descriptor() ([]byte, []int) {
	return file_chalk_engine_v2_query_values_proto_rawDescGZIP(), []int{3}
}
...
func (x *GetQueryValuesResponse) Reset() {
	*x = GetQueryValuesResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_chalk_engine_v2_query_values_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*GetQueryValuesResponse) Descriptor() ([]byte, []int) {
	return file_chalk_engine_v2_query_values_proto_rawDescGZIP(), []int{4}
}
...
var file_chalk_engine_v2_query_values_proto_rawDesc = []byte{
	0x0a, 0x22, 0x63, 0x68, 0x61, 0x6c, 0x6b, 0x2f, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2f, 0x76,
	0x32, 0x2f, 0x71, 0x75, 0x65, 0x72, 0x79, 0x5f, 0x76, 0x61, 0x6c, 0x75, 0x65, 0x73, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0f, 0x63, 0x68, 0x61, 0x6c, 0x6b, 0x2e, 0x65, 0x6e, 0x67, 0x69,
	0x6e, 0x65, 0x2e, 0x76, 0x32, 0x1a, 0x1f, 0x63, 0x68, 0x61, 0x6c, 0x6b, 0x2f, 0x63, 0x6f, 0x6d,
	...
	0x6c, 0x6b, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x76, 0x32, 0x2e, 0x4f, 0x70, 0x65,
	...
	0x29, 0x2e, 0x63, 0x68, 0x61, 0x6c, 0x6b, 0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x76,
	0x32, 0x2e, 0x54, 0x61, 0x62, 0x6c, 0x65, 0x4e, 0x61, 0x6d, 0x65, 0x54, 0x61, 0x62, 0x6c, 0x65,
	...
	0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x76, 0x32, 0x42, 0x10, 0x51, 0x75, 0x65, 0x72, 0x79,
	...
	0x63, 0x68, 0x61, 0x6c, 0x6b, 0x2f, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2f, 0x76, 0x32, 0x3b,
	0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x76, 0x32, 0xa2, 0x02, 0x03, 0x43, 0x45, 0x58, 0xaa, 0x02,
	0x0f, 0x43, 0x68, 0x61, 0x6c, 0x6b, 0x2e, 0x45, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x2e, 0x56, 0x32,
	0xca, 0x02, 0x0f, 0x43, 0x68, 0x61, 0x6c, 0x6b, 0x5c, 0x45, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x5c,
	0x56, 0x32, 0xe2, 0x02, 0x1b, 0x43, 0x68, 0x61, 0x6c, 0x6b, 0x5c, 0x45, 0x6e, 0x67, 0x69, 0x6e,
...
var (
	file_chalk_engine_v2_query_values_proto_rawDescOnce sync.Once
	file_chalk_engine_v2_query_values_proto_rawDescData = file_chalk_engine_v2_query_values_proto_rawDesc
)

func file_chalk_engine_v2_query_values_proto_rawDescGZIP() []byte {
	file_chalk_engine_v2_query_values_proto_rawDescOnce.Do(func() {
		file_chalk_engine_v2_query_values_proto_rawDescData = protoimpl.X.CompressGZIP(file_chalk_engine_v2_query_values_proto_rawDescData)
	})
	return file_chalk_engine_v2_query_values_proto_rawDescData
}

var file_chalk_engine_v2_query_values_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_chalk_engine_v2_query_values_proto_goTypes = []any{
	(*OperationIdTableIdentifier)(nil), // 0: chalk.engine.v2.OperationIdTableIdentifier
	(*TableNameTableIdentifier)(nil),   // 1: chalk.engine.v2.TableNameTableIdentifier
	(*GetQueryValuesPageToken)(nil),    // 2: chalk.engine.v2.GetQueryValuesPageToken
	(*GetQueryValuesRequest)(nil),      // 3: chalk.engine.v2.GetQueryValuesRequest
	(*GetQueryValuesResponse)(nil),     // 4: chalk.engine.v2.GetQueryValuesResponse
	(*v1.QueryLogFilters)(nil),         // 5: chalk.common.v1.QueryLogFilters
	(*timestamppb.Timestamp)(nil),      // 6: google.protobuf.Timestamp
}
var file_chalk_engine_v2_query_values_proto_depIdxs = []int32{
	5, // 0: chalk.engine.v2.TableNameTableIdentifier.filters:type_name -> chalk.common.v1.QueryLogFilters
	6, // 1: chalk.engine.v2.GetQueryValuesPageToken.query_timestamp_hwm:type_name -> google.protobuf.Timestamp
	0, // 2: chalk.engine.v2.GetQueryValuesRequest.operation_id_identifier:type_name -> chalk.engine.v2.OperationIdTableIdentifier
	1, // 3: chalk.engine.v2.GetQueryValuesRequest.table_name_identifier:type_name -> chalk.engine.v2.TableNameTableIdentifier
	6, // 4: chalk.engine.v2.GetQueryValuesRequest.query_timestamp_lower_bound_inclusive:type_name -> google.protobuf.Timestamp
	6, // 5: chalk.engine.v2.GetQueryValuesRequest.query_timestamp_upper_bound_exclusive:type_name -> google.protobuf.Timestamp
...
func init() { file_chalk_engine_v2_query_values_proto_init() }
func file_chalk_engine_v2_query_values_proto_init() {
	if File_chalk_engine_v2_query_values_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_chalk_engine_v2_query_values_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_chalk_engine_v2_query_values_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_chalk_engine_v2_query_values_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_chalk_engine_v2_query_values_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_chalk_engine_v2_query_values_proto_msgTypes[4].Exporter = func(v any, i int) any {
	...
	file_chalk_engine_v2_query_values_proto_msgTypes[3].OneofWrappers = []any{
		(*GetQueryValuesRequest_OperationIdIdentifier)(nil),
		(*GetQueryValuesRequest_TableNameIdentifier)(nil),
	}
	file_chalk_engine_v2_query_values_proto_msgTypes[4].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_chalk_engine_v2_query_values_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_chalk_engine_v2_query_values_proto_goTypes,
		DependencyIndexes: file_chalk_engine_v2_query_values_proto_depIdxs,
		MessageInfos:      file_chalk_engine_v2_query_values_proto_msgTypes,
	}.Build()
	File_chalk_engine_v2_query_values_proto = out.File
	file_chalk_engine_v2_query_values_proto_rawDesc = nil
	file_chalk_engine_v2_query_values_proto_goTypes = nil
	file_chalk_engine_v2_query_values_proto_depIdxs = nil
}
