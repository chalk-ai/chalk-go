...
const file_chalk_nodepools_v1_gke_proto_rawDesc = "" +
	...
	"\vdescription\x18\x02 \x01(\tR\vdescription\"\xa7\x03\n" +
	...
	"\x12gpu_sharing_config\x18\x05 \x01(\v2$.chalk.nodepools.v1.GPUSharingConfigH\x00R\x10gpuSharingConfig\x88\x01\x01\x12y\n" +
	"\x1egpu_driver_installation_config\x18\x06 \x01(\v2/.chalk.nodepools.v1.GPUDriverInstallationConfigH\x01R\x1bgpuDriverInstallationConfig\x88\x01\x01B\x15\n" +
	...
	"\x14gpu_sharing_strategy\x18\x02 \x01(\x0e27.chalk.nodepools.v1.GPUSharingConfig.GPUSharingStrategyH\x00R\x12gpuSharingStrategy\x88\x01\x01\"\x7f\n" +
	"\x12GPUSharingStrategy\x12$\n" +
	" GPU_SHARING_STRATEGY_UNSPECIFIED\x10\x00\x12%\n" +
	"!GPU_SHARING_STRATEGY_TIME_SHARING\x10\x01\x12\x1c\n" +
	"\x18GPU_SHARING_STRATEGY_MPS\x10\x02B\x17\n" +
	"\x15_gpu_sharing_strategy\"\xcf\x02\n" +
	"\x1bGPUDriverInstallationConfig\x12s\n" +
	"\x12gpu_driver_version\x18\x01 \x01(\x0e2@.chalk.nodepools.v1.GPUDriverInstallationConfig.GPUDriverVersionH\x00R\x10gpuDriverVersion\x88\x01\x01\"\xa3\x01\n" +
	...
	"\x19GPU_DRIVER_VERSION_LATEST\x10\x03B\x15\n" +
	"\x13_gpu_driver_version\"\x8f\f\n" +
	"\n" +
	"NodeConfig\x12!\n" +
	...
	"\vpreemptible\x18\n" +
	" \x01(\bR\vpreemptible\x12I\n" +
	"\faccelerators\x18\v \x03(\v2%.chalk.nodepools.v1.AcceleratorConfigR\faccelerators\x12\x1b\n" +
