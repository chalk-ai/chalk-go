...
const file_chalk_nodepools_v1_karpenter_proto_rawDesc = "" +
	...
	"\x06status\x18\x05 \x01(\v2+.chalk.nodepools.v1.KarpenterNodepoolStatusR\x06status\x12\x1d\n" +
	"\acluster\x18\x06 \x01(\tH\x00R\acluster\x88\x01\x01\x12#\n" +
	"\rworkload_type\x18\a \x01(\tR\fworkloadTypeB\n" +
	"\n" +
	"\b_clusterB\xd3\x01\n" +
