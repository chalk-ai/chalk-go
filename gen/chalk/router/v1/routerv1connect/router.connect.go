...
type TelemetrySettingsServiceClient interface {
	...
	// Validate and probe an unsaved exporter draft without persisting or activating it.
...
func NewTelemetrySettingsServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) TelemetrySettingsServiceClient {
	baseURL = strings.TrimRight(baseURL, "/")
	telemetrySettingsServiceMethods := v1.File_chalk_router_v1_router_proto.Services().ByName("TelemetrySettingsService").Methods()
