...
type ProviderConnection struct {
	...
	// Sparse operator-authored capability overrides, exactly as stored. Only the
	// leaves this connection pins are present; everything else is inherited.
...
type CreateProviderConnectionRequest struct {
	...
	// Plaintext key; encrypted at rest. May be empty when the endpoint selects
	// ambient credentials (Bedrock Runtime signs with the AWS default chain).
	ApiKey string `protobuf:"bytes,7,opt,name=api_key,json=apiKey,proto3" json:"api_key,omitempty"`
	// Sparse overrides; unset inherits every default. Validated against the
	// vocabulary's schema version, so an unknown shape is rejected at create.
...
type UpdateProviderConnectionOperation struct {
	...
	// Masked and unset drops every override, returning the connection to fully
...
const file_chalk_router_v1_router_proto_rawDesc = "" +
	"\n" +
	"\x1cchalk/router/v1/router.proto\x12\x0fchalk.router.v1\x1a\x1fchalk/auth/v1/permissions.proto\x1a\x1egoogle/protobuf/duration.proto\x1a google/protobuf/field_mask.proto\x1a\x1cgoogle/protobuf/struct.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x84\x02\n" +
...
var file_chalk_router_v1_router_proto_depIdxs = []int32{
	...
	103, // 45: chalk.router.v1.ProviderConnection.declared_capabilities:type_name -> google.protobuf.Struct
	0,   // 46: chalk.router.v1.ProviderConnectionDraft.exposure:type_name -> chalk.router.v1.ExposurePolicy
	53,  // 47: chalk.router.v1.ListProviderConnectionsResponse.connections:type_name -> chalk.router.v1.ProviderConnection
	0,   // 48: chalk.router.v1.CreateProviderConnectionRequest.exposure:type_name -> chalk.router.v1.ExposurePolicy
	103, // 49: chalk.router.v1.CreateProviderConnectionRequest.declared_capabilities:type_name -> google.protobuf.Struct
	53,  // 50: chalk.router.v1.CreateProviderConnectionResponse.connection:type_name -> chalk.router.v1.ProviderConnection
	0,   // 51: chalk.router.v1.UpdateProviderConnectionOperation.exposure:type_name -> chalk.router.v1.ExposurePolicy
	103, // 52: chalk.router.v1.UpdateProviderConnectionOperation.declared_capabilities:type_name -> google.protobuf.Struct
	59,  // 53: chalk.router.v1.UpdateProviderConnectionRequest.update:type_name -> chalk.router.v1.UpdateProviderConnectionOperation
	102, // 54: chalk.router.v1.UpdateProviderConnectionRequest.update_mask:type_name -> google.protobuf.FieldMask
	53,  // 55: chalk.router.v1.UpdateProviderConnectionResponse.connection:type_name -> chalk.router.v1.ProviderConnection
	54,  // 56: chalk.router.v1.TestProviderConnectionRequest.draft:type_name -> chalk.router.v1.ProviderConnectionDraft
	104, // 57: chalk.router.v1.TestProviderConnectionResponse.latency:type_name -> google.protobuf.Duration
	1,   // 58: chalk.router.v1.ModelRoute.diagnostic:type_name -> chalk.router.v1.RouteDiagnostic
	101, // 59: chalk.router.v1.ModelRoute.created_at:type_name -> google.protobuf.Timestamp
	101, // 60: chalk.router.v1.ModelRoute.updated_at:type_name -> google.protobuf.Timestamp
	66,  // 61: chalk.router.v1.ListModelRoutesResponse.routes:type_name -> chalk.router.v1.ModelRoute
	66,  // 62: chalk.router.v1.CreateModelRouteResponse.route:type_name -> chalk.router.v1.ModelRoute
	71,  // 63: chalk.router.v1.UpdateModelRouteRequest.update:type_name -> chalk.router.v1.UpdateModelRouteOperation
	102, // 64: chalk.router.v1.UpdateModelRouteRequest.update_mask:type_name -> google.protobuf.FieldMask
	66,  // 65: chalk.router.v1.UpdateModelRouteResponse.route:type_name -> chalk.router.v1.ModelRoute
	101, // 66: chalk.router.v1.TelemetryExporter.created_at:type_name -> google.protobuf.Timestamp
	101, // 67: chalk.router.v1.TelemetryExporter.updated_at:type_name -> google.protobuf.Timestamp
	76,  // 68: chalk.router.v1.ListTelemetryExportersResponse.exporters:type_name -> chalk.router.v1.TelemetryExporter
	79,  // 69: chalk.router.v1.UpsertTelemetryExporterRequest.exporter:type_name -> chalk.router.v1.UpsertTelemetryExporterOperation
	76,  // 70: chalk.router.v1.UpsertTelemetryExporterResponse.exporter:type_name -> chalk.router.v1.TelemetryExporter
	79,  // 71: chalk.router.v1.TestTelemetryExporterRequest.exporter:type_name -> chalk.router.v1.UpsertTelemetryExporterOperation
	104, // 72: chalk.router.v1.TestTelemetryExporterResponse.latency:type_name -> google.protobuf.Duration
	101, // 73: chalk.router.v1.DebugCompletionEntry.timestamp:type_name -> google.protobuf.Timestamp
	104, // 74: chalk.router.v1.DebugCompletionEntry.duration:type_name -> google.protobuf.Duration
	86,  // 75: chalk.router.v1.DebugCompletionEntry.usage:type_name -> chalk.router.v1.Usage
	87,  // 76: chalk.router.v1.RecentCompletionsResponse.entries:type_name -> chalk.router.v1.DebugCompletionEntry
	38,  // 77: chalk.router.v1.FallbackPolicy.FallbacksEntry.value:type_name -> chalk.router.v1.FallbackList
	38,  // 78: chalk.router.v1.UpdateFallbackPolicyOperation.FallbacksEntry.value:type_name -> chalk.router.v1.FallbackList
	45,  // 79: chalk.router.v1.JudgePolicy.LaddersEntry.value:type_name -> chalk.router.v1.JudgeLadder
	45,  // 80: chalk.router.v1.UpdateJudgePolicyOperation.LaddersEntry.value:type_name -> chalk.router.v1.JudgeLadder
	5,   // 81: chalk.router.v1.ApiKeyService.CreateKey:input_type -> chalk.router.v1.CreateKeyRequest
	7,   // 82: chalk.router.v1.ApiKeyService.ListKeys:input_type -> chalk.router.v1.ListKeysRequest
	10,  // 83: chalk.router.v1.ApiKeyService.UpdateKey:input_type -> chalk.router.v1.UpdateKeyRequest
	12,  // 84: chalk.router.v1.ApiKeyService.RevokeKey:input_type -> chalk.router.v1.RevokeKeyRequest
	14,  // 85: chalk.router.v1.ApiKeyService.GetKeyUsage:input_type -> chalk.router.v1.GetKeyUsageRequest
	16,  // 86: chalk.router.v1.ApiKeyService.ListAllUsage:input_type -> chalk.router.v1.ListAllUsageRequest
	18,  // 87: chalk.router.v1.ApiKeyService.GetUsageHistogram:input_type -> chalk.router.v1.GetUsageHistogramRequest
	22,  // 88: chalk.router.v1.UsagePoolService.CreateUsagePool:input_type -> chalk.router.v1.CreateUsagePoolRequest
	24,  // 89: chalk.router.v1.UsagePoolService.ListUsagePools:input_type -> chalk.router.v1.ListUsagePoolsRequest
	26,  // 90: chalk.router.v1.UsagePoolService.DeleteUsagePool:input_type -> chalk.router.v1.DeleteUsagePoolRequest
	29,  // 91: chalk.router.v1.RateLimitService.CreateRateLimit:input_type -> chalk.router.v1.CreateRateLimitRequest
	31,  // 92: chalk.router.v1.RateLimitService.ListRateLimits:input_type -> chalk.router.v1.ListRateLimitsRequest
	34,  // 93: chalk.router.v1.RateLimitService.UpdateRateLimit:input_type -> chalk.router.v1.UpdateRateLimitRequest
	36,  // 94: chalk.router.v1.RateLimitService.DeleteRateLimit:input_type -> chalk.router.v1.DeleteRateLimitRequest
	40,  // 95: chalk.router.v1.FallbackPolicyService.GetFallbackPolicy:input_type -> chalk.router.v1.GetFallbackPolicyRequest
	43,  // 96: chalk.router.v1.FallbackPolicyService.UpdateFallbackPolicy:input_type -> chalk.router.v1.UpdateFallbackPolicyRequest
	47,  // 97: chalk.router.v1.JudgePolicyService.GetJudgePolicy:input_type -> chalk.router.v1.GetJudgePolicyRequest
	50,  // 98: chalk.router.v1.JudgePolicyService.UpdateJudgePolicy:input_type -> chalk.router.v1.UpdateJudgePolicyRequest
	55,  // 99: chalk.router.v1.ProviderConnectionService.ListProviderConnections:input_type -> chalk.router.v1.ListProviderConnectionsRequest
	57,  // 100: chalk.router.v1.ProviderConnectionService.CreateProviderConnection:input_type -> chalk.router.v1.CreateProviderConnectionRequest
	60,  // 101: chalk.router.v1.ProviderConnectionService.UpdateProviderConnection:input_type -> chalk.router.v1.UpdateProviderConnectionRequest
	62,  // 102: chalk.router.v1.ProviderConnectionService.DeleteProviderConnection:input_type -> chalk.router.v1.DeleteProviderConnectionRequest
	64,  // 103: chalk.router.v1.ProviderConnectionService.TestProviderConnection:input_type -> chalk.router.v1.TestProviderConnectionRequest
	67,  // 104: chalk.router.v1.ModelRouteService.ListModelRoutes:input_type -> chalk.router.v1.ListModelRoutesRequest
	69,  // 105: chalk.router.v1.ModelRouteService.CreateModelRoute:input_type -> chalk.router.v1.CreateModelRouteRequest
	72,  // 106: chalk.router.v1.ModelRouteService.UpdateModelRoute:input_type -> chalk.router.v1.UpdateModelRouteRequest
	74,  // 107: chalk.router.v1.ModelRouteService.DeleteModelRoute:input_type -> chalk.router.v1.DeleteModelRouteRequest
	77,  // 108: chalk.router.v1.TelemetrySettingsService.ListTelemetryExporters:input_type -> chalk.router.v1.ListTelemetryExportersRequest
	80,  // 109: chalk.router.v1.TelemetrySettingsService.UpsertTelemetryExporter:input_type -> chalk.router.v1.UpsertTelemetryExporterRequest
	82,  // 110: chalk.router.v1.TelemetrySettingsService.DeleteTelemetryExporter:input_type -> chalk.router.v1.DeleteTelemetryExporterRequest
	84,  // 111: chalk.router.v1.TelemetrySettingsService.TestTelemetryExporter:input_type -> chalk.router.v1.TestTelemetryExporterRequest
	88,  // 112: chalk.router.v1.DebugService.RecentCompletions:input_type -> chalk.router.v1.RecentCompletionsRequest
	90,  // 113: chalk.router.v1.HealthService.Check:input_type -> chalk.router.v1.CheckRequest
	6,   // 114: chalk.router.v1.ApiKeyService.CreateKey:output_type -> chalk.router.v1.CreateKeyResponse
	8,   // 115: chalk.router.v1.ApiKeyService.ListKeys:output_type -> chalk.router.v1.ListKeysResponse
	11,  // 116: chalk.router.v1.ApiKeyService.UpdateKey:output_type -> chalk.router.v1.UpdateKeyResponse
	13,  // 117: chalk.router.v1.ApiKeyService.RevokeKey:output_type -> chalk.router.v1.RevokeKeyResponse
	15,  // 118: chalk.router.v1.ApiKeyService.GetKeyUsage:output_type -> chalk.router.v1.GetKeyUsageResponse
	17,  // 119: chalk.router.v1.ApiKeyService.ListAllUsage:output_type -> chalk.router.v1.ListAllUsageResponse
	20,  // 120: chalk.router.v1.ApiKeyService.GetUsageHistogram:output_type -> chalk.router.v1.GetUsageHistogramResponse
	23,  // 121: chalk.router.v1.UsagePoolService.CreateUsagePool:output_type -> chalk.router.v1.CreateUsagePoolResponse
	25,  // 122: chalk.router.v1.UsagePoolService.ListUsagePools:output_type -> chalk.router.v1.ListUsagePoolsResponse
	27,  // 123: chalk.router.v1.UsagePoolService.DeleteUsagePool:output_type -> chalk.router.v1.DeleteUsagePoolResponse
	30,  // 124: chalk.router.v1.RateLimitService.CreateRateLimit:output_type -> chalk.router.v1.CreateRateLimitResponse
	32,  // 125: chalk.router.v1.RateLimitService.ListRateLimits:output_type -> chalk.router.v1.ListRateLimitsResponse
	35,  // 126: chalk.router.v1.RateLimitService.UpdateRateLimit:output_type -> chalk.router.v1.UpdateRateLimitResponse
	37,  // 127: chalk.router.v1.RateLimitService.DeleteRateLimit:output_type -> chalk.router.v1.DeleteRateLimitResponse
	41,  // 128: chalk.router.v1.FallbackPolicyService.GetFallbackPolicy:output_type -> chalk.router.v1.GetFallbackPolicyResponse
	44,  // 129: chalk.router.v1.FallbackPolicyService.UpdateFallbackPolicy:output_type -> chalk.router.v1.UpdateFallbackPolicyResponse
	48,  // 130: chalk.router.v1.JudgePolicyService.GetJudgePolicy:output_type -> chalk.router.v1.GetJudgePolicyResponse
	51,  // 131: chalk.router.v1.JudgePolicyService.UpdateJudgePolicy:output_type -> chalk.router.v1.UpdateJudgePolicyResponse
	56,  // 132: chalk.router.v1.ProviderConnectionService.ListProviderConnections:output_type -> chalk.router.v1.ListProviderConnectionsResponse
	58,  // 133: chalk.router.v1.ProviderConnectionService.CreateProviderConnection:output_type -> chalk.router.v1.CreateProviderConnectionResponse
	61,  // 134: chalk.router.v1.ProviderConnectionService.UpdateProviderConnection:output_type -> chalk.router.v1.UpdateProviderConnectionResponse
	63,  // 135: chalk.router.v1.ProviderConnectionService.DeleteProviderConnection:output_type -> chalk.router.v1.DeleteProviderConnectionResponse
	65,  // 136: chalk.router.v1.ProviderConnectionService.TestProviderConnection:output_type -> chalk.router.v1.TestProviderConnectionResponse
	68,  // 137: chalk.router.v1.ModelRouteService.ListModelRoutes:output_type -> chalk.router.v1.ListModelRoutesResponse
	70,  // 138: chalk.router.v1.ModelRouteService.CreateModelRoute:output_type -> chalk.router.v1.CreateModelRouteResponse
	73,  // 139: chalk.router.v1.ModelRouteService.UpdateModelRoute:output_type -> chalk.router.v1.UpdateModelRouteResponse
	75,  // 140: chalk.router.v1.ModelRouteService.DeleteModelRoute:output_type -> chalk.router.v1.DeleteModelRouteResponse
	78,  // 141: chalk.router.v1.TelemetrySettingsService.ListTelemetryExporters:output_type -> chalk.router.v1.ListTelemetryExportersResponse
	81,  // 142: chalk.router.v1.TelemetrySettingsService.UpsertTelemetryExporter:output_type -> chalk.router.v1.UpsertTelemetryExporterResponse
	83,  // 143: chalk.router.v1.TelemetrySettingsService.DeleteTelemetryExporter:output_type -> chalk.router.v1.DeleteTelemetryExporterResponse
	85,  // 144: chalk.router.v1.TelemetrySettingsService.TestTelemetryExporter:output_type -> chalk.router.v1.TestTelemetryExporterResponse
	89,  // 145: chalk.router.v1.DebugService.RecentCompletions:output_type -> chalk.router.v1.RecentCompletionsResponse
	91,  // 146: chalk.router.v1.HealthService.Check:output_type -> chalk.router.v1.CheckResponse
