...
var file_chalk_server_v1_builder_proto_rawDesc = []byte{
	...
	0x4f, 0x54, 0x5f, 0x45, 0x52, 0x52, 0x4f, 0x52, 0x53, 0x10, 0x0b, 0x32, 0xca, 0x10, 0x0a, 0x0e,
	...
	0x6e, 0x73, 0x65, 0x22, 0x03, 0x80, 0x7d, 0x0c, 0x42, 0xbc, 0x01, 0x0a, 0x13, 0x63, 0x6f, 0x6d,
	0x2e, 0x63, 0x68, 0x61, 0x6c, 0x6b, 0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31,
...
var file_chalk_server_v1_builder_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_chalk_server_v1_builder_proto_goTypes = []any{
	...
	(*MigrateClusterTimescaleDBRequest)(nil),           // 27: chalk.server.v1.MigrateClusterTimescaleDBRequest
	(*MigrateClusterTimescaleDBResponse)(nil),          // 28: chalk.server.v1.MigrateClusterTimescaleDBResponse
	(*CreateClusterGatewayRequest)(nil),                // 29: chalk.server.v1.CreateClusterGatewayRequest
	(*CreateClusterGatewayResponse)(nil),               // 30: chalk.server.v1.CreateClusterGatewayResponse
	(*CreateClusterBackgroundPersistenceRequest)(nil),  // 31: chalk.server.v1.CreateClusterBackgroundPersistenceRequest
	(*CreateClusterBackgroundPersistenceResponse)(nil), // 32: chalk.server.v1.CreateClusterBackgroundPersistenceResponse
	(*GetSearchConfigRequest)(nil),                     // 33: chalk.server.v1.GetSearchConfigRequest
	(*GetSearchConfigResponse)(nil),                    // 34: chalk.server.v1.GetSearchConfigResponse
	(*UpdateEnvironmentVariablesRequest)(nil),          // 35: chalk.server.v1.UpdateEnvironmentVariablesRequest
	(*UpdateEnvironmentVariablesResponse)(nil),         // 36: chalk.server.v1.UpdateEnvironmentVariablesResponse
	nil,                           // 37: chalk.server.v1.UpdateEnvironmentVariablesRequest.EnvironmentVariablesEntry
	(*timestamppb.Timestamp)(nil), // 38: google.protobuf.Timestamp
	(*Deployment)(nil),            // 39: chalk.server.v1.Deployment
	(*LogEntry)(nil),              // 40: chalk.server.v1.LogEntry
}
var file_chalk_server_v1_builder_proto_depIdxs = []int32{
	...
	38, // 1: chalk.server.v1.DeploymentBuildStep.start_time:type_name -> google.protobuf.Timestamp
	38, // 2: chalk.server.v1.DeploymentBuildStep.end_time:type_name -> google.protobuf.Timestamp
	14, // 3: chalk.server.v1.GetDeploymentStepsResponse.steps:type_name -> chalk.server.v1.DeploymentBuildStep
	39, // 4: chalk.server.v1.GetDeploymentStepsResponse.deployment:type_name -> chalk.server.v1.Deployment
	40, // 5: chalk.server.v1.GetDeploymentLogsResponse.logs:type_name -> chalk.server.v1.LogEntry
	38, // 6: chalk.server.v1.GetClusterTimescaleDBResponse.created_at:type_name -> google.protobuf.Timestamp
	38, // 7: chalk.server.v1.GetClusterTimescaleDBResponse.updated_at:type_name -> google.protobuf.Timestamp
	38, // 8: chalk.server.v1.GetClusterGatewayResponse.created_at:type_name -> google.protobuf.Timestamp
	38, // 9: chalk.server.v1.GetClusterGatewayResponse.updated_at:type_name -> google.protobuf.Timestamp
	38, // 10: chalk.server.v1.BackgroundPersistence.created_at:type_name -> google.protobuf.Timestamp
	38, // 11: chalk.server.v1.BackgroundPersistence.updated_at:type_name -> google.protobuf.Timestamp
	22, // 12: chalk.server.v1.GetClusterBackgroundPersistenceResponse.background_persistence:type_name -> chalk.server.v1.BackgroundPersistence
	37, // 13: chalk.server.v1.UpdateEnvironmentVariablesRequest.environment_variables:type_name -> chalk.server.v1.UpdateEnvironmentVariablesRequest.EnvironmentVariablesEntry
	33, // 14: chalk.server.v1.BuilderService.GetSearchConfig:input_type -> chalk.server.v1.GetSearchConfigRequest
	1,  // 15: chalk.server.v1.BuilderService.ActivateDeployment:input_type -> chalk.server.v1.ActivateDeploymentRequest
	3,  // 16: chalk.server.v1.BuilderService.IndexDeployment:input_type -> chalk.server.v1.IndexDeploymentRequest
	5,  // 17: chalk.server.v1.BuilderService.DeployKubeComponents:input_type -> chalk.server.v1.DeployKubeComponentsRequest
	7,  // 18: chalk.server.v1.BuilderService.RebuildDeployment:input_type -> chalk.server.v1.RebuildDeploymentRequest
	9,  // 19: chalk.server.v1.BuilderService.RedeployDeployment:input_type -> chalk.server.v1.RedeployDeploymentRequest
	11, // 20: chalk.server.v1.BuilderService.UploadSource:input_type -> chalk.server.v1.UploadSourceRequest
	13, // 21: chalk.server.v1.BuilderService.GetDeploymentSteps:input_type -> chalk.server.v1.GetDeploymentStepsRequest
	16, // 22: chalk.server.v1.BuilderService.GetDeploymentLogs:input_type -> chalk.server.v1.GetDeploymentLogsRequest
	18, // 23: chalk.server.v1.BuilderService.GetClusterTimescaleDB:input_type -> chalk.server.v1.GetClusterTimescaleDBRequest
	20, // 24: chalk.server.v1.BuilderService.GetClusterGateway:input_type -> chalk.server.v1.GetClusterGatewayRequest
	23, // 25: chalk.server.v1.BuilderService.GetClusterBackgroundPersistence:input_type -> chalk.server.v1.GetClusterBackgroundPersistenceRequest
	25, // 26: chalk.server.v1.BuilderService.CreateClusterTimescaleDB:input_type -> chalk.server.v1.CreateClusterTimescaleDBRequest
	27, // 27: chalk.server.v1.BuilderService.MigrateClusterTimescaleDB:input_type -> chalk.server.v1.MigrateClusterTimescaleDBRequest
	29, // 28: chalk.server.v1.BuilderService.CreateClusterGateway:input_type -> chalk.server.v1.CreateClusterGatewayRequest
	31, // 29: chalk.server.v1.BuilderService.CreateClusterBackgroundPersistence:input_type -> chalk.server.v1.CreateClusterBackgroundPersistenceRequest
	35, // 30: chalk.server.v1.BuilderService.UpdateEnvironmentVariables:input_type -> chalk.server.v1.UpdateEnvironmentVariablesRequest
	34, // 31: chalk.server.v1.BuilderService.GetSearchConfig:output_type -> chalk.server.v1.GetSearchConfigResponse
	2,  // 32: chalk.server.v1.BuilderService.ActivateDeployment:output_type -> chalk.server.v1.ActivateDeploymentResponse
	4,  // 33: chalk.server.v1.BuilderService.IndexDeployment:output_type -> chalk.server.v1.IndexDeploymentResponse
	6,  // 34: chalk.server.v1.BuilderService.DeployKubeComponents:output_type -> chalk.server.v1.DeployKubeComponentsResponse
	8,  // 35: chalk.server.v1.BuilderService.RebuildDeployment:output_type -> chalk.server.v1.RebuildDeploymentResponse
	10, // 36: chalk.server.v1.BuilderService.RedeployDeployment:output_type -> chalk.server.v1.RedeployDeploymentResponse
	12, // 37: chalk.server.v1.BuilderService.UploadSource:output_type -> chalk.server.v1.UploadSourceResponse
	15, // 38: chalk.server.v1.BuilderService.GetDeploymentSteps:output_type -> chalk.server.v1.GetDeploymentStepsResponse
	17, // 39: chalk.server.v1.BuilderService.GetDeploymentLogs:output_type -> chalk.server.v1.GetDeploymentLogsResponse
	19, // 40: chalk.server.v1.BuilderService.GetClusterTimescaleDB:output_type -> chalk.server.v1.GetClusterTimescaleDBResponse
	21, // 41: chalk.server.v1.BuilderService.GetClusterGateway:output_type -> chalk.server.v1.GetClusterGatewayResponse
	24, // 42: chalk.server.v1.BuilderService.GetClusterBackgroundPersistence:output_type -> chalk.server.v1.GetClusterBackgroundPersistenceResponse
	26, // 43: chalk.server.v1.BuilderService.CreateClusterTimescaleDB:output_type -> chalk.server.v1.CreateClusterTimescaleDBResponse
	28, // 44: chalk.server.v1.BuilderService.MigrateClusterTimescaleDB:output_type -> chalk.server.v1.MigrateClusterTimescaleDBResponse
	30, // 45: chalk.server.v1.BuilderService.CreateClusterGateway:output_type -> chalk.server.v1.CreateClusterGatewayResponse
	32, // 46: chalk.server.v1.BuilderService.CreateClusterBackgroundPersistence:output_type -> chalk.server.v1.CreateClusterBackgroundPersistenceResponse
	36, // 47: chalk.server.v1.BuilderService.UpdateEnvironmentVariables:output_type -> chalk.server.v1.UpdateEnvironmentVariablesResponse
