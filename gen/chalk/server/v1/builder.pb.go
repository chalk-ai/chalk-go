...
const file_chalk_server_v1_builder_proto_rawDesc = "" +
	...
	"\x05specs\x18\x05 \x01(\v2\".chalk.server.v1.EnvoyGatewaySpecsR\x05specs\"!\n" +
	"\x1fGetClusterGatewayDefaultRequest\"\\\n" +
	" GetClusterGatewayDefaultResponse\x128\n" +
	"\x05specs\x18\x01 \x01(\v2\".chalk.server.v1.EnvoyGatewaySpecsR\x05specs\"\xa5\x02\n" +
	...
	"\x05specs\x18\x04 \x01(\v2&.chalk.server.v1.ClusterTimescaleSpecsR\x05specs\"#\n" +
	...
	"\astorage\x18\x04 \x01(\tR\astorage\"\xaf\v\n" +
	...
	"\fdns_hostname\x18\x18 \x01(\tH\x05R\vdnsHostname\x88\x01\x01\x1aE\n" +
	...
	"\x05specs\x18\x04 \x01(\v2\".chalk.server.v1.EnvoyGatewaySpecsR\x05specs\"\xad\x06\n" +
	...
	" \x01(\tH\x02R\x11loadBalancerClass\x88\x01\x01\x121\n" +
	"\x12cluster_gateway_id\x18\v \x01(\tH\x03R\x10clusterGatewayId\x88\x01\x01\x1aE\n" +
	...
	"\x14additional_dns_names\x18\x06 \x03(\tR\x12additionalDnsNamesB\x13\n" +
	...
	"\bcontents\x18\x02 \x01(\tR\bcontents\"\xfc\x03\n" +
	...
	"\x10project_settings\x18\v \x01(\v2#.chalk.artifacts.v1.ProjectSettingsR\x0fprojectSettingsB\r\n" +
	"\v_git_branchB\r\n" +
	"\v_git_commitB\t\n" +
	"\a_git_prB\r\n" +
	"\v_git_authorB\n" +
	...
	"\rdeployment_id\x18\x01 \x01(\tR\fdeploymentId*\xe3\x03\n" +
	...
	" BRANCH_SCALING_STATE_IN_PROGRESS\x10\x022\xac!\n" +
	"\x0eBuilderService\x12l\n" +
	"\x0fGetSearchConfig\x12'.chalk.server.v1.GetSearchConfigRequest\x1a(.chalk.server.v1.GetSearchConfigResponse\"\x06\x80}\x02\x90\x02\x01\x12x\n" +
	"\x12ActivateDeployment\x12*.chalk.server.v1.ActivateDeploymentRequest\x1a+.chalk.server.v1.ActivateDeploymentResponse\"\t\x80}\x0e\x8a\xd3\x0e\x02\b\x02\x12i\n" +
	...
	"\x14DeployKubeComponents\x12,.chalk.server.v1.DeployKubeComponentsRequest\x1a-.chalk.server.v1.DeployKubeComponentsResponse\"\t\x80}\f\x8a\xd3\x0e\x02\b\x02\x12u\n" +
	"\x11RebuildDeployment\x12).chalk.server.v1.RebuildDeploymentRequest\x1a*.chalk.server.v1.RebuildDeploymentResponse\"\t\x80}\x0e\x8a\xd3\x0e\x02\b\x02\x12x\n" +
	"\x12RedeployDeployment\x12*.chalk.server.v1.RedeployDeploymentRequest\x1a+.chalk.server.v1.RedeployDeploymentResponse\"\t\x80}\x0e\x8a\xd3\x0e\x02\b\x02\x12`\n" +
	...
	"\x12\x8a\x01\n" +
	"\x1aGetClusterTimescaleDefault\x122.chalk.server.v1.GetClusterTimescaleDefaultRequest\x1a3.chalk.server.v1.GetClusterTimescaleDefaultResponse\"\x03\x80}\v\x12\x87\x01\n" +
	...
	"\x10GetBranchProfile\x12(.chalk.server.v1.GetBranchProfileRequest\x1a).chalk.server.v1.GetBranchProfileResponse\"\x03\x80}\x02\x12c\n" +
	"\fGetNodepools\x12$.chalk.server.v1.GetNodepoolsRequest\x1a%.chalk.server.v1.GetNodepoolsResponse\"\x06\x80}\v\x90\x02\x01\x12c\n" +
	"\vAddNodepool\x12#.chalk.server.v1.AddNodepoolRequest\x1a$.chalk.server.v1.AddNodepoolResponse\"\t\x80}\f\x8a\xd3\x0e\x02\b\x02\x12l\n" +
	"\x0eUpdateNodepool\x12&.chalk.server.v1.UpdateNodepoolRequest\x1a'.chalk.server.v1.UpdateNodepoolResponse\"\t\x80}\f\x8a\xd3\x0e\x02\b\x02\x12l\n" +
	"\x0eDeleteNodepool\x12&.chalk.server.v1.DeleteNodepoolRequest\x1a'.chalk.server.v1.DeleteNodepoolResponse\"\t\x80}\f\x8a\xd3\x0e\x02\b\x02\x12\x81\x01\n" +
	"\x15GetKarpenterNodepools\x12-.chalk.server.v1.GetKarpenterNodepoolsRequest\x1a..chalk.server.v1.GetKarpenterNodepoolsResponse\"\t\x80}\v\x88\x02\x01\x90\x02\x01\x12\x81\x01\n" +
	"\x14AddKarpenterNodepool\x12,.chalk.server.v1.AddKarpenterNodepoolRequest\x1a-.chalk.server.v1.AddKarpenterNodepoolResponse\"\f\x80}\f\x8a\xd3\x0e\x02\b\x02\x88\x02\x01\x12\x8a\x01\n" +
	"\x17UpdateKarpenterNodepool\x12/.chalk.server.v1.UpdateKarpenterNodepoolRequest\x1a0.chalk.server.v1.UpdateKarpenterNodepoolResponse\"\f\x80}\f\x8a\xd3\x0e\x02\b\x02\x88\x02\x01\x12\x8a\x01\n" +
	"\x17DeleteKarpenterNodepool\x12/.chalk.server.v1.DeleteKarpenterNodepoolRequest\x1a0.chalk.server.v1.DeleteKarpenterNodepoolResponse\"\f\x80}\f\x8a\xd3\x0e\x02\b\x02\x88\x02\x01\x12\x9f\x01\n" +
	...
	"\rGetTagWeights\x12%.chalk.server.v1.GetTagWeightsRequest\x1a&.chalk.server.v1.GetTagWeightsResponse\"\x03\x80}\v\x12i\n" +
	"\rSetTagWeights\x12%.chalk.server.v1.SetTagWeightsRequest\x1a&.chalk.server.v1.SetTagWeightsResponse\"\t\x80}\f\x8a\xd3\x0e\x02\b\x02\x12r\n" +
	"\x10CreateDeployment\x12(.chalk.server.v1.CreateDeploymentRequest\x1a).chalk.server.v1.CreateDeploymentResponse\"\t\x80}\f\x8a\xd3\x0e\x02\b\x022\xf0\x01\n" +
