...
var file_chalk_server_v1_bootstrap_proto_rawDesc = []byte{
	...
	0x6f, 0x22, 0xfd, 0x01, 0x0a, 0x16, 0x50, 0x61, 0x72, 0x73, 0x65, 0x64, 0x42, 0x6f, 0x6f, 0x74,
	...
	0x73, 0x42, 0xbe, 0x01, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x68, 0x61, 0x6c, 0x6b, 0x2e,
	0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x42, 0x0e, 0x42, 0x6f, 0x6f, 0x74, 0x73,
	0x74, 0x72, 0x61, 0x70, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x39, 0x67, 0x69, 0x74,
...
var file_chalk_server_v1_bootstrap_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_chalk_server_v1_bootstrap_proto_goTypes = []any{
	(*ParsedBootstrapConfigs)(nil), // 0: chalk.server.v1.ParsedBootstrapConfigs
	(*Team)(nil),                   // 1: chalk.server.v1.Team
	(*Project)(nil),                // 2: chalk.server.v1.Project
	(*Environment)(nil),            // 3: chalk.server.v1.Environment
	(*TeamInvite)(nil),             // 4: chalk.server.v1.TeamInvite
}
var file_chalk_server_v1_bootstrap_proto_depIdxs = []int32{
	1, // 0: chalk.server.v1.ParsedBootstrapConfigs.teams:type_name -> chalk.server.v1.Team
	2, // 1: chalk.server.v1.ParsedBootstrapConfigs.projects:type_name -> chalk.server.v1.Project
	3, // 2: chalk.server.v1.ParsedBootstrapConfigs.environments:type_name -> chalk.server.v1.Environment
	4, // 3: chalk.server.v1.ParsedBootstrapConfigs.team_invites:type_name -> chalk.server.v1.TeamInvite
