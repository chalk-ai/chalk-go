...
func file_chalk_server_v1_bootstrap_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chalk_server_v1_bootstrap_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*BootstrapExtraSettingsEnvironment); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chalk_server_v1_bootstrap_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*BootstrapExtraSettings); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chalk_server_v1_bootstrap_proto_msgTypes[2].Exporter = func(v any, i int) any {
