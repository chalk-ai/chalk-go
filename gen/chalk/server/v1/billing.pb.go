...
var file_chalk_server_v1_billing_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x64, 0x73, 0x2a, 0x74, 0x0a, 0x10, 0x55, 0x73, 0x61, 0x67, 0x65, 0x43, 0x68, 0x61,
	0x72, 0x74, 0x50, 0x65, 0x72, 0x69, 0x6f, 0x64, 0x12, 0x22, 0x0a, 0x1e, 0x55, 0x53, 0x41, 0x47,
	0x45, 0x5f, 0x43, 0x48, 0x41, 0x52, 0x54, 0x5f, 0x50, 0x45, 0x52, 0x49, 0x4f, 0x44, 0x5f, 0x55,
	...
	,
	...
	0x02, 0x01, 0x42, 0xbc, 0x01, 0x0a, 0x13, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x68, 0x61, 0x6c, 0x6b,
	0x2e, 0x73, 0x65, 0x72, 0x76, 0x65, 0x72, 0x2e, 0x76, 0x31, 0x42, 0x0c, 0x42, 0x69, 0x6c, 0x6c,
...
var file_chalk_server_v1_billing_proto_msgTypes = make([]protoimpl.MessageInfo, 8)
var file_chalk_server_v1_billing_proto_goTypes = []any{
	...
	(*Chart)(nil),                       // 10: chalk.server.v1.Chart
	(*v1.MachineRate)(nil),              // 11: chalk.usage.v1.MachineRate
	(*v11.NodeStatusPubSub)(nil),        // 12: chalk.pubsub.v1.NodeStatusPubSub
	(*v11.PodStatusPubSub)(nil),         // 13: chalk.pubsub.v1.PodStatusPubSub
	(*v12.KubernetesNodeData)(nil),      // 14: chalk.kubernetes.v1.KubernetesNodeData
	(*v12.KubernetesPodData)(nil),       // 15: chalk.kubernetes.v1.KubernetesPodData
	(*GetPodRequestChartsRequest)(nil),  // 16: chalk.server.v1.GetPodRequestChartsRequest
	(*GetPodRequestChartsResponse)(nil), // 17: chalk.server.v1.GetPodRequestChartsResponse
}
var file_chalk_server_v1_billing_proto_depIdxs = []int32{
	...
	10, // 2: chalk.server.v1.GetUsageChartResponse.chart:type_name -> chalk.server.v1.Chart
	11, // 3: chalk.server.v1.GetUtilizationRatesResponse.rates:type_name -> chalk.usage.v1.MachineRate
	12, // 4: chalk.server.v1.GetNodesAndPodsResponse.nodes:type_name -> chalk.pubsub.v1.NodeStatusPubSub
	13, // 5: chalk.server.v1.GetNodesAndPodsResponse.pods:type_name -> chalk.pubsub.v1.PodStatusPubSub
	14, // 6: chalk.server.v1.GetNodesAndPodsUIResponse.nodes:type_name -> chalk.kubernetes.v1.KubernetesNodeData
	15, // 7: chalk.server.v1.GetNodesAndPodsUIResponse.pods:type_name -> chalk.kubernetes.v1.KubernetesPodData
	...
	16, // 12: chalk.server.v1.BillingService.GetPodRequestCharts:input_type -> chalk.server.v1.GetPodRequestChartsRequest
	9,  // 13: chalk.server.v1.BillingService.GetNodesAndPodsUI:output_type -> chalk.server.v1.GetNodesAndPodsUIResponse
	7,  // 14: chalk.server.v1.BillingService.GetNodesAndPods:output_type -> chalk.server.v1.GetNodesAndPodsResponse
	3,  // 15: chalk.server.v1.BillingService.GetUsageChart:output_type -> chalk.server.v1.GetUsageChartResponse
	5,  // 16: chalk.server.v1.BillingService.GetUtilizationRates:output_type -> chalk.server.v1.GetUtilizationRatesResponse
	17, // 17: chalk.server.v1.BillingService.GetPodRequestCharts:output_type -> chalk.server.v1.GetPodRequestChartsResponse
...
func file_chalk_server_v1_billing_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_chalk_server_v1_billing_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*GetNodesAndPodsUIRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chalk_server_v1_billing_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*GetNodesAndPodsUIResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
