...
var file_chalk_server_v1_billing_proto_rawDesc = []byte{
	...
	0x72, 0x61, 0x74, 0x65, 0x73, 0x2a, 0x74, 0x0a, 0x10, 0x55, 0x73, 0x61, 0x67, 0x65, 0x43, 0x68,
	...
	0x10, 0x02, 0x32, 0xcb, 0x02, 0x0a, 0x0e, 0x42, 0x69, 0x6c, 0x6c, 0x69, 0x6e, 0x67, 0x53, 0x65,
...
var file_chalk_server_v1_billing_proto_goTypes = []any{
	...
	(*v1.NodeStatusPubSub)(nil),         // 8: chalk.pubsub.v1.NodeStatusPubSub
	(*v1.PodStatusPubSub)(nil),          // 9: chalk.pubsub.v1.PodStatusPubSub
	(*Chart)(nil),                       // 10: chalk.server.v1.Chart
	(*v11.MachineRate)(nil),             // 11: chalk.usage.v1.MachineRate
}
var file_chalk_server_v1_billing_proto_depIdxs = []int32{
	8,  // 0: chalk.server.v1.GetNodesResponse.node_statuses:type_name -> chalk.pubsub.v1.NodeStatusPubSub
	9,  // 1: chalk.server.v1.GetNodesResponse.pod_statuses:type_name -> chalk.pubsub.v1.PodStatusPubSub
	...
	10, // 4: chalk.server.v1.GetUsageChartResponse.chart:type_name -> chalk.server.v1.Chart
	11, // 5: chalk.server.v1.GetUtilizationRatesResponse.rates:type_name -> chalk.usage.v1.MachineRate
	2,  // 6: chalk.server.v1.BillingService.GetNodes:input_type -> chalk.server.v1.GetNodesRequest
	4,  // 7: chalk.server.v1.BillingService.GetUsageChart:input_type -> chalk.server.v1.GetUsageChartRequest
	6,  // 8: chalk.server.v1.BillingService.GetUtilizationRates:input_type -> chalk.server.v1.GetUtilizationRatesRequest
	3,  // 9: chalk.server.v1.BillingService.GetNodes:output_type -> chalk.server.v1.GetNodesResponse
	5,  // 10: chalk.server.v1.BillingService.GetUsageChart:output_type -> chalk.server.v1.GetUsageChartResponse
	7,  // 11: chalk.server.v1.BillingService.GetUtilizationRates:output_type -> chalk.server.v1.GetUtilizationRatesResponse
