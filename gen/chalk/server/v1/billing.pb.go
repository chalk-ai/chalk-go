...
const file_chalk_server_v1_billing_proto_rawDesc = "" +
	...
	"\x1cUSAGE_CHART_GROUPING_CLUSTER\x10\x022\xbc\x05\n" +
	...
	"\x0fSyncUtilization\x12'.chalk.server.v1.SyncUtilizationRequest\x1a(.chalk.server.v1.SyncUtilizationResponse\"\x06\x80}\x1b\x90\x02\x01B\xbc\x01\n" +
