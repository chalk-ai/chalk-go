...
var file_chalk_server_v1_audit_proto_goTypes = []interface{}{
...
func file_chalk_server_v1_audit_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chalk_server_v1_audit_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_server_v1_audit_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_server_v1_audit_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
	...
	file_chalk_server_v1_audit_proto_msgTypes[0].OneofWrappers = []interface{}{}
	type x struct{}
