...
func (x *InMemoryTopic) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InMemoryTopic) ProtoMessage() {}

func (x *InMemoryTopic) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_topic_proto_msgTypes[2]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InMemoryTopic.ProtoReflect.Descriptor instead.
func (*InMemoryTopic) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_topic_proto_rawDescGZIP(), []int{2}
}

func (x *InMemoryTopic) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *Topic) Reset() {
	*x = Topic{}
	mi := &file_chalk_server_v1_topic_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*Topic) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_topic_proto_rawDescGZIP(), []int{3}
}
...
func (x *Topic) GetSqsTopic() *SQSTopic {
	if x, ok := x.GetTopic().(*Topic_SqsTopic); ok {
		return x.SqsTopic
	}
	return nil
}
...
func (x *Topic) GetPubsubTopic() *PubSubTopic {
	if x, ok := x.GetTopic().(*Topic_PubsubTopic); ok {
		return x.PubsubTopic
	}
	return nil
}

func (x *Topic) GetInMemoryTopic() *InMemoryTopic {
	if x, ok := x.GetTopic().(*Topic_InMemoryTopic); ok {
		return x.InMemoryTopic
	}
	return nil
}
...
type Topic_InMemoryTopic struct {
	InMemoryTopic *InMemoryTopic `protobuf:"bytes,3,opt,name=in_memory_topic,json=inMemoryTopic,proto3,oneof"`
}
...
func (*Topic_InMemoryTopic) isTopic_Topic() {}

var File_chalk_server_v1_topic_proto protoreflect.FileDescriptor

var file_chalk_server_v1_topic_proto_rawDesc = []byte{
	,
...
var (
	...
	file_chalk_server_v1_topic_proto_rawDescData = file_chalk_server_v1_topic_proto_rawDesc
)

func file_chalk_server_v1_topic_proto_rawDescGZIP() []byte {
	file_chalk_server_v1_topic_proto_rawDescOnce.Do(func() {
		file_chalk_server_v1_topic_proto_rawDescData = protoimpl.X.CompressGZIP(file_chalk_server_v1_topic_proto_rawDescData)
	})
	return file_chalk_server_v1_topic_proto_rawDescData
}

var file_chalk_server_v1_topic_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_chalk_server_v1_topic_proto_goTypes = []any{
	...
	(*InMemoryTopic)(nil), // 2: chalk.server.v1.InMemoryTopic
	(*Topic)(nil),         // 3: chalk.server.v1.Topic
}
var file_chalk_server_v1_topic_proto_depIdxs = []int32{
	...
	2, // 2: chalk.server.v1.Topic.in_memory_topic:type_name -> chalk.server.v1.InMemoryTopic
...
func file_chalk_server_v1_topic_proto_init() {
	...
	file_chalk_server_v1_topic_proto_msgTypes[3].OneofWrappers = []any{
		(*Topic_SqsTopic)(nil),
		(*Topic_PubsubTopic)(nil),
		(*Topic_InMemoryTopic)(nil),
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_chalk_server_v1_topic_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
	...
	file_chalk_server_v1_topic_proto_rawDesc = nil
