...
func (x *Topic) GetInMemoryTopic() *InMemoryTopic {
	if x != nil {
		if x, ok := x.Topic.(*Topic_InMemoryTopic); ok {
...
const file_chalk_server_v1_topic_proto_rawDesc = "" +
	...
	"\fpubsub_topic\x18\x02 \x01(\v2\x1c.chalk.server.v1.PubSubTopicH\x00R\vpubsubTopic\x12H\n" +
	"\x0fin_memory_topic\x18\x03 \x01(\v2\x1e.chalk.server.v1.InMemoryTopicH\x00R\rinMemoryTopicB\a\n" +
	"\x05topicB\xba\x01\n" +
