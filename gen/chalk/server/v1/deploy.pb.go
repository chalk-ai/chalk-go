...
var file_chalk_server_v1_deploy_proto_goTypes = []any{
	...
	(*Deployment)(nil),                               // 21: chalk.server.v1.Deployment
	(*InstanceSizing)(nil),                           // 22: chalk.server.v1.InstanceSizing
}
var file_chalk_server_v1_deploy_proto_depIdxs = []int32{
	...
	20, // 6: chalk.server.v1.GetDeploymentRequest.read_mask:type_name -> google.protobuf.FieldMask
	21, // 7: chalk.server.v1.GetDeploymentResponse.deployment:type_name -> chalk.server.v1.Deployment
	18, // 8: chalk.server.v1.GetDeploymentResponse.export:type_name -> chalk.artifacts.v1.Export
	21, // 9: chalk.server.v1.ListDeploymentsResponse.deployments:type_name -> chalk.server.v1.Deployment
	21, // 10: chalk.server.v1.SuspendDeploymentResponse.deployment:type_name -> chalk.server.v1.Deployment
	22, // 11: chalk.server.v1.ScaleDeploymentRequest.sizing:type_name -> chalk.server.v1.InstanceSizing
	21, // 12: chalk.server.v1.ScaleDeploymentResponse.deployment:type_name -> chalk.server.v1.Deployment
	21, // 13: chalk.server.v1.TagDeploymentResponse.deployment:type_name -> chalk.server.v1.Deployment
	21, // 14: chalk.server.v1.GetActiveDeploymentsResponse.deployments:type_name -> chalk.server.v1.Deployment
	...
	1,  // 23: chalk.server.v1.DeployService.DeployBranch:output_type -> chalk.server.v1.DeployBranchResponse
	3,  // 24: chalk.server.v1.DeployService.CreateBranchFromSourceDeployment:output_type -> chalk.server.v1.CreateBranchFromSourceDeploymentResponse
	5,  // 25: chalk.server.v1.DeployService.GetDeployment:output_type -> chalk.server.v1.GetDeploymentResponse
	7,  // 26: chalk.server.v1.DeployService.ListDeployments:output_type -> chalk.server.v1.ListDeploymentsResponse
	15, // 27: chalk.server.v1.DeployService.GetActiveDeployments:output_type -> chalk.server.v1.GetActiveDeploymentsResponse
	9,  // 28: chalk.server.v1.DeployService.SuspendDeployment:output_type -> chalk.server.v1.SuspendDeploymentResponse
	11, // 29: chalk.server.v1.DeployService.ScaleDeployment:output_type -> chalk.server.v1.ScaleDeploymentResponse
	13, // 30: chalk.server.v1.DeployService.TagDeployment:output_type -> chalk.server.v1.TagDeploymentResponse
