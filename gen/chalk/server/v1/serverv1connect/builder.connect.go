...
func NewBuilderServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) BuilderServiceClient {
	...
	return &builderServiceClient{
		...
		validateNamedQueries: connect.NewClient[v1.ValidateNamedQueriesRequest, v1.ValidateNamedQueriesResponse](
			httpClient,
		...
		startShadowBuildFromDeployment: connect.NewClient[v1.StartShadowBuildFromDeploymentRequest, v1.StartShadowBuildFromDeploymentResponse](
			httpClient,
			baseURL+BuilderServiceStartShadowBuildFromDeploymentProcedure,
			connect.WithSchema(builderServiceMethods.ByName("StartShadowBuildFromDeployment")),
			connect.WithClientOptions(opts...),
		),
		...
		resolveEngineBaseImage: connect.NewClient[v1.ResolveEngineBaseImageRequest, v1.ResolveEngineBaseImageResponse](
			httpClient,
		...
		prepareDeployment: connect.NewClient[v1.PrepareDeploymentRequest, v1.PrepareDeploymentResponse](
			httpClient,
			baseURL+BuilderServicePrepareDeploymentProcedure,
...
func (c *builderServiceClient) StartShadowBuildFromDeployment(ctx context.Context, req *connect.Request[v1.StartShadowBuildFromDeploymentRequest]) (*connect.Response[v1.StartShadowBuildFromDeploymentResponse], error) {
	return c.startShadowBuildFromDeployment.CallUnary(ctx, req)
}
...
// PrepareDeployment calls chalk.server.v1.BuilderService.PrepareDeployment.
func (c *builderServiceClient) PrepareDeployment(ctx context.Context, req *connect.Request[v1.PrepareDeploymentRequest]) (*connect.Response[v1.PrepareDeploymentResponse], error) {
...
func NewBuilderServiceHandler(svc BuilderServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	builderServiceValidateNamedQueriesHandler := connect.NewUnaryHandler(
	...
	builderServiceStartShadowBuildFromDeploymentHandler := connect.NewUnaryHandler(
		BuilderServiceStartShadowBuildFromDeploymentProcedure,
		svc.StartShadowBuildFromDeployment,
		connect.WithSchema(builderServiceMethods.ByName("StartShadowBuildFromDeployment")),
		connect.WithHandlerOptions(opts...),
	)
	...
	builderServiceResolveEngineBaseImageHandler := connect.NewUnaryHandler(
	...
	builderServicePrepareDeploymentHandler := connect.NewUnaryHandler(
		BuilderServicePrepareDeploymentProcedure,
