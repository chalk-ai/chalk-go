...
const file_chalk_server_v1_topicpush_proto_rawDesc = "" +
	...
	"\x05queue\x18\t \x01(\x0e2\x1f.chalk.server.v1.TopicPushQueueR\x05queue\x1a=\n" +
	"\x0fAttributesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01B\x0e\n" +
	"\f_environment\"D\n" +
	"\x11UpdateJobResponse\x12/\n" +
	"\x03job\x18\x01 \x01(\v2\x1d.chalk.server.v1.ScheduledJobR\x03job\"H\n" +
	"\x0fListJobsRequest\x125\n" +
	"\x05queue\x18\x01 \x01(\x0e2\x1f.chalk.server.v1.TopicPushQueueR\x05queue\"E\n" +
	"\x10ListJobsResponse\x121\n" +
	"\x04jobs\x18\x01 \x03(\v2\x1d.chalk.server.v1.ScheduledJobR\x04jobs\"\x9e\x03\n" +
	...
	"\x03job\x18\x01 \x01(\v2\x1d.chalk.server.v1.ScheduledJobR\x03job\"Y\n" +
	"\x10DeleteJobRequest\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x125\n" +
	"\x05queue\x18\x02 \x01(\x0e2\x1f.chalk.server.v1.TopicPushQueueR\x05queue\"\x13\n" +
	"\x11DeleteJobResponse\"`\n" +
	"\x13GetJobByNameRequest\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x125\n" +
	"\x05queue\x18\x02 \x01(\x0e2\x1f.chalk.server.v1.TopicPushQueueR\x05queue\"G\n" +
	"\x14GetJobByNameResponse\x12/\n" +
	"\x03job\x18\x01 \x01(\v2\x1d.chalk.server.v1.ScheduledJobR\x03job*n\n" +
	"\x0eTopicPushQueue\x12 \n" +
	"\x1cTOPIC_PUSH_QUEUE_UNSPECIFIED\x10\x00\x12\x1c\n" +
	"\x18TOPIC_PUSH_QUEUE_DEFAULT\x10\x01\x12\x1c\n" +
	"\x18TOPIC_PUSH_QUEUE_METRICS\x10\x022\xde\x03\n" +
