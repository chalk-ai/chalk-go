...
var file_chalk_server_v1_cli_proto_rawDesc = []byte{
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x06, 0x80, 0x7d, 0x01, 0x90, 0x02, 0x01, 0x42, 0xb8, 0x01,
...
func file_chalk_server_v1_cli_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chalk_server_v1_cli_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_chalk_server_v1_cli_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_chalk_server_v1_cli_proto_msgTypes[2].Exporter = func(v any, i int) any {
