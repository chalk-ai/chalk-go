...
type SourceImageSpecs struct {
	state                  protoimpl.MessageState      `protogen:"open.v1"`
	Specs                  map[string]*SourceImageSpec `protobuf:"bytes,1,rep,name=specs,proto3" json:"specs,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type Deployment struct {
	...
	// Order-independent content hash over every regular file in the uploaded
	// deployment source archive (distinct from the dependency hashes above, which
...
func (x *Deployment) GetSourceCodeHash() string {
	if x != nil && x.SourceCodeHash != nil {
...
const file_chalk_server_v1_deployment_proto_rawDesc = "" +
	"\n" +
	" chalk/server/v1/deployment.proto\x12\x0fchalk.server.v1\x1a!chalk/server/v1/environment.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x88\x01\n" +
	...
	"\x16preview_deployment_tag\x18\x1b \x01(\tB\x02\x18\x01H\aR\x14previewDeploymentTag\x88\x01\x01\x12X\n" +
	"\x0eprofiling_mode\x18\x1c \x01(\x0e2(.chalk.server.v1.DeploymentProfilingModeB\x02\x18\x01H\bR\rprofilingMode\x88\x01\x01\x121\n" +
	"\x12source_image_specs\x18\x1d \x01(\fH\tR\x10sourceImageSpecs\x88\x01\x01\x129\n" +
	"\x19uses_uploaded_proto_graph\x18\x1e \x01(\bR\x16usesUploadedProtoGraph\x12Q\n" +
	"\rbuild_profile\x18\x1f \x01(\x0e2'.chalk.server.v1.DeploymentBuildProfileH\n" +
	"R\fbuildProfile\x88\x01\x01\x126\n" +
	"\x15customer_cicd_job_url\x18  \x01(\tH\vR\x12customerCicdJobUrl\x88\x01\x01\x120\n" +
	...
	"\x1bDEPLOYMENT_STATUS_DEPLOYING\x10\r*\x8e\x01\n" +
	...
	"\x1cDEPLOYMENT_PROFILING_MODE_O2\x10\x02\x1a\x02\x18\x01B\xbf\x01\n" +
