...
type CloudComponentCluster_DeployAuxiliaryComponents int32

const (
	CloudComponentCluster_DEPLOY_AUXILIARY_COMPONENTS_NONE_UNSPECIFIED CloudComponentCluster_DeployAuxiliaryComponents = 0
	CloudComponentCluster_DEPLOY_AUXILIARY_COMPONENTS_ENABLED          CloudComponentCluster_DeployAuxiliaryComponents = 1
)

// Enum value maps for CloudComponentCluster_DeployAuxiliaryComponents.
var (
	CloudComponentCluster_DeployAuxiliaryComponents_name = map[int32]string{
		0: "DEPLOY_AUXILIARY_COMPONENTS_NONE_UNSPECIFIED",
		1: "DEPLOY_AUXILIARY_COMPONENTS_ENABLED",
	}
	CloudComponentCluster_DeployAuxiliaryComponents_value = map[string]int32{
		"DEPLOY_AUXILIARY_COMPONENTS_NONE_UNSPECIFIED": 0,
		"DEPLOY_AUXILIARY_COMPONENTS_ENABLED":          1,
	}
)

func (x CloudComponentCluster_DeployAuxiliaryComponents) Enum() *CloudComponentCluster_DeployAuxiliaryComponents {
	p := new(CloudComponentCluster_DeployAuxiliaryComponents)
	*p = x
	return p
}

func (x CloudComponentCluster_DeployAuxiliaryComponents) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CloudComponentCluster_DeployAuxiliaryComponents) Descriptor() protoreflect.EnumDescriptor {
	return file_chalk_server_v1_cloud_components_proto_enumTypes[2].Descriptor()
}

func (CloudComponentCluster_DeployAuxiliaryComponents) Type() protoreflect.EnumType {
	return &file_chalk_server_v1_cloud_components_proto_enumTypes[2]
}

func (x CloudComponentCluster_DeployAuxiliaryComponents) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CloudComponentCluster_DeployAuxiliaryComponents.Descriptor instead.
func (CloudComponentCluster_DeployAuxiliaryComponents) EnumDescriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{33, 0}
}

type CloudComponentCluster_ChalkDataplaneVersion int32

const (
	CloudComponentCluster_CHALK_DATAPLANE_VERSION_UNSPECIFIED CloudComponentCluster_ChalkDataplaneVersion = 0
	CloudComponentCluster_CHALK_DATAPLANE_VERSION_V1          CloudComponentCluster_ChalkDataplaneVersion = 1
	CloudComponentCluster_CHALK_DATAPLANE_VERSION_V2          CloudComponentCluster_ChalkDataplaneVersion = 2
)

// Enum value maps for CloudComponentCluster_ChalkDataplaneVersion.
var (
	CloudComponentCluster_ChalkDataplaneVersion_name = map[int32]string{
		0: "CHALK_DATAPLANE_VERSION_UNSPECIFIED",
		1: "CHALK_DATAPLANE_VERSION_V1",
		2: "CHALK_DATAPLANE_VERSION_V2",
	}
	CloudComponentCluster_ChalkDataplaneVersion_value = map[string]int32{
		"CHALK_DATAPLANE_VERSION_UNSPECIFIED": 0,
		"CHALK_DATAPLANE_VERSION_V1":          1,
		"CHALK_DATAPLANE_VERSION_V2":          2,
	}
)

func (x CloudComponentCluster_ChalkDataplaneVersion) Enum() *CloudComponentCluster_ChalkDataplaneVersion {
	p := new(CloudComponentCluster_ChalkDataplaneVersion)
	*p = x
	return p
}

func (x CloudComponentCluster_ChalkDataplaneVersion) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (CloudComponentCluster_ChalkDataplaneVersion) Descriptor() protoreflect.EnumDescriptor {
	return file_chalk_server_v1_cloud_components_proto_enumTypes[3].Descriptor()
}

func (CloudComponentCluster_ChalkDataplaneVersion) Type() protoreflect.EnumType {
	return &file_chalk_server_v1_cloud_components_proto_enumTypes[3]
}

func (x CloudComponentCluster_ChalkDataplaneVersion) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use CloudComponentCluster_ChalkDataplaneVersion.Descriptor instead.
func (CloudComponentCluster_ChalkDataplaneVersion) EnumDescriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{33, 1}
}
...
func (DataplaneController_Tier) Descriptor() protoreflect.EnumDescriptor {
	return file_chalk_server_v1_cloud_components_proto_enumTypes[4].Descriptor()
}

func (DataplaneController_Tier) Type() protoreflect.EnumType {
	return &file_chalk_server_v1_cloud_components_proto_enumTypes[4]
}
...
func (DataplaneController_Tier) EnumDescriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{35, 0}
}
...
type CloudComponentStorage struct {
	...
	// Object-expiration rules Chalk has configured on this bucket. This is the
	// recorded desired state: it is pushed to the bucket when the storage is created
	// and on every update, and is what clients render. Chalk does not poll the
	// provider, so a policy changed out-of-band (Terraform, a cloud console) will not
	// be reflected here until the next update through this API overwrites it.
	Retention     *CloudStorageLifecyclePolicy `protobuf:"bytes,2,opt,name=retention,proto3" json:"retention,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CloudComponentStorage) GetRetention() *CloudStorageLifecyclePolicy {
	if x != nil {
		return x.Retention
	}
	return nil
...
// A single object-expiration rule on a cloud storage bucket.
//
// This is a provider-neutral shape rather than a oneof per cloud: the three providers
// express expiration differently (GCS lifecycle rules, S3 lifecycle configuration,
// Azure account-level management policies), but the subset Chalk needs — "delete
// objects under this prefix once they are N days old" — is expressible on all three.
// go-api-server translates to and from the provider representation, so a caller does
// not have to know which cloud backs the storage. Anything a provider supports beyond
// this subset (storage-class transitions, version/snapshot actions, tag filters) is
// deliberately not modeled here and is preserved rather than rewritten where possible.
type CloudStorageLifecycleRule struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Rule name. S3 and Azure require one and it must be unique within the bucket or
	// account; GCS has no per-rule identity, so ids there are synthesized on read and
	// ignored on write. Leave empty on create and the server generates one.
	Id string `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// Delete objects this many days after they were last modified. Required, and must
	// be at least 1: expiration is the only action this API exposes, so a rule with no
	// age is not a rule.
	ExpireAfterDays int32 `protobuf:"varint,2,opt,name=expire_after_days,json=expireAfterDays,proto3" json:"expire_after_days,omitempty"`
	// Object key prefix the rule applies to. Empty means every object in the bucket.
	// The prefix is relative to the bucket (or, on Azure, to the container) and must
	// not repeat the bucket/container name.
	Prefix string `protobuf:"bytes,3,opt,name=prefix,proto3" json:"prefix,omitempty"`
	// Whether the rule is currently in force. A disabled rule is retained but does not
	// delete anything. GCS has no representation for a disabled lifecycle rule, so the
	// server rejects enabled=false on gcs storages rather than silently dropping the
	// rule; delete the rule instead.
	Enabled       bool `protobuf:"varint,4,opt,name=enabled,proto3" json:"enabled,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CloudStorageLifecycleRule) Reset() {
	*x = CloudStorageLifecycleRule{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CloudStorageLifecycleRule) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CloudStorageLifecycleRule) ProtoMessage() {}

func (x *CloudStorageLifecycleRule) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[21]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CloudStorageLifecycleRule.ProtoReflect.Descriptor instead.
func (*CloudStorageLifecycleRule) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{21}
}

func (x *CloudStorageLifecycleRule) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *CloudStorageLifecycleRule) GetExpireAfterDays() int32 {
	if x != nil {
...
func (x *CloudStorageLifecycleRule) GetPrefix() string {
	if x != nil {
		return x.Prefix
	}
	return ""
...
func (x *CloudStorageLifecycleRule) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
type CloudStorageLifecyclePolicy struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	Rules         []*CloudStorageLifecycleRule `protobuf:"bytes,1,rep,name=rules,proto3" json:"rules,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CloudStorageLifecyclePolicy) Reset() {
	*x = CloudStorageLifecyclePolicy{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[22]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CloudStorageLifecyclePolicy) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CloudStorageLifecyclePolicy) ProtoMessage() {}

func (x *CloudStorageLifecyclePolicy) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[22]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CloudStorageLifecyclePolicy.ProtoReflect.Descriptor instead.
func (*CloudStorageLifecyclePolicy) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{22}
}

func (x *CloudStorageLifecyclePolicy) GetRules() []*CloudStorageLifecycleRule {
	if x != nil {
		return x.Rules
	}
	return nil
...
type CloudComponentCluster struct {
	...
	// Create and bind the default gateway, persistence, and telemetry deployments after a managed
	// cluster finishes provisioning. This is create-time intent used by the Chalk UI; status reads do
	// not reconcile missing auxiliary components.
	DeployAuxiliaryComponents CloudComponentCluster_DeployAuxiliaryComponents `protobuf:"varint,10,opt,name=deploy_auxiliary_components,json=deployAuxiliaryComponents,proto3,enum=chalk.server.v1.CloudComponentCluster_DeployAuxiliaryComponents" json:"deploy_auxiliary_components,omitempty"`
	// Selects the Chalk dataplane architecture. Unset and V1 both resolve to V1.
	ChalkDataplaneVersion CloudComponentCluster_ChalkDataplaneVersion `protobuf:"varint,11,opt,name=chalk_dataplane_version,json=chalkDataplaneVersion,proto3,enum=chalk.server.v1.CloudComponentCluster_ChalkDataplaneVersion" json:"chalk_dataplane_version,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *CloudComponentCluster) GetDeployAuxiliaryComponents() CloudComponentCluster_DeployAuxiliaryComponents {
	if x != nil {
		return x.DeployAuxiliaryComponents
	}
	return CloudComponentCluster_DEPLOY_AUXILIARY_COMPONENTS_NONE_UNSPECIFIED
}

func (x *CloudComponentCluster) GetChalkDataplaneVersion() CloudComponentCluster_ChalkDataplaneVersion {
	if x != nil {
		return x.ChalkDataplaneVersion
	}
	return CloudComponentCluster_CHALK_DATAPLANE_VERSION_UNSPECIFIED
}
...
type DataplaneController struct {
	...
	// Host pools to deploy for this cluster. Deprecated: use HostPoolService.
	//
	// Deprecated: Marked as deprecated in chalk/server/v1/cloud_components.proto.
...
type ClusterDeploymentManifest struct {
	...
	ReplicationSource *ClusterReplicationSource `protobuf:"bytes,6,opt,name=replication_source,json=replicationSource,proto3" json:"replication_source,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}
...
func (x *ClusterDeploymentManifest) GetReplicationSource() *ClusterReplicationSource {
	if x != nil {
...
type CloudComponentClusterResponse struct {
	...
	// Source cluster whose Aurora global database this cluster joins.
	ClusterReplicationSourceId *string `protobuf:"bytes,16,opt,name=cluster_replication_source_id,json=clusterReplicationSourceId,proto3,oneof" json:"cluster_replication_source_id,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *CloudComponentClusterResponse) GetClusterReplicationSourceId() string {
	if x != nil && x.ClusterReplicationSourceId != nil {
		return *x.ClusterReplicationSourceId
	}
	return ""
}
...
type CreateCloudComponentClusterRequest struct {
	...
	// Source cluster whose Aurora global database the new cluster joins.
	ClusterReplicationSourceId *string `protobuf:"bytes,2,opt,name=cluster_replication_source_id,json=clusterReplicationSourceId,proto3,oneof" json:"cluster_replication_source_id,omitempty"`
	unknownFields              protoimpl.UnknownFields
	sizeCache                  protoimpl.SizeCache
}
...
func (x *CreateCloudComponentClusterRequest) GetClusterReplicationSourceId() string {
	if x != nil && x.ClusterReplicationSourceId != nil {
		return *x.ClusterReplicationSourceId
	}
	return ""
...
type DeleteCloudComponentClusterRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Id    string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// Deletes cluster-owned auxiliary resources before deleting the cluster. This is only valid for
	// Chalk-managed clusters and fails while any active environment references the cluster or one of
	// its auxiliary resources.
...
func (x *DeleteCloudComponentClusterRequest) GetForce() bool {
	if x != nil {
		return x.Force
	}
	return false
...
type RecoveryClusterTarget struct {
	state                         protoimpl.MessageState `protogen:"open.v1"`
	Id                            string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	EnvironmentId                 string                 `protobuf:"bytes,2,opt,name=environment_id,json=environmentId,proto3" json:"environment_id,omitempty"`
	ClusterId                     string                 `protobuf:"bytes,3,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`
	DataplaneDbBackupSecret       string                 `protobuf:"bytes,4,opt,name=dataplane_db_backup_secret,json=dataplaneDbBackupSecret,proto3" json:"dataplane_db_backup_secret,omitempty"`
	DataplaneDbBackupDirectSecret *string                `protobuf:"bytes,5,opt,name=dataplane_db_backup_direct_secret,json=dataplaneDbBackupDirectSecret,proto3,oneof" json:"dataplane_db_backup_direct_secret,omitempty"`
	Active                        bool                   `protobuf:"varint,6,opt,name=active,proto3" json:"active,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}

func (x *RecoveryClusterTarget) Reset() {
	*x = RecoveryClusterTarget{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[60]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *RecoveryClusterTarget) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RecoveryClusterTarget) ProtoMessage() {}

func (x *RecoveryClusterTarget) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[60]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RecoveryClusterTarget.ProtoReflect.Descriptor instead.
func (*RecoveryClusterTarget) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{60}
}

func (x *RecoveryClusterTarget) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *RecoveryClusterTarget) GetEnvironmentId() string {
	if x != nil {
		return x.EnvironmentId
	}
	return ""
...
func (x *RecoveryClusterTarget) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
func (x *RecoveryClusterTarget) GetDataplaneDbBackupSecret() string {
	if x != nil {
		return x.DataplaneDbBackupSecret
	}
	return ""
}

func (x *RecoveryClusterTarget) GetDataplaneDbBackupDirectSecret() string {
	if x != nil && x.DataplaneDbBackupDirectSecret != nil {
		return *x.DataplaneDbBackupDirectSecret
	}
	return ""
}

func (x *RecoveryClusterTarget) GetActive() bool {
	if x != nil {
		return x.Active
	}
	return false
...
type CreateRecoverClusterTargetRequest struct {
	state                         protoimpl.MessageState `protogen:"open.v1"`
	EnvironmentId                 string                 `protobuf:"bytes,1,opt,name=environment_id,json=environmentId,proto3" json:"environment_id,omitempty"`
	ClusterId                     string                 `protobuf:"bytes,2,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`
	DataplaneDbBackupSecret       string                 `protobuf:"bytes,3,opt,name=dataplane_db_backup_secret,json=dataplaneDbBackupSecret,proto3" json:"dataplane_db_backup_secret,omitempty"`
	DataplaneDbBackupDirectSecret *string                `protobuf:"bytes,4,opt,name=dataplane_db_backup_direct_secret,json=dataplaneDbBackupDirectSecret,proto3,oneof" json:"dataplane_db_backup_direct_secret,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}

func (x *CreateRecoverClusterTargetRequest) Reset() {
	*x = CreateRecoverClusterTargetRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[61]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreateRecoverClusterTargetRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateRecoverClusterTargetRequest) ProtoMessage() {}

func (x *CreateRecoverClusterTargetRequest) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[61]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateRecoverClusterTargetRequest.ProtoReflect.Descriptor instead.
func (*CreateRecoverClusterTargetRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{61}
}

func (x *CreateRecoverClusterTargetRequest) GetEnvironmentId() string {
	if x != nil {
		return x.EnvironmentId
	}
	return ""
...
func (x *CreateRecoverClusterTargetRequest) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
func (x *CreateRecoverClusterTargetRequest) GetDataplaneDbBackupSecret() string {
	if x != nil {
		return x.DataplaneDbBackupSecret
	}
	return ""
...
func (x *CreateRecoverClusterTargetRequest) GetDataplaneDbBackupDirectSecret() string {
	if x != nil && x.DataplaneDbBackupDirectSecret != nil {
		return *x.DataplaneDbBackupDirectSecret
	}
	return ""
...
type CreateRecoverClusterTargetResponse struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	RecoveryClusterTarget *RecoveryClusterTarget `protobuf:"bytes,1,opt,name=recovery_cluster_target,json=recoveryClusterTarget,proto3" json:"recovery_cluster_target,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}

func (x *CreateRecoverClusterTargetResponse) Reset() {
	*x = CreateRecoverClusterTargetResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[62]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreateRecoverClusterTargetResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateRecoverClusterTargetResponse) ProtoMessage() {}

func (x *CreateRecoverClusterTargetResponse) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[62]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateRecoverClusterTargetResponse.ProtoReflect.Descriptor instead.
func (*CreateRecoverClusterTargetResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{62}
}

func (x *CreateRecoverClusterTargetResponse) GetRecoveryClusterTarget() *RecoveryClusterTarget {
	if x != nil {
		return x.RecoveryClusterTarget
	}
	return nil
}
...
type UpdateCloudComponentStorageRequest struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	Id    string                 `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	// The desired spec. Only `retention` is mutable; `uri` identifies which bucket the
	// storage points at, so repointing it is a delete plus a create rather than an
	// update. Leave `uri` empty, or set it to the storage's current uri; anything else
	// is rejected. There is no field mask because retention is the only mutable field —
	// add one before making a second field mutable, rather than growing the
	// one-field-at-a-time handling that UpdateCloudComponentCluster ended up with.
	//
	// Retention is a replacement, not a merge: rules absent from the list are removed
	// from the bucket, and an empty list clears the policy.
	Spec          *CloudComponentStorage `protobuf:"bytes,2,opt,name=spec,proto3" json:"spec,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *UpdateCloudComponentStorageRequest) Reset() {
	*x = UpdateCloudComponentStorageRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[69]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateCloudComponentStorageRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateCloudComponentStorageRequest) ProtoMessage() {}

func (x *UpdateCloudComponentStorageRequest) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[69]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateCloudComponentStorageRequest.ProtoReflect.Descriptor instead.
func (*UpdateCloudComponentStorageRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{69}
}

func (x *UpdateCloudComponentStorageRequest) GetId() string {
	if x != nil {
		return x.Id
	}
	return ""
...
func (x *UpdateCloudComponentStorageRequest) GetSpec() *CloudComponentStorage {
	if x != nil {
		return x.Spec
	}
	return nil
...
type UpdateCloudComponentStorageResponse struct {
	state         protoimpl.MessageState         `protogen:"open.v1"`
	Storage       *CloudComponentStorageResponse `protobuf:"bytes,1,opt,name=storage,proto3" json:"storage,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *UpdateCloudComponentStorageResponse) Reset() {
	*x = UpdateCloudComponentStorageResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[70]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *UpdateCloudComponentStorageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*UpdateCloudComponentStorageResponse) ProtoMessage() {}

func (x *UpdateCloudComponentStorageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[70]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use UpdateCloudComponentStorageResponse.ProtoReflect.Descriptor instead.
func (*UpdateCloudComponentStorageResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{70}
}

func (x *UpdateCloudComponentStorageResponse) GetStorage() *CloudComponentStorageResponse {
	if x != nil {
		return x.Storage
	}
	return nil
...
// Services Gateway - Cluster bindings
type CreateBindingServicesGatewayRequest struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	ClusterId         string                 `protobuf:"bytes,1,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`
	ServicesGatewayId string                 `protobuf:"bytes,2,opt,name=services_gateway_id,json=servicesGatewayId,proto3" json:"services_gateway_id,omitempty"`
	unknownFields     protoimpl.UnknownFields
	sizeCache         protoimpl.SizeCache
}

func (x *CreateBindingServicesGatewayRequest) Reset() {
	*x = CreateBindingServicesGatewayRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[115]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreateBindingServicesGatewayRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateBindingServicesGatewayRequest) ProtoMessage() {}

func (x *CreateBindingServicesGatewayRequest) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[115]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateBindingServicesGatewayRequest.ProtoReflect.Descriptor instead.
func (*CreateBindingServicesGatewayRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{115}
}

func (x *CreateBindingServicesGatewayRequest) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
func (x *CreateBindingServicesGatewayRequest) GetServicesGatewayId() string {
	if x != nil {
		return x.ServicesGatewayId
	}
	return ""
}

type CreateBindingServicesGatewayResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *CreateBindingServicesGatewayResponse) Reset() {
	*x = CreateBindingServicesGatewayResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[116]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *CreateBindingServicesGatewayResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateBindingServicesGatewayResponse) ProtoMessage() {}

func (x *CreateBindingServicesGatewayResponse) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[116]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateBindingServicesGatewayResponse.ProtoReflect.Descriptor instead.
func (*CreateBindingServicesGatewayResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{116}
}

type DeleteBindingServicesGatewayRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ClusterId     string                 `protobuf:"bytes,1,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *DeleteBindingServicesGatewayRequest) Reset() {
	*x = DeleteBindingServicesGatewayRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[117]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeleteBindingServicesGatewayRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteBindingServicesGatewayRequest) ProtoMessage() {}

func (x *DeleteBindingServicesGatewayRequest) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[117]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteBindingServicesGatewayRequest.ProtoReflect.Descriptor instead.
func (*DeleteBindingServicesGatewayRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{117}
}

func (x *DeleteBindingServicesGatewayRequest) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
type DeleteBindingServicesGatewayResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *DeleteBindingServicesGatewayResponse) Reset() {
	*x = DeleteBindingServicesGatewayResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[118]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeleteBindingServicesGatewayResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeleteBindingServicesGatewayResponse) ProtoMessage() {}

func (x *DeleteBindingServicesGatewayResponse) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[118]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeleteBindingServicesGatewayResponse.ProtoReflect.Descriptor instead.
func (*DeleteBindingServicesGatewayResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{118}
}

type GetBindingServicesGatewayRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ClusterId     string                 `protobuf:"bytes,1,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *GetBindingServicesGatewayRequest) Reset() {
	*x = GetBindingServicesGatewayRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[119]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetBindingServicesGatewayRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBindingServicesGatewayRequest) ProtoMessage() {}

func (x *GetBindingServicesGatewayRequest) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[119]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBindingServicesGatewayRequest.ProtoReflect.Descriptor instead.
func (*GetBindingServicesGatewayRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{119}
}

func (x *GetBindingServicesGatewayRequest) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
type GetBindingServicesGatewayResponse struct {
	state             protoimpl.MessageState `protogen:"open.v1"`
	ClusterId         string                 `protobuf:"bytes,1,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`
	ServicesGatewayId string                 `protobuf:"bytes,2,opt,name=services_gateway_id,json=servicesGatewayId,proto3" json:"services_gateway_id,omitempty"`
	unknownFields     protoimpl.UnknownFields
...
func (x *GetBindingServicesGatewayResponse) Reset() {
	*x = GetBindingServicesGatewayResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[120]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *GetBindingServicesGatewayResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetBindingServicesGatewayResponse) ProtoMessage() {}

func (x *GetBindingServicesGatewayResponse) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[120]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetBindingServicesGatewayResponse.ProtoReflect.Descriptor instead.
func (*GetBindingServicesGatewayResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{120}
}

func (x *GetBindingServicesGatewayResponse) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
func (x *GetBindingServicesGatewayResponse) GetServicesGatewayId() string {
	if x != nil {
		return x.ServicesGatewayId
	}
	return ""
...
type ListBindingServicesGatewayRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	ClusterId     string                 `protobuf:"bytes,1,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
...
func (x *ListBindingServicesGatewayRequest) Reset() {
	*x = ListBindingServicesGatewayRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[121]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListBindingServicesGatewayRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListBindingServicesGatewayRequest) ProtoMessage() {}

func (x *ListBindingServicesGatewayRequest) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[121]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListBindingServicesGatewayRequest.ProtoReflect.Descriptor instead.
func (*ListBindingServicesGatewayRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{121}
}

func (x *ListBindingServicesGatewayRequest) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
type ListBindingServicesGatewayResponse struct {
	state         protoimpl.MessageState               `protogen:"open.v1"`
	Bindings      []*GetBindingServicesGatewayResponse `protobuf:"bytes,1,rep,name=bindings,proto3" json:"bindings,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ListBindingServicesGatewayResponse) Reset() {
	*x = ListBindingServicesGatewayResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[122]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListBindingServicesGatewayResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListBindingServicesGatewayResponse) ProtoMessage() {}

func (x *ListBindingServicesGatewayResponse) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[122]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListBindingServicesGatewayResponse.ProtoReflect.Descriptor instead.
func (*ListBindingServicesGatewayResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{122}
}

func (x *ListBindingServicesGatewayResponse) GetBindings() []*GetBindingServicesGatewayResponse {
	if x != nil {
		return x.Bindings
	}
	return nil
...
func (*CreateBindingEnvironmentGatewayResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{148}
}
...
func (x *DeleteBindingEnvironmentGatewayRequest) Reset() {
	*x = DeleteBindingEnvironmentGatewayRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[149]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteBindingEnvironmentGatewayRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{149}
}
...
func (x *DeleteBindingEnvironmentGatewayResponse) Reset() {
	*x = DeleteBindingEnvironmentGatewayResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[150]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteBindingEnvironmentGatewayResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{150}
}
...
func (x *GetBindingEnvironmentGatewayRequest) Reset() {
	*x = GetBindingEnvironmentGatewayRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[151]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetBindingEnvironmentGatewayRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{151}
}
...
func (x *GetBindingEnvironmentGatewayResponse) Reset() {
	*x = GetBindingEnvironmentGatewayResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[152]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetBindingEnvironmentGatewayResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{152}
}
...
func (x *ListBindingEnvironmentGatewayRequest) Reset() {
	*x = ListBindingEnvironmentGatewayRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[153]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListBindingEnvironmentGatewayRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{153}
}
...
func (x *ListBindingEnvironmentGatewayResponse) Reset() {
	*x = ListBindingEnvironmentGatewayResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[154]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ListBindingEnvironmentGatewayResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{154}
}
...
func (x *CreateBindingEnvironmentBackgroundPersistenceDeploymentRequest) Reset() {
	*x = CreateBindingEnvironmentBackgroundPersistenceDeploymentRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[155]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateBindingEnvironmentBackgroundPersistenceDeploymentRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{155}
}
...
func (x *CreateBindingEnvironmentBackgroundPersistenceDeploymentResponse) Reset() {
	*x = CreateBindingEnvironmentBackgroundPersistenceDeploymentResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[156]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*CreateBindingEnvironmentBackgroundPersistenceDeploymentResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{156}
}
...
func (x *DeleteBindingEnvironmentBackgroundPersistenceDeploymentRequest) Reset() {
	*x = DeleteBindingEnvironmentBackgroundPersistenceDeploymentRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[157]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteBindingEnvironmentBackgroundPersistenceDeploymentRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{157}
}
...
func (x *DeleteBindingEnvironmentBackgroundPersistenceDeploymentResponse) Reset() {
	*x = DeleteBindingEnvironmentBackgroundPersistenceDeploymentResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[158]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DeleteBindingEnvironmentBackgroundPersistenceDeploymentResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{158}
}
...
func (x *GetBindingEnvironmentBackgroundPersistenceDeploymentRequest) Reset() {
	*x = GetBindingEnvironmentBackgroundPersistenceDeploymentRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[159]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetBindingEnvironmentBackgroundPersistenceDeploymentRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{159}
}
...
func (*DataplaneDynamicConfig) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{163}
}
...
func (x *DataplaneControllerDynamicConfig) Reset() {
	*x = DataplaneControllerDynamicConfig{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[164]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*DataplaneControllerDynamicConfig) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{164}
}
...
func (x *HypervisorDynamicConfig) Reset() {
	*x = HypervisorDynamicConfig{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[165]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HypervisorDynamicConfig) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{165}
}

type ListRecoveryClusterTargetsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *ListRecoveryClusterTargetsRequest) Reset() {
	*x = ListRecoveryClusterTargetsRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[166]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListRecoveryClusterTargetsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRecoveryClusterTargetsRequest) ProtoMessage() {}

func (x *ListRecoveryClusterTargetsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[166]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRecoveryClusterTargetsRequest.ProtoReflect.Descriptor instead.
func (*ListRecoveryClusterTargetsRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{166}
}

type ListRecoveryClusterTargetsResponse struct {
	state                  protoimpl.MessageState   `protogen:"open.v1"`
	RecoveryClusterTargets []*RecoveryClusterTarget `protobuf:"bytes,1,rep,name=recovery_cluster_targets,json=recoveryClusterTargets,proto3" json:"recovery_cluster_targets,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}

func (x *ListRecoveryClusterTargetsResponse) Reset() {
	*x = ListRecoveryClusterTargetsResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[167]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ListRecoveryClusterTargetsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ListRecoveryClusterTargetsResponse) ProtoMessage() {}

func (x *ListRecoveryClusterTargetsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[167]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ListRecoveryClusterTargetsResponse.ProtoReflect.Descriptor instead.
func (*ListRecoveryClusterTargetsResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{167}
}

func (x *ListRecoveryClusterTargetsResponse) GetRecoveryClusterTargets() []*RecoveryClusterTarget {
	if x != nil {
		return x.RecoveryClusterTargets
	}
	return nil
}

type ActivateRecoveryClusterTargetRequest struct {
	state                   protoimpl.MessageState `protogen:"open.v1"`
	RecoveryClusterTargetId string                 `protobuf:"bytes,1,opt,name=recovery_cluster_target_id,json=recoveryClusterTargetId,proto3" json:"recovery_cluster_target_id,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}

func (x *ActivateRecoveryClusterTargetRequest) Reset() {
	*x = ActivateRecoveryClusterTargetRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[168]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActivateRecoveryClusterTargetRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActivateRecoveryClusterTargetRequest) ProtoMessage() {}

func (x *ActivateRecoveryClusterTargetRequest) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[168]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActivateRecoveryClusterTargetRequest.ProtoReflect.Descriptor instead.
func (*ActivateRecoveryClusterTargetRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{168}
}

func (x *ActivateRecoveryClusterTargetRequest) GetRecoveryClusterTargetId() string {
	if x != nil {
		return x.RecoveryClusterTargetId
	}
	return ""
}

type ActivateRecoveryClusterTargetResponse struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	RecoveryClusterTarget *RecoveryClusterTarget `protobuf:"bytes,1,opt,name=recovery_cluster_target,json=recoveryClusterTarget,proto3" json:"recovery_cluster_target,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
...
func (x *ActivateRecoveryClusterTargetResponse) Reset() {
	*x = ActivateRecoveryClusterTargetResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[169]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ActivateRecoveryClusterTargetResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ActivateRecoveryClusterTargetResponse) ProtoMessage() {}

func (x *ActivateRecoveryClusterTargetResponse) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[169]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ActivateRecoveryClusterTargetResponse.ProtoReflect.Descriptor instead.
func (*ActivateRecoveryClusterTargetResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{169}
}

func (x *ActivateRecoveryClusterTargetResponse) GetRecoveryClusterTarget() *RecoveryClusterTarget {
	if x != nil {
		return x.RecoveryClusterTarget
	}
	return nil
...
type DeactivateRecoveryClusterTargetRequest struct {
	state                   protoimpl.MessageState `protogen:"open.v1"`
	RecoveryClusterTargetId string                 `protobuf:"bytes,1,opt,name=recovery_cluster_target_id,json=recoveryClusterTargetId,proto3" json:"recovery_cluster_target_id,omitempty"`
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
...
func (x *DeactivateRecoveryClusterTargetRequest) Reset() {
	*x = DeactivateRecoveryClusterTargetRequest{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[170]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeactivateRecoveryClusterTargetRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeactivateRecoveryClusterTargetRequest) ProtoMessage() {}

func (x *DeactivateRecoveryClusterTargetRequest) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[170]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeactivateRecoveryClusterTargetRequest.ProtoReflect.Descriptor instead.
func (*DeactivateRecoveryClusterTargetRequest) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{170}
}

func (x *DeactivateRecoveryClusterTargetRequest) GetRecoveryClusterTargetId() string {
	if x != nil {
		return x.RecoveryClusterTargetId
	}
	return ""
...
type DeactivateRecoveryClusterTargetResponse struct {
	state                 protoimpl.MessageState `protogen:"open.v1"`
	RecoveryClusterTarget *RecoveryClusterTarget `protobuf:"bytes,1,opt,name=recovery_cluster_target,json=recoveryClusterTarget,proto3" json:"recovery_cluster_target,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
...
func (x *DeactivateRecoveryClusterTargetResponse) Reset() {
	*x = DeactivateRecoveryClusterTargetResponse{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[171]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *DeactivateRecoveryClusterTargetResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*DeactivateRecoveryClusterTargetResponse) ProtoMessage() {}

func (x *DeactivateRecoveryClusterTargetResponse) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[171]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use DeactivateRecoveryClusterTargetResponse.ProtoReflect.Descriptor instead.
func (*DeactivateRecoveryClusterTargetResponse) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{171}
}

func (x *DeactivateRecoveryClusterTargetResponse) GetRecoveryClusterTarget() *RecoveryClusterTarget {
	if x != nil {
		return x.RecoveryClusterTarget
	}
	return nil
...
type ClusterReplicationSource struct {
	state                  protoimpl.MessageState `protogen:"open.v1"`
	SourceCluster          *CloudComponentCluster `protobuf:"bytes,1,opt,name=source_cluster,json=sourceCluster,proto3" json:"source_cluster,omitempty"`
	SourceCloudCredentials *CloudConfig           `protobuf:"bytes,2,opt,name=source_cloud_credentials,json=sourceCloudCredentials,proto3" json:"source_cloud_credentials,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}

func (x *ClusterReplicationSource) Reset() {
	*x = ClusterReplicationSource{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[172]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *ClusterReplicationSource) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ClusterReplicationSource) ProtoMessage() {}

func (x *ClusterReplicationSource) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[172]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ClusterReplicationSource.ProtoReflect.Descriptor instead.
func (*ClusterReplicationSource) Descriptor() ([]byte, []int) {
	return file_chalk_server_v1_cloud_components_proto_rawDescGZIP(), []int{172}
}

func (x *ClusterReplicationSource) GetSourceCluster() *CloudComponentCluster {
	if x != nil {
...
func (x *ClusterReplicationSource) GetSourceCloudCredentials() *CloudConfig {
	if x != nil {
		return x.SourceCloudCredentials
	}
	return nil
}
...
func (x *DataplaneController_TierInfo) Reset() {
	*x = DataplaneController_TierInfo{}
	mi := &file_chalk_server_v1_cloud_components_proto_msgTypes[173]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
const file_chalk_server_v1_cloud_components_proto_rawDesc = "" +
	"\n" +
	"&chalk/server/v1/cloud_components.proto\x12\x0fchalk.server.v1\x1a\x19chalk/auth/v1/audit.proto\x1a\x1fchalk/auth/v1/permissions.proto\x1a\"chalk/server/v1/cloud_config.proto\x1a'chalk/server/v1/cloud_credentials.proto\x1a#chalk/server/v1/cluster_class.proto\x1a\x1achalk/server/v1/team.proto\x1a\x1fgoogle/api/field_behavior.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x94\x01\n" +
	...
	"\rip_cidr_range\x18\x02 \x01(\tR\vipCidrRange\"u\n" +
	"\x15CloudComponentStorage\x12\x10\n" +
	"\x03uri\x18\x01 \x01(\tR\x03uri\x12J\n" +
	"\tretention\x18\x02 \x01(\v2,.chalk.server.v1.CloudStorageLifecyclePolicyR\tretention\"\xf8\x03\n" +
	...
	"\x19CloudStorageLifecycleRule\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12*\n" +
	"\x11expire_after_days\x18\x02 \x01(\x05R\x0fexpireAfterDays\x12\x16\n" +
	"\x06prefix\x18\x03 \x01(\tR\x06prefix\x12\x18\n" +
	"\aenabled\x18\x04 \x01(\bR\aenabled\"_\n" +
	"\x1bCloudStorageLifecyclePolicy\x12@\n" +
	"\x05rules\x18\x01 \x03(\v2*.chalk.server.v1.CloudStorageLifecycleRuleR\x05rules\"\xbd\x02\n" +
	...
	"\x0edynamic_config\x18\t \x01(\v2'.chalk.server.v1.DataplaneDynamicConfigH\x05R\rdynamicConfig\x88\x01\x01\x12\x80\x01\n" +
	"\x1bdeploy_auxiliary_components\x18\n" +
	" \x01(\x0e2@.chalk.server.v1.CloudComponentCluster.DeployAuxiliaryComponentsR\x19deployAuxiliaryComponents\x12t\n" +
	"\x17chalk_dataplane_version\x18\v \x01(\x0e2<.chalk.server.v1.CloudComponentCluster.ChalkDataplaneVersionR\x15chalkDataplaneVersion\"v\n" +
	"\x19DeployAuxiliaryComponents\x120\n" +
	",DEPLOY_AUXILIARY_COMPONENTS_NONE_UNSPECIFIED\x10\x00\x12'\n" +
	"#DEPLOY_AUXILIARY_COMPONENTS_ENABLED\x10\x01\"\x80\x01\n" +
	"\x15ChalkDataplaneVersion\x12'\n" +
	"#CHALK_DATAPLANE_VERSION_UNSPECIFIED\x10\x00\x12\x1e\n" +
	"\x1aCHALK_DATAPLANE_VERSION_V1\x10\x01\x12\x1e\n" +
	"\x1aCHALK_DATAPLANE_VERSION_V2\x10\x02B\r\n" +
	"\v_designatorB\v\n" +
	"\t_dns_zoneB\x13\n" +
	...
	"\x14restricted_node_pool\x18\x04 \x01(\tH\x01R\x12restrictedNodePool\x88\x01\x01\x12A\n" +
	"\n" +
	"host_pools\x18\x05 \x03(\v2\x1e.chalk.server.v1.ChalkHostPoolB\x02\x18\x01R\thostPools\x1a\xe4\x01\n" +
	"\bTierInfo\x12=\n" +
	"\x04tier\x18\x01 \x01(\x0e2).chalk.server.v1.DataplaneController.TierR\x04tier\x12%\n" +
	...
	"\x18DeploymentManifestUpdate\"\xf8\x02\n" +
	...
	"\n" +
	"cluster_id\x18\x05 \x01(\tR\tclusterId\x12X\n" +
	"\x12replication_source\x18\x06 \x01(\v2).chalk.server.v1.ClusterReplicationSourceR\x11replicationSource\"\xd0\x01\n" +
	...
	"\x06vpc_id\x18\x04 \x01(\tR\x05vpcId\"\xc5\x06\n" +
	...
	"\x1ceffective_maintenance_window\x18\x0f \x01(\v2\".chalk.server.v1.MaintenanceWindowB\x03\xe0A\x03R\x1aeffectiveMaintenanceWindow\x12F\n" +
	"\x1dcluster_replication_source_id\x18\x10 \x01(\tH\x04R\x1aclusterReplicationSourceId\x88\x01\x01B\r\n" +
	"\v_designatorB\x16\n" +
	"\x14_cloud_credential_idB\t\n" +
	"\a_vpc_idB\x0f\n" +
	"\r_status_errorB \n" +
	"\x1e_cluster_replication_source_id\"\xfc\x01\n" +
	...
	"\acluster\x18\x01 \x01(\v2-.chalk.server.v1.CloudComponentClusterRequestR\acluster\x12F\n" +
	"\x1dcluster_replication_source_id\x18\x02 \x01(\tH\x00R\x1aclusterReplicationSourceId\x88\x01\x01B \n" +
	"\x1e_cluster_replication_source_id\"o\n" +
	...
	"\acluster\x18\x01 \x01(\v2..chalk.server.v1.CloudComponentClusterResponseR\acluster\"J\n" +
	...
	"\bclusters\x18\x01 \x03(\v2\".chalk.server.v1.ServerlessClusterR\bclusters\"\xb7\x02\n" +
	"\x15RecoveryClusterTarget\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12%\n" +
	"\x0eenvironment_id\x18\x02 \x01(\tR\renvironmentId\x12\x1d\n" +
	"\n" +
	"cluster_id\x18\x03 \x01(\tR\tclusterId\x12;\n" +
	"\x1adataplane_db_backup_secret\x18\x04 \x01(\tR\x17dataplaneDbBackupSecret\x12M\n" +
	"!dataplane_db_backup_direct_secret\x18\x05 \x01(\tH\x00R\x1ddataplaneDbBackupDirectSecret\x88\x01\x01\x12\x16\n" +
	"\x06active\x18\x06 \x01(\bR\x06activeB$\n" +
	"\"_dataplane_db_backup_direct_secret\"\x9b\x02\n" +
	"!CreateRecoverClusterTargetRequest\x12%\n" +
	"\x0eenvironment_id\x18\x01 \x01(\tR\renvironmentId\x12\x1d\n" +
	"\n" +
	"cluster_id\x18\x02 \x01(\tR\tclusterId\x12;\n" +
	"\x1adataplane_db_backup_secret\x18\x03 \x01(\tR\x17dataplaneDbBackupSecret\x12M\n" +
	"!dataplane_db_backup_direct_secret\x18\x04 \x01(\tH\x00R\x1ddataplaneDbBackupDirectSecret\x88\x01\x01B$\n" +
	"\"_dataplane_db_backup_direct_secret\"\x84\x01\n" +
	"\"CreateRecoverClusterTargetResponse\x12^\n" +
	"\x17recovery_cluster_target\x18\x01 \x01(\v2&.chalk.server.v1.RecoveryClusterTargetR\x15recoveryClusterTarget\"m\n" +
	...
	"\x02id\x18\x01 \x01(\tR\x02id\x12:\n" +
	"\x04spec\x18\x02 \x01(\v2&.chalk.server.v1.CloudComponentStorageR\x04spec\"o\n" +
	"#UpdateCloudComponentStorageResponse\x12H\n" +
	"\astorage\x18\x01 \x01(\v2..chalk.server.v1.CloudComponentStorageResponseR\astorage\"?\n" +
	...
	"\bbindings\x18\x01 \x03(\v21.chalk.server.v1.GetBindingClusterGatewayResponseR\bbindings\"t\n" +
	...
	"\bbindings\x18\x01 \x03(\v22.chalk.server.v1.GetBindingServicesGatewayResponseR\bbindings\"q\n" +
	...
	"\x17HypervisorDynamicConfig\"#\n" +
	"!ListRecoveryClusterTargetsRequest\"\x86\x01\n" +
	"\"ListRecoveryClusterTargetsResponse\x12`\n" +
	"\x18recovery_cluster_targets\x18\x01 \x03(\v2&.chalk.server.v1.RecoveryClusterTargetR\x16recoveryClusterTargets\"c\n" +
	"$ActivateRecoveryClusterTargetRequest\x12;\n" +
	"\x1arecovery_cluster_target_id\x18\x01 \x01(\tR\x17recoveryClusterTargetId\"\x87\x01\n" +
	"%ActivateRecoveryClusterTargetResponse\x12^\n" +
	"\x17recovery_cluster_target\x18\x01 \x01(\v2&.chalk.server.v1.RecoveryClusterTargetR\x15recoveryClusterTarget\"e\n" +
	"&DeactivateRecoveryClusterTargetRequest\x12;\n" +
	"\x1arecovery_cluster_target_id\x18\x01 \x01(\tR\x17recoveryClusterTargetId\"\x89\x01\n" +
	"'DeactivateRecoveryClusterTargetResponse\x12^\n" +
	"\x17recovery_cluster_target\x18\x01 \x01(\v2&.chalk.server.v1.RecoveryClusterTargetR\x15recoveryClusterTarget\"\xc1\x01\n" +
	"\x18ClusterReplicationSource\x12M\n" +
	"\x0esource_cluster\x18\x01 \x01(\v2&.chalk.server.v1.CloudComponentClusterR\rsourceCluster\x12V\n" +
	"\x18source_cloud_credentials\x18\x02 \x01(\v2\x1c.chalk.server.v1.CloudConfigR\x16sourceCloudCredentials*\xe6\x01\n" +
	...
	"\x19CLOUD_STORAGE_ROLE_VOLUME\x10\x052\x8c`\n" +
	...
	"\x1bCreateCloudComponentCluster\x123.chalk.server.v1.CreateCloudComponentClusterRequest\x1a4.chalk.server.v1.CreateCloudComponentClusterResponse\"*\x88}\x1a\x8a\xd3\x0e#\b\x02\x12\x1fCreated cloud component cluster\x12\xb1\x01\n" +
	"\x1aCreateRecoverClusterTarget\x122.chalk.server.v1.CreateRecoverClusterTargetRequest\x1a3.chalk.server.v1.CreateRecoverClusterTargetResponse\"*\x88}\n" +
	"\x8a\xd3\x0e#\b\x02\x12\x1fCreated recovery cluster target\x12\x8d\x01\n" +
	"\x1aListRecoveryClusterTargets\x122.chalk.server.v1.ListRecoveryClusterTargetsRequest\x1a3.chalk.server.v1.ListRecoveryClusterTargetsResponse\"\x06\x88}\n" +
	"\x90\x02\x01\x12\xbf\x01\n" +
	"\x1dActivateRecoveryClusterTarget\x125.chalk.server.v1.ActivateRecoveryClusterTargetRequest\x1a6.chalk.server.v1.ActivateRecoveryClusterTargetResponse\"/\x88}\n" +
	"\x8a\xd3\x0e%\b\x02\x12!Activated recovery cluster target\x90\x02\x02\x12\xc7\x01\n" +
	...
	"\x1bUpdateCloudComponentStorage\x123.chalk.server.v1.UpdateCloudComponentStorageRequest\x1a4.chalk.server.v1.UpdateCloudComponentStorageResponse\"*\x88}\x1a\x8a\xd3\x0e#\b\x02\x12\x1fUpdated cloud component storage\x12\xb4\x01\n" +
...
var file_chalk_server_v1_cloud_components_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_chalk_server_v1_cloud_components_proto_msgTypes = make([]protoimpl.MessageInfo, 174)
var file_chalk_server_v1_cloud_components_proto_goTypes = []any{
	...
	(CloudComponentCluster_DeployAuxiliaryComponents)(0),                    // 2: chalk.server.v1.CloudComponentCluster.DeployAuxiliaryComponents
	(CloudComponentCluster_ChalkDataplaneVersion)(0),                        // 3: chalk.server.v1.CloudComponentCluster.ChalkDataplaneVersion
	(DataplaneController_Tier)(0),                                           // 4: chalk.server.v1.DataplaneController.Tier
	(*CloudComponentVpc)(nil),                                               // 5: chalk.server.v1.CloudComponentVpc
	(*CloudComponentVpcResponse)(nil),                                       // 6: chalk.server.v1.CloudComponentVpcResponse
	(*CloudComponentVpcRequest)(nil),                                        // 7: chalk.server.v1.CloudComponentVpcRequest
	(*CreateCloudComponentVpcRequest)(nil),                                  // 8: chalk.server.v1.CreateCloudComponentVpcRequest
	(*CreateCloudComponentVpcResponse)(nil),                                 // 9: chalk.server.v1.CreateCloudComponentVpcResponse
	(*GetCloudComponentVpcRequest)(nil),                                     // 10: chalk.server.v1.GetCloudComponentVpcRequest
	(*GetCloudComponentVpcResponse)(nil),                                    // 11: chalk.server.v1.GetCloudComponentVpcResponse
	(*DeleteCloudComponentVpcRequest)(nil),                                  // 12: chalk.server.v1.DeleteCloudComponentVpcRequest
	(*DeleteCloudComponentVpcResponse)(nil),                                 // 13: chalk.server.v1.DeleteCloudComponentVpcResponse
	(*ListCloudComponentVpcRequest)(nil),                                    // 14: chalk.server.v1.ListCloudComponentVpcRequest
	(*ListCloudComponentVpcResponse)(nil),                                   // 15: chalk.server.v1.ListCloudComponentVpcResponse
	(*CloudVpcConfig)(nil),                                                  // 16: chalk.server.v1.CloudVpcConfig
	(*AWSVpcConfig)(nil),                                                    // 17: chalk.server.v1.AWSVpcConfig
	(*AWSVpcRoute)(nil),                                                     // 18: chalk.server.v1.AWSVpcRoute
	(*AwsSubnetConfig)(nil),                                                 // 19: chalk.server.v1.AwsSubnetConfig
	(*GCPVpcConfig)(nil),                                                    // 20: chalk.server.v1.GCPVpcConfig
	(*GCPSubnetConfig)(nil),                                                 // 21: chalk.server.v1.GCPSubnetConfig
	(*GCPSecondaryIpRange)(nil),                                             // 22: chalk.server.v1.GCPSecondaryIpRange
	(*CloudComponentStorage)(nil),                                           // 23: chalk.server.v1.CloudComponentStorage
	(*CloudComponentStorageResponse)(nil),                                   // 24: chalk.server.v1.CloudComponentStorageResponse
	(*CloudComponentStorageRequest)(nil),                                    // 25: chalk.server.v1.CloudComponentStorageRequest
	(*CloudStorageLifecycleRule)(nil),                                       // 26: chalk.server.v1.CloudStorageLifecycleRule
	(*CloudStorageLifecyclePolicy)(nil),                                     // 27: chalk.server.v1.CloudStorageLifecyclePolicy
	(*EnvironmentCloudStorageBinding)(nil),                                  // 28: chalk.server.v1.EnvironmentCloudStorageBinding
	(*ClusterCloudStorageBinding)(nil),                                      // 29: chalk.server.v1.ClusterCloudStorageBinding
	(*GarContainerRegistryConfig)(nil),                                      // 30: chalk.server.v1.GarContainerRegistryConfig
	(*EcrContainerRegistryConfig)(nil),                                      // 31: chalk.server.v1.EcrContainerRegistryConfig
	(*AcrContainerRegistryConfig)(nil),                                      // 32: chalk.server.v1.AcrContainerRegistryConfig
	(*CloudContainerRegistryConfig)(nil),                                    // 33: chalk.server.v1.CloudContainerRegistryConfig
	(*CloudComponentContainerRegistry)(nil),                                 // 34: chalk.server.v1.CloudComponentContainerRegistry
	(*CloudComponentContainerRegistryResponse)(nil),                         // 35: chalk.server.v1.CloudComponentContainerRegistryResponse
	(*CloudComponentContainerRegistryRequest)(nil),                          // 36: chalk.server.v1.CloudComponentContainerRegistryRequest
	(*MaintenanceWindow)(nil),                                               // 37: chalk.server.v1.MaintenanceWindow
	(*CloudComponentCluster)(nil),                                           // 38: chalk.server.v1.CloudComponentCluster
	(*DataPlaneRedis)(nil),                                                  // 39: chalk.server.v1.DataPlaneRedis
	(*DataplaneController)(nil),                                             // 40: chalk.server.v1.DataplaneController
	(*ChalkHostPool)(nil),                                                   // 41: chalk.server.v1.ChalkHostPool
	(*DeploymentManifest)(nil),                                              // 42: chalk.server.v1.DeploymentManifest
	(*DeploymentManifestCreate)(nil),                                        // 43: chalk.server.v1.DeploymentManifestCreate
	(*DeploymentManifestDelete)(nil),                                        // 44: chalk.server.v1.DeploymentManifestDelete
	(*DeploymentManifestUpdate)(nil),                                        // 45: chalk.server.v1.DeploymentManifestUpdate
	(*ClusterDeploymentManifest)(nil),                                       // 46: chalk.server.v1.ClusterDeploymentManifest
	(*VpcDeploymentManifest)(nil),                                           // 47: chalk.server.v1.VpcDeploymentManifest
	(*CloudComponentClusterResponse)(nil),                                   // 48: chalk.server.v1.CloudComponentClusterResponse
	(*CloudComponentClusterRequest)(nil),                                    // 49: chalk.server.v1.CloudComponentClusterRequest
	(*CreateCloudComponentClusterRequest)(nil),                              // 50: chalk.server.v1.CreateCloudComponentClusterRequest
	(*CreateCloudComponentClusterResponse)(nil),                             // 51: chalk.server.v1.CreateCloudComponentClusterResponse
	(*UpdateCloudComponentClusterRequest)(nil),                              // 52: chalk.server.v1.UpdateCloudComponentClusterRequest
	(*UpdateCloudComponentClusterResponse)(nil),                             // 53: chalk.server.v1.UpdateCloudComponentClusterResponse
	(*GetCloudComponentClusterRequest)(nil),                                 // 54: chalk.server.v1.GetCloudComponentClusterRequest
	(*GetCloudComponentClusterResponse)(nil),                                // 55: chalk.server.v1.GetCloudComponentClusterResponse
	(*DeleteCloudComponentClusterRequest)(nil),                              // 56: chalk.server.v1.DeleteCloudComponentClusterRequest
	(*DeleteCloudComponentClusterResponse)(nil),                             // 57: chalk.server.v1.DeleteCloudComponentClusterResponse
	(*TestClusterConnectionRequest)(nil),                                    // 58: chalk.server.v1.TestClusterConnectionRequest
	(*TestClusterConnectionResponse)(nil),                                   // 59: chalk.server.v1.TestClusterConnectionResponse
	(*ListCloudComponentClusterRequest)(nil),                                // 60: chalk.server.v1.ListCloudComponentClusterRequest
	(*ListCloudComponentClusterResponse)(nil),                               // 61: chalk.server.v1.ListCloudComponentClusterResponse
	(*ListServerlessClustersRequest)(nil),                                   // 62: chalk.server.v1.ListServerlessClustersRequest
	(*ServerlessCluster)(nil),                                               // 63: chalk.server.v1.ServerlessCluster
	(*ListServerlessClustersResponse)(nil),                                  // 64: chalk.server.v1.ListServerlessClustersResponse
	(*RecoveryClusterTarget)(nil),                                           // 65: chalk.server.v1.RecoveryClusterTarget
	(*CreateRecoverClusterTargetRequest)(nil),                               // 66: chalk.server.v1.CreateRecoverClusterTargetRequest
	(*CreateRecoverClusterTargetResponse)(nil),                              // 67: chalk.server.v1.CreateRecoverClusterTargetResponse
	(*CreateCloudComponentStorageRequest)(nil),                              // 68: chalk.server.v1.CreateCloudComponentStorageRequest
	(*CreateCloudComponentStorageResponse)(nil),                             // 69: chalk.server.v1.CreateCloudComponentStorageResponse
	(*GetCloudComponentStorageRequest)(nil),                                 // 70: chalk.server.v1.GetCloudComponentStorageRequest
	(*GetCloudComponentStorageResponse)(nil),                                // 71: chalk.server.v1.GetCloudComponentStorageResponse
	(*DeleteCloudComponentStorageRequest)(nil),                              // 72: chalk.server.v1.DeleteCloudComponentStorageRequest
	(*DeleteCloudComponentStorageResponse)(nil),                             // 73: chalk.server.v1.DeleteCloudComponentStorageResponse
	(*UpdateCloudComponentStorageRequest)(nil),                              // 74: chalk.server.v1.UpdateCloudComponentStorageRequest
	(*UpdateCloudComponentStorageResponse)(nil),                             // 75: chalk.server.v1.UpdateCloudComponentStorageResponse
	(*ListCloudComponentStorageRequest)(nil),                                // 76: chalk.server.v1.ListCloudComponentStorageRequest
	(*ListCloudComponentStorageResponse)(nil),                               // 77: chalk.server.v1.ListCloudComponentStorageResponse
	(*CreateBindingEnvironmentCloudStorageRequest)(nil),                     // 78: chalk.server.v1.CreateBindingEnvironmentCloudStorageRequest
	(*CreateBindingEnvironmentCloudStorageResponse)(nil),                    // 79: chalk.server.v1.CreateBindingEnvironmentCloudStorageResponse
	(*GetBindingEnvironmentCloudStorageRequest)(nil),                        // 80: chalk.server.v1.GetBindingEnvironmentCloudStorageRequest
	(*GetBindingEnvironmentCloudStorageResponse)(nil),                       // 81: chalk.server.v1.GetBindingEnvironmentCloudStorageResponse
	(*ListBindingEnvironmentCloudStorageRequest)(nil),                       // 82: chalk.server.v1.ListBindingEnvironmentCloudStorageRequest
	(*ListBindingEnvironmentCloudStorageResponse)(nil),                      // 83: chalk.server.v1.ListBindingEnvironmentCloudStorageResponse
	(*DeleteBindingEnvironmentCloudStorageRequest)(nil),                     // 84: chalk.server.v1.DeleteBindingEnvironmentCloudStorageRequest
	(*DeleteBindingEnvironmentCloudStorageResponse)(nil),                    // 85: chalk.server.v1.DeleteBindingEnvironmentCloudStorageResponse
	(*CreateBindingClusterCloudStorageRequest)(nil),                         // 86: chalk.server.v1.CreateBindingClusterCloudStorageRequest
	(*CreateBindingClusterCloudStorageResponse)(nil),                        // 87: chalk.server.v1.CreateBindingClusterCloudStorageResponse
	(*GetBindingClusterCloudStorageRequest)(nil),                            // 88: chalk.server.v1.GetBindingClusterCloudStorageRequest
	(*GetBindingClusterCloudStorageResponse)(nil),                           // 89: chalk.server.v1.GetBindingClusterCloudStorageResponse
	(*ListBindingClusterCloudStorageRequest)(nil),                           // 90: chalk.server.v1.ListBindingClusterCloudStorageRequest
	(*ListBindingClusterCloudStorageResponse)(nil),                          // 91: chalk.server.v1.ListBindingClusterCloudStorageResponse
	(*DeleteBindingClusterCloudStorageRequest)(nil),                         // 92: chalk.server.v1.DeleteBindingClusterCloudStorageRequest
	(*DeleteBindingClusterCloudStorageResponse)(nil),                        // 93: chalk.server.v1.DeleteBindingClusterCloudStorageResponse
	(*CreateCloudComponentContainerRegistryRequest)(nil),                    // 94: chalk.server.v1.CreateCloudComponentContainerRegistryRequest
	(*CreateCloudComponentContainerRegistryResponse)(nil),                   // 95: chalk.server.v1.CreateCloudComponentContainerRegistryResponse
	(*UpdateCloudComponentContainerRegistryRequest)(nil),                    // 96: chalk.server.v1.UpdateCloudComponentContainerRegistryRequest
	(*UpdateCloudComponentContainerRegistryResponse)(nil),                   // 97: chalk.server.v1.UpdateCloudComponentContainerRegistryResponse
	(*GetCloudComponentContainerRegistryRequest)(nil),                       // 98: chalk.server.v1.GetCloudComponentContainerRegistryRequest
	(*GetCloudComponentContainerRegistryResponse)(nil),                      // 99: chalk.server.v1.GetCloudComponentContainerRegistryResponse
	(*DeleteCloudComponentContainerRegistryRequest)(nil),                    // 100: chalk.server.v1.DeleteCloudComponentContainerRegistryRequest
	(*DeleteCloudComponentContainerRegistryResponse)(nil),                   // 101: chalk.server.v1.DeleteCloudComponentContainerRegistryResponse
	(*ListCloudComponentContainerRegistryRequest)(nil),                      // 102: chalk.server.v1.ListCloudComponentContainerRegistryRequest
	(*ListCloudComponentContainerRegistryResponse)(nil),                     // 103: chalk.server.v1.ListCloudComponentContainerRegistryResponse
	(*CreateBindingClusterContainerRegistryRequest)(nil),                    // 104: chalk.server.v1.CreateBindingClusterContainerRegistryRequest
	(*CreateBindingClusterContainerRegistryResponse)(nil),                   // 105: chalk.server.v1.CreateBindingClusterContainerRegistryResponse
	(*GetBindingClusterContainerRegistryRequest)(nil),                       // 106: chalk.server.v1.GetBindingClusterContainerRegistryRequest
	(*GetBindingClusterContainerRegistryResponse)(nil),                      // 107: chalk.server.v1.GetBindingClusterContainerRegistryResponse
	(*ListBindingClusterContainerRegistryRequest)(nil),                      // 108: chalk.server.v1.ListBindingClusterContainerRegistryRequest
	(*ListBindingClusterContainerRegistryResponse)(nil),                     // 109: chalk.server.v1.ListBindingClusterContainerRegistryResponse
	(*DeleteBindingClusterContainerRegistryRequest)(nil),                    // 110: chalk.server.v1.DeleteBindingClusterContainerRegistryRequest
	(*DeleteBindingClusterContainerRegistryResponse)(nil),                   // 111: chalk.server.v1.DeleteBindingClusterContainerRegistryResponse
	(*CreateBindingClusterGatewayRequest)(nil),                              // 112: chalk.server.v1.CreateBindingClusterGatewayRequest
	(*CreateBindingClusterGatewayResponse)(nil),                             // 113: chalk.server.v1.CreateBindingClusterGatewayResponse
	(*DeleteBindingClusterGatewayRequest)(nil),                              // 114: chalk.server.v1.DeleteBindingClusterGatewayRequest
	(*DeleteBindingClusterGatewayResponse)(nil),                             // 115: chalk.server.v1.DeleteBindingClusterGatewayResponse
	(*GetBindingClusterGatewayRequest)(nil),                                 // 116: chalk.server.v1.GetBindingClusterGatewayRequest
	(*GetBindingClusterGatewayResponse)(nil),                                // 117: chalk.server.v1.GetBindingClusterGatewayResponse
	(*ListBindingClusterGatewayRequest)(nil),                                // 118: chalk.server.v1.ListBindingClusterGatewayRequest
	(*ListBindingClusterGatewayResponse)(nil),                               // 119: chalk.server.v1.ListBindingClusterGatewayResponse
	(*CreateBindingServicesGatewayRequest)(nil),                             // 120: chalk.server.v1.CreateBindingServicesGatewayRequest
	(*CreateBindingServicesGatewayResponse)(nil),                            // 121: chalk.server.v1.CreateBindingServicesGatewayResponse
	(*DeleteBindingServicesGatewayRequest)(nil),                             // 122: chalk.server.v1.DeleteBindingServicesGatewayRequest
	(*DeleteBindingServicesGatewayResponse)(nil),                            // 123: chalk.server.v1.DeleteBindingServicesGatewayResponse
	(*GetBindingServicesGatewayRequest)(nil),                                // 124: chalk.server.v1.GetBindingServicesGatewayRequest
	(*GetBindingServicesGatewayResponse)(nil),                               // 125: chalk.server.v1.GetBindingServicesGatewayResponse
	(*ListBindingServicesGatewayRequest)(nil),                               // 126: chalk.server.v1.ListBindingServicesGatewayRequest
	(*ListBindingServicesGatewayResponse)(nil),                              // 127: chalk.server.v1.ListBindingServicesGatewayResponse
	(*CreateBindingPrivateGatewayRequest)(nil),                              // 128: chalk.server.v1.CreateBindingPrivateGatewayRequest
	(*CreateBindingPrivateGatewayResponse)(nil),                             // 129: chalk.server.v1.CreateBindingPrivateGatewayResponse
	(*DeleteBindingPrivateGatewayRequest)(nil),                              // 130: chalk.server.v1.DeleteBindingPrivateGatewayRequest
	(*DeleteBindingPrivateGatewayResponse)(nil),                             // 131: chalk.server.v1.DeleteBindingPrivateGatewayResponse
	(*GetBindingPrivateGatewayRequest)(nil),                                 // 132: chalk.server.v1.GetBindingPrivateGatewayRequest
	(*GetBindingPrivateGatewayResponse)(nil),                                // 133: chalk.server.v1.GetBindingPrivateGatewayResponse
	(*ListBindingPrivateGatewayRequest)(nil),                                // 134: chalk.server.v1.ListBindingPrivateGatewayRequest
	(*ListBindingPrivateGatewayResponse)(nil),                               // 135: chalk.server.v1.ListBindingPrivateGatewayResponse
	(*CreateBindingClusterBackgroundPersistenceDeploymentRequest)(nil),      // 136: chalk.server.v1.CreateBindingClusterBackgroundPersistenceDeploymentRequest
	(*CreateBindingClusterBackgroundPersistenceDeploymentResponse)(nil),     // 137: chalk.server.v1.CreateBindingClusterBackgroundPersistenceDeploymentResponse
	(*DeleteBindingClusterBackgroundPersistenceDeploymentRequest)(nil),      // 138: chalk.server.v1.DeleteBindingClusterBackgroundPersistenceDeploymentRequest
	(*DeleteBindingClusterBackgroundPersistenceDeploymentResponse)(nil),     // 139: chalk.server.v1.DeleteBindingClusterBackgroundPersistenceDeploymentResponse
	(*GetBindingClusterBackgroundPersistenceDeploymentRequest)(nil),         // 140: chalk.server.v1.GetBindingClusterBackgroundPersistenceDeploymentRequest
	(*GetBindingClusterBackgroundPersistenceDeploymentResponse)(nil),        // 141: chalk.server.v1.GetBindingClusterBackgroundPersistenceDeploymentResponse
	(*ListBindingClusterBackgroundPersistenceDeploymentRequest)(nil),        // 142: chalk.server.v1.ListBindingClusterBackgroundPersistenceDeploymentRequest
	(*ListBindingClusterBackgroundPersistenceDeploymentResponse)(nil),       // 143: chalk.server.v1.ListBindingClusterBackgroundPersistenceDeploymentResponse
	(*CreateBindingClusterTelemetryDeploymentRequest)(nil),                  // 144: chalk.server.v1.CreateBindingClusterTelemetryDeploymentRequest
	(*CreateBindingClusterTelemetryDeploymentResponse)(nil),                 // 145: chalk.server.v1.CreateBindingClusterTelemetryDeploymentResponse
	(*DeleteBindingClusterTelemetryDeploymentRequest)(nil),                  // 146: chalk.server.v1.DeleteBindingClusterTelemetryDeploymentRequest
	(*DeleteBindingClusterTelemetryDeploymentResponse)(nil),                 // 147: chalk.server.v1.DeleteBindingClusterTelemetryDeploymentResponse
	(*GetBindingClusterTelemetryDeploymentRequest)(nil),                     // 148: chalk.server.v1.GetBindingClusterTelemetryDeploymentRequest
	(*GetBindingClusterTelemetryDeploymentResponse)(nil),                    // 149: chalk.server.v1.GetBindingClusterTelemetryDeploymentResponse
	(*ListBindingClusterTelemetryDeploymentRequest)(nil),                    // 150: chalk.server.v1.ListBindingClusterTelemetryDeploymentRequest
	(*ListBindingClusterTelemetryDeploymentResponse)(nil),                   // 151: chalk.server.v1.ListBindingClusterTelemetryDeploymentResponse
	(*CreateBindingEnvironmentGatewayRequest)(nil),                          // 152: chalk.server.v1.CreateBindingEnvironmentGatewayRequest
	(*CreateBindingEnvironmentGatewayResponse)(nil),                         // 153: chalk.server.v1.CreateBindingEnvironmentGatewayResponse
	(*DeleteBindingEnvironmentGatewayRequest)(nil),                          // 154: chalk.server.v1.DeleteBindingEnvironmentGatewayRequest
	(*DeleteBindingEnvironmentGatewayResponse)(nil),                         // 155: chalk.server.v1.DeleteBindingEnvironmentGatewayResponse
	(*GetBindingEnvironmentGatewayRequest)(nil),                             // 156: chalk.server.v1.GetBindingEnvironmentGatewayRequest
	(*GetBindingEnvironmentGatewayResponse)(nil),                            // 157: chalk.server.v1.GetBindingEnvironmentGatewayResponse
	(*ListBindingEnvironmentGatewayRequest)(nil),                            // 158: chalk.server.v1.ListBindingEnvironmentGatewayRequest
	(*ListBindingEnvironmentGatewayResponse)(nil),                           // 159: chalk.server.v1.ListBindingEnvironmentGatewayResponse
	(*CreateBindingEnvironmentBackgroundPersistenceDeploymentRequest)(nil),  // 160: chalk.server.v1.CreateBindingEnvironmentBackgroundPersistenceDeploymentRequest
	(*CreateBindingEnvironmentBackgroundPersistenceDeploymentResponse)(nil), // 161: chalk.server.v1.CreateBindingEnvironmentBackgroundPersistenceDeploymentResponse
	(*DeleteBindingEnvironmentBackgroundPersistenceDeploymentRequest)(nil),  // 162: chalk.server.v1.DeleteBindingEnvironmentBackgroundPersistenceDeploymentRequest
	(*DeleteBindingEnvironmentBackgroundPersistenceDeploymentResponse)(nil), // 163: chalk.server.v1.DeleteBindingEnvironmentBackgroundPersistenceDeploymentResponse
	(*GetBindingEnvironmentBackgroundPersistenceDeploymentRequest)(nil),     // 164: chalk.server.v1.GetBindingEnvironmentBackgroundPersistenceDeploymentRequest
	(*GetBindingEnvironmentBackgroundPersistenceDeploymentResponse)(nil),    // 165: chalk.server.v1.GetBindingEnvironmentBackgroundPersistenceDeploymentResponse
	(*ListBindingEnvironmentBackgroundPersistenceDeploymentRequest)(nil),    // 166: chalk.server.v1.ListBindingEnvironmentBackgroundPersistenceDeploymentRequest
	(*ListBindingEnvironmentBackgroundPersistenceDeploymentResponse)(nil),   // 167: chalk.server.v1.ListBindingEnvironmentBackgroundPersistenceDeploymentResponse
	(*DataplaneDynamicConfig)(nil),                                          // 168: chalk.server.v1.DataplaneDynamicConfig
	(*DataplaneControllerDynamicConfig)(nil),                                // 169: chalk.server.v1.DataplaneControllerDynamicConfig
	(*HypervisorDynamicConfig)(nil),                                         // 170: chalk.server.v1.HypervisorDynamicConfig
	(*ListRecoveryClusterTargetsRequest)(nil),                               // 171: chalk.server.v1.ListRecoveryClusterTargetsRequest
	(*ListRecoveryClusterTargetsResponse)(nil),                              // 172: chalk.server.v1.ListRecoveryClusterTargetsResponse
	(*ActivateRecoveryClusterTargetRequest)(nil),                            // 173: chalk.server.v1.ActivateRecoveryClusterTargetRequest
	(*ActivateRecoveryClusterTargetResponse)(nil),                           // 174: chalk.server.v1.ActivateRecoveryClusterTargetResponse
	(*DeactivateRecoveryClusterTargetRequest)(nil),                          // 175: chalk.server.v1.DeactivateRecoveryClusterTargetRequest
	(*DeactivateRecoveryClusterTargetResponse)(nil),                         // 176: chalk.server.v1.DeactivateRecoveryClusterTargetResponse
	(*ClusterReplicationSource)(nil),                                        // 177: chalk.server.v1.ClusterReplicationSource
	(*DataplaneController_TierInfo)(nil),                                    // 178: chalk.server.v1.DataplaneController.TierInfo
	(*timestamppb.Timestamp)(nil),                                           // 179: google.protobuf.Timestamp
	(ClusterClass)(0),                                                       // 180: chalk.server.v1.ClusterClass
	(*CloudConfig)(nil),                                                     // 181: chalk.server.v1.CloudConfig
	(*Team)(nil),                                                            // 182: chalk.server.v1.Team
	(*CloudCredentialsResponse)(nil),                                        // 183: chalk.server.v1.CloudCredentialsResponse
}
var file_chalk_server_v1_cloud_components_proto_depIdxs = []int32{
	16,  // 0: chalk.server.v1.CloudComponentVpc.config:type_name -> chalk.server.v1.CloudVpcConfig
	5,   // 1: chalk.server.v1.CloudComponentVpcResponse.spec:type_name -> chalk.server.v1.CloudComponentVpc
	179, // 2: chalk.server.v1.CloudComponentVpcResponse.created_at:type_name -> google.protobuf.Timestamp
	179, // 3: chalk.server.v1.CloudComponentVpcResponse.updated_at:type_name -> google.protobuf.Timestamp
	179, // 4: chalk.server.v1.CloudComponentVpcResponse.applied_at:type_name -> google.protobuf.Timestamp
	5,   // 5: chalk.server.v1.CloudComponentVpcRequest.spec:type_name -> chalk.server.v1.CloudComponentVpc
	7,   // 6: chalk.server.v1.CreateCloudComponentVpcRequest.vpc:type_name -> chalk.server.v1.CloudComponentVpcRequest
	6,   // 7: chalk.server.v1.CreateCloudComponentVpcResponse.vpc:type_name -> chalk.server.v1.CloudComponentVpcResponse
	6,   // 8: chalk.server.v1.GetCloudComponentVpcResponse.vpc:type_name -> chalk.server.v1.CloudComponentVpcResponse
	6,   // 9: chalk.server.v1.ListCloudComponentVpcResponse.vpcs:type_name -> chalk.server.v1.CloudComponentVpcResponse
	17,  // 10: chalk.server.v1.CloudVpcConfig.aws:type_name -> chalk.server.v1.AWSVpcConfig
	20,  // 11: chalk.server.v1.CloudVpcConfig.gcp:type_name -> chalk.server.v1.GCPVpcConfig
	19,  // 12: chalk.server.v1.AWSVpcConfig.subnets:type_name -> chalk.server.v1.AwsSubnetConfig
	18,  // 13: chalk.server.v1.AWSVpcConfig.additional_public_routes:type_name -> chalk.server.v1.AWSVpcRoute
	18,  // 14: chalk.server.v1.AWSVpcConfig.additional_private_routes:type_name -> chalk.server.v1.AWSVpcRoute
	21,  // 15: chalk.server.v1.GCPVpcConfig.subnets:type_name -> chalk.server.v1.GCPSubnetConfig
	21,  // 16: chalk.server.v1.GCPVpcConfig.backup_subnets:type_name -> chalk.server.v1.GCPSubnetConfig
	22,  // 17: chalk.server.v1.GCPSubnetConfig.secondary_ip_ranges:type_name -> chalk.server.v1.GCPSecondaryIpRange
	27,  // 18: chalk.server.v1.CloudComponentStorage.retention:type_name -> chalk.server.v1.CloudStorageLifecyclePolicy
	23,  // 19: chalk.server.v1.CloudComponentStorageResponse.spec:type_name -> chalk.server.v1.CloudComponentStorage
	179, // 20: chalk.server.v1.CloudComponentStorageResponse.created_at:type_name -> google.protobuf.Timestamp
	179, // 21: chalk.server.v1.CloudComponentStorageResponse.updated_at:type_name -> google.protobuf.Timestamp
	179, // 22: chalk.server.v1.CloudComponentStorageResponse.applied_at:type_name -> google.protobuf.Timestamp
	23,  // 23: chalk.server.v1.CloudComponentStorageRequest.spec:type_name -> chalk.server.v1.CloudComponentStorage
	26,  // 24: chalk.server.v1.CloudStorageLifecyclePolicy.rules:type_name -> chalk.server.v1.CloudStorageLifecycleRule
	0,   // 25: chalk.server.v1.EnvironmentCloudStorageBinding.storage_role:type_name -> chalk.server.v1.CloudStorageRole
	179, // 26: chalk.server.v1.EnvironmentCloudStorageBinding.created_at:type_name -> google.protobuf.Timestamp
	179, // 27: chalk.server.v1.EnvironmentCloudStorageBinding.updated_at:type_name -> google.protobuf.Timestamp
	0,   // 28: chalk.server.v1.ClusterCloudStorageBinding.storage_role:type_name -> chalk.server.v1.CloudStorageRole
	179, // 29: chalk.server.v1.ClusterCloudStorageBinding.created_at:type_name -> google.protobuf.Timestamp
	179, // 30: chalk.server.v1.ClusterCloudStorageBinding.updated_at:type_name -> google.protobuf.Timestamp
	30,  // 31: chalk.server.v1.CloudContainerRegistryConfig.gar:type_name -> chalk.server.v1.GarContainerRegistryConfig
	31,  // 32: chalk.server.v1.CloudContainerRegistryConfig.ecr:type_name -> chalk.server.v1.EcrContainerRegistryConfig
	32,  // 33: chalk.server.v1.CloudContainerRegistryConfig.acr:type_name -> chalk.server.v1.AcrContainerRegistryConfig
	33,  // 34: chalk.server.v1.CloudComponentContainerRegistry.config:type_name -> chalk.server.v1.CloudContainerRegistryConfig
	34,  // 35: chalk.server.v1.CloudComponentContainerRegistryResponse.spec:type_name -> chalk.server.v1.CloudComponentContainerRegistry
	179, // 36: chalk.server.v1.CloudComponentContainerRegistryResponse.created_at:type_name -> google.protobuf.Timestamp
	179, // 37: chalk.server.v1.CloudComponentContainerRegistryResponse.updated_at:type_name -> google.protobuf.Timestamp
	179, // 38: chalk.server.v1.CloudComponentContainerRegistryResponse.applied_at:type_name -> google.protobuf.Timestamp
	34,  // 39: chalk.server.v1.CloudComponentContainerRegistryRequest.spec:type_name -> chalk.server.v1.CloudComponentContainerRegistry
	1,   // 40: chalk.server.v1.MaintenanceWindow.mode:type_name -> chalk.server.v1.MaintenanceWindow.Mode
	179, // 41: chalk.server.v1.MaintenanceWindow.override_active_until:type_name -> google.protobuf.Timestamp
	39,  // 42: chalk.server.v1.CloudComponentCluster.data_plane_redis:type_name -> chalk.server.v1.DataPlaneRedis
	40,  // 43: chalk.server.v1.CloudComponentCluster.dataplane_controller:type_name -> chalk.server.v1.DataplaneController
	180, // 44: chalk.server.v1.CloudComponentCluster.cluster_class:type_name -> chalk.server.v1.ClusterClass
	37,  // 45: chalk.server.v1.CloudComponentCluster.maintenance_window:type_name -> chalk.server.v1.MaintenanceWindow
	168, // 46: chalk.server.v1.CloudComponentCluster.dynamic_config:type_name -> chalk.server.v1.DataplaneDynamicConfig
	2,   // 47: chalk.server.v1.CloudComponentCluster.deploy_auxiliary_components:type_name -> chalk.server.v1.CloudComponentCluster.DeployAuxiliaryComponents
	3,   // 48: chalk.server.v1.CloudComponentCluster.chalk_dataplane_version:type_name -> chalk.server.v1.CloudComponentCluster.ChalkDataplaneVersion
	4,   // 49: chalk.server.v1.DataplaneController.tier:type_name -> chalk.server.v1.DataplaneController.Tier
	178, // 50: chalk.server.v1.DataplaneController.available_tiers:type_name -> chalk.server.v1.DataplaneController.TierInfo
	41,  // 51: chalk.server.v1.DataplaneController.host_pools:type_name -> chalk.server.v1.ChalkHostPool
	46,  // 52: chalk.server.v1.DeploymentManifest.cluster_deployment:type_name -> chalk.server.v1.ClusterDeploymentManifest
	47,  // 53: chalk.server.v1.DeploymentManifest.vpc_deployment:type_name -> chalk.server.v1.VpcDeploymentManifest
	43,  // 54: chalk.server.v1.DeploymentManifest.create:type_name -> chalk.server.v1.DeploymentManifestCreate
	44,  // 55: chalk.server.v1.DeploymentManifest.delete:type_name -> chalk.server.v1.DeploymentManifestDelete
	45,  // 56: chalk.server.v1.DeploymentManifest.update:type_name -> chalk.server.v1.DeploymentManifestUpdate
	38,  // 57: chalk.server.v1.ClusterDeploymentManifest.cluster:type_name -> chalk.server.v1.CloudComponentCluster
	181, // 58: chalk.server.v1.ClusterDeploymentManifest.cloud_config:type_name -> chalk.server.v1.CloudConfig
	182, // 59: chalk.server.v1.ClusterDeploymentManifest.team:type_name -> chalk.server.v1.Team
	5,   // 60: chalk.server.v1.ClusterDeploymentManifest.vpc:type_name -> chalk.server.v1.CloudComponentVpc
	177, // 61: chalk.server.v1.ClusterDeploymentManifest.replication_source:type_name -> chalk.server.v1.ClusterReplicationSource
	5,   // 62: chalk.server.v1.VpcDeploymentManifest.vpc:type_name -> chalk.server.v1.CloudComponentVpc
	181, // 63: chalk.server.v1.VpcDeploymentManifest.cloud_config:type_name -> chalk.server.v1.CloudConfig
	182, // 64: chalk.server.v1.VpcDeploymentManifest.team:type_name -> chalk.server.v1.Team
	38,  // 65: chalk.server.v1.CloudComponentClusterResponse.spec:type_name -> chalk.server.v1.CloudComponentCluster
	179, // 66: chalk.server.v1.CloudComponentClusterResponse.created_at:type_name -> google.protobuf.Timestamp
	179, // 67: chalk.server.v1.CloudComponentClusterResponse.updated_at:type_name -> google.protobuf.Timestamp
	179, // 68: chalk.server.v1.CloudComponentClusterResponse.applied_at:type_name -> google.protobuf.Timestamp
	37,  // 69: chalk.server.v1.CloudComponentClusterResponse.effective_maintenance_window:type_name -> chalk.server.v1.MaintenanceWindow
	38,  // 70: chalk.server.v1.CloudComponentClusterRequest.spec:type_name -> chalk.server.v1.CloudComponentCluster
	49,  // 71: chalk.server.v1.CreateCloudComponentClusterRequest.cluster:type_name -> chalk.server.v1.CloudComponentClusterRequest
	48,  // 72: chalk.server.v1.CreateCloudComponentClusterResponse.cluster:type_name -> chalk.server.v1.CloudComponentClusterResponse
	49,  // 73: chalk.server.v1.UpdateCloudComponentClusterRequest.cluster:type_name -> chalk.server.v1.CloudComponentClusterRequest
	48,  // 74: chalk.server.v1.UpdateCloudComponentClusterResponse.cluster:type_name -> chalk.server.v1.CloudComponentClusterResponse
	48,  // 75: chalk.server.v1.GetCloudComponentClusterResponse.cluster:type_name -> chalk.server.v1.CloudComponentClusterResponse
	49,  // 76: chalk.server.v1.TestClusterConnectionRequest.config:type_name -> chalk.server.v1.CloudComponentClusterRequest
	48,  // 77: chalk.server.v1.ListCloudComponentClusterResponse.clusters:type_name -> chalk.server.v1.CloudComponentClusterResponse
	48,  // 78: chalk.server.v1.ServerlessCluster.cluster:type_name -> chalk.server.v1.CloudComponentClusterResponse
	183, // 79: chalk.server.v1.ServerlessCluster.cloud_credentials:type_name -> chalk.server.v1.CloudCredentialsResponse
	63,  // 80: chalk.server.v1.ListServerlessClustersResponse.clusters:type_name -> chalk.server.v1.ServerlessCluster
	65,  // 81: chalk.server.v1.CreateRecoverClusterTargetResponse.recovery_cluster_target:type_name -> chalk.server.v1.RecoveryClusterTarget
	25,  // 82: chalk.server.v1.CreateCloudComponentStorageRequest.storage:type_name -> chalk.server.v1.CloudComponentStorageRequest
	24,  // 83: chalk.server.v1.CreateCloudComponentStorageResponse.storage:type_name -> chalk.server.v1.CloudComponentStorageResponse
	24,  // 84: chalk.server.v1.GetCloudComponentStorageResponse.storage:type_name -> chalk.server.v1.CloudComponentStorageResponse
	23,  // 85: chalk.server.v1.UpdateCloudComponentStorageRequest.spec:type_name -> chalk.server.v1.CloudComponentStorage
	24,  // 86: chalk.server.v1.UpdateCloudComponentStorageResponse.storage:type_name -> chalk.server.v1.CloudComponentStorageResponse
	24,  // 87: chalk.server.v1.ListCloudComponentStorageResponse.storages:type_name -> chalk.server.v1.CloudComponentStorageResponse
	0,   // 88: chalk.server.v1.CreateBindingEnvironmentCloudStorageRequest.storage_role:type_name -> chalk.server.v1.CloudStorageRole
	28,  // 89: chalk.server.v1.CreateBindingEnvironmentCloudStorageResponse.binding:type_name -> chalk.server.v1.EnvironmentCloudStorageBinding
	0,   // 90: chalk.server.v1.GetBindingEnvironmentCloudStorageRequest.storage_role:type_name -> chalk.server.v1.CloudStorageRole
	28,  // 91: chalk.server.v1.GetBindingEnvironmentCloudStorageResponse.binding:type_name -> chalk.server.v1.EnvironmentCloudStorageBinding
	28,  // 92: chalk.server.v1.ListBindingEnvironmentCloudStorageResponse.bindings:type_name -> chalk.server.v1.EnvironmentCloudStorageBinding
	0,   // 93: chalk.server.v1.DeleteBindingEnvironmentCloudStorageRequest.storage_role:type_name -> chalk.server.v1.CloudStorageRole
	0,   // 94: chalk.server.v1.CreateBindingClusterCloudStorageRequest.storage_role:type_name -> chalk.server.v1.CloudStorageRole
	29,  // 95: chalk.server.v1.CreateBindingClusterCloudStorageResponse.binding:type_name -> chalk.server.v1.ClusterCloudStorageBinding
	0,   // 96: chalk.server.v1.GetBindingClusterCloudStorageRequest.storage_role:type_name -> chalk.server.v1.CloudStorageRole
	29,  // 97: chalk.server.v1.GetBindingClusterCloudStorageResponse.binding:type_name -> chalk.server.v1.ClusterCloudStorageBinding
	29,  // 98: chalk.server.v1.ListBindingClusterCloudStorageResponse.bindings:type_name -> chalk.server.v1.ClusterCloudStorageBinding
	0,   // 99: chalk.server.v1.DeleteBindingClusterCloudStorageRequest.storage_role:type_name -> chalk.server.v1.CloudStorageRole
	36,  // 100: chalk.server.v1.CreateCloudComponentContainerRegistryRequest.container_registry:type_name -> chalk.server.v1.CloudComponentContainerRegistryRequest
	35,  // 101: chalk.server.v1.CreateCloudComponentContainerRegistryResponse.container_registry:type_name -> chalk.server.v1.CloudComponentContainerRegistryResponse
	36,  // 102: chalk.server.v1.UpdateCloudComponentContainerRegistryRequest.container_registry:type_name -> chalk.server.v1.CloudComponentContainerRegistryRequest
	35,  // 103: chalk.server.v1.UpdateCloudComponentContainerRegistryResponse.container_registry:type_name -> chalk.server.v1.CloudComponentContainerRegistryResponse
	35,  // 104: chalk.server.v1.GetCloudComponentContainerRegistryResponse.container_registry:type_name -> chalk.server.v1.CloudComponentContainerRegistryResponse
	35,  // 105: chalk.server.v1.ListCloudComponentContainerRegistryResponse.container_registries:type_name -> chalk.server.v1.CloudComponentContainerRegistryResponse
	107, // 106: chalk.server.v1.ListBindingClusterContainerRegistryResponse.bindings:type_name -> chalk.server.v1.GetBindingClusterContainerRegistryResponse
	117, // 107: chalk.server.v1.ListBindingClusterGatewayResponse.bindings:type_name -> chalk.server.v1.GetBindingClusterGatewayResponse
	125, // 108: chalk.server.v1.ListBindingServicesGatewayResponse.bindings:type_name -> chalk.server.v1.GetBindingServicesGatewayResponse
	133, // 109: chalk.server.v1.ListBindingPrivateGatewayResponse.bindings:type_name -> chalk.server.v1.GetBindingPrivateGatewayResponse
	141, // 110: chalk.server.v1.ListBindingClusterBackgroundPersistenceDeploymentResponse.bindings:type_name -> chalk.server.v1.GetBindingClusterBackgroundPersistenceDeploymentResponse
	149, // 111: chalk.server.v1.ListBindingClusterTelemetryDeploymentResponse.bindings:type_name -> chalk.server.v1.GetBindingClusterTelemetryDeploymentResponse
	157, // 112: chalk.server.v1.ListBindingEnvironmentGatewayResponse.bindings:type_name -> chalk.server.v1.GetBindingEnvironmentGatewayResponse
	165, // 113: chalk.server.v1.ListBindingEnvironmentBackgroundPersistenceDeploymentResponse.bindings:type_name -> chalk.server.v1.GetBindingEnvironmentBackgroundPersistenceDeploymentResponse
	169, // 114: chalk.server.v1.DataplaneDynamicConfig.dataplane_controller:type_name -> chalk.server.v1.DataplaneControllerDynamicConfig
	170, // 115: chalk.server.v1.DataplaneDynamicConfig.hypervisor:type_name -> chalk.server.v1.HypervisorDynamicConfig
	65,  // 116: chalk.server.v1.ListRecoveryClusterTargetsResponse.recovery_cluster_targets:type_name -> chalk.server.v1.RecoveryClusterTarget
	65,  // 117: chalk.server.v1.ActivateRecoveryClusterTargetResponse.recovery_cluster_target:type_name -> chalk.server.v1.RecoveryClusterTarget
	65,  // 118: chalk.server.v1.DeactivateRecoveryClusterTargetResponse.recovery_cluster_target:type_name -> chalk.server.v1.RecoveryClusterTarget
	38,  // 119: chalk.server.v1.ClusterReplicationSource.source_cluster:type_name -> chalk.server.v1.CloudComponentCluster
	181, // 120: chalk.server.v1.ClusterReplicationSource.source_cloud_credentials:type_name -> chalk.server.v1.CloudConfig
	4,   // 121: chalk.server.v1.DataplaneController.TierInfo.tier:type_name -> chalk.server.v1.DataplaneController.Tier
	8,   // 122: chalk.server.v1.CloudComponentsService.CreateCloudComponentVpc:input_type -> chalk.server.v1.CreateCloudComponentVpcRequest
	10,  // 123: chalk.server.v1.CloudComponentsService.GetCloudComponentVpc:input_type -> chalk.server.v1.GetCloudComponentVpcRequest
	14,  // 124: chalk.server.v1.CloudComponentsService.ListCloudComponentVpc:input_type -> chalk.server.v1.ListCloudComponentVpcRequest
	12,  // 125: chalk.server.v1.CloudComponentsService.DeleteCloudComponentVpc:input_type -> chalk.server.v1.DeleteCloudComponentVpcRequest
	50,  // 126: chalk.server.v1.CloudComponentsService.CreateCloudComponentCluster:input_type -> chalk.server.v1.CreateCloudComponentClusterRequest
	66,  // 127: chalk.server.v1.CloudComponentsService.CreateRecoverClusterTarget:input_type -> chalk.server.v1.CreateRecoverClusterTargetRequest
	171, // 128: chalk.server.v1.CloudComponentsService.ListRecoveryClusterTargets:input_type -> chalk.server.v1.ListRecoveryClusterTargetsRequest
	173, // 129: chalk.server.v1.CloudComponentsService.ActivateRecoveryClusterTarget:input_type -> chalk.server.v1.ActivateRecoveryClusterTargetRequest
	175, // 130: chalk.server.v1.CloudComponentsService.DeactivateRecoveryClusterTarget:input_type -> chalk.server.v1.DeactivateRecoveryClusterTargetRequest
	52,  // 131: chalk.server.v1.CloudComponentsService.UpdateCloudComponentCluster:input_type -> chalk.server.v1.UpdateCloudComponentClusterRequest
	54,  // 132: chalk.server.v1.CloudComponentsService.GetCloudComponentCluster:input_type -> chalk.server.v1.GetCloudComponentClusterRequest
	60,  // 133: chalk.server.v1.CloudComponentsService.ListCloudComponentCluster:input_type -> chalk.server.v1.ListCloudComponentClusterRequest
	62,  // 134: chalk.server.v1.CloudComponentsService.ListServerlessClusters:input_type -> chalk.server.v1.ListServerlessClustersRequest
	56,  // 135: chalk.server.v1.CloudComponentsService.DeleteCloudComponentCluster:input_type -> chalk.server.v1.DeleteCloudComponentClusterRequest
	58,  // 136: chalk.server.v1.CloudComponentsService.TestClusterConnection:input_type -> chalk.server.v1.TestClusterConnectionRequest
	68,  // 137: chalk.server.v1.CloudComponentsService.CreateCloudComponentStorage:input_type -> chalk.server.v1.CreateCloudComponentStorageRequest
	70,  // 138: chalk.server.v1.CloudComponentsService.GetCloudComponentStorage:input_type -> chalk.server.v1.GetCloudComponentStorageRequest
	76,  // 139: chalk.server.v1.CloudComponentsService.ListCloudComponentStorage:input_type -> chalk.server.v1.ListCloudComponentStorageRequest
	74,  // 140: chalk.server.v1.CloudComponentsService.UpdateCloudComponentStorage:input_type -> chalk.server.v1.UpdateCloudComponentStorageRequest
	72,  // 141: chalk.server.v1.CloudComponentsService.DeleteCloudComponentStorage:input_type -> chalk.server.v1.DeleteCloudComponentStorageRequest
	78,  // 142: chalk.server.v1.CloudComponentsService.CreateBindingEnvironmentCloudStorage:input_type -> chalk.server.v1.CreateBindingEnvironmentCloudStorageRequest
	80,  // 143: chalk.server.v1.CloudComponentsService.GetBindingEnvironmentCloudStorage:input_type -> chalk.server.v1.GetBindingEnvironmentCloudStorageRequest
	82,  // 144: chalk.server.v1.CloudComponentsService.ListBindingEnvironmentCloudStorage:input_type -> chalk.server.v1.ListBindingEnvironmentCloudStorageRequest
	84,  // 145: chalk.server.v1.CloudComponentsService.DeleteBindingEnvironmentCloudStorage:input_type -> chalk.server.v1.DeleteBindingEnvironmentCloudStorageRequest
	86,  // 146: chalk.server.v1.CloudComponentsService.CreateBindingClusterCloudStorage:input_type -> chalk.server.v1.CreateBindingClusterCloudStorageRequest
	88,  // 147: chalk.server.v1.CloudComponentsService.GetBindingClusterCloudStorage:input_type -> chalk.server.v1.GetBindingClusterCloudStorageRequest
	90,  // 148: chalk.server.v1.CloudComponentsService.ListBindingClusterCloudStorage:input_type -> chalk.server.v1.ListBindingClusterCloudStorageRequest
	92,  // 149: chalk.server.v1.CloudComponentsService.DeleteBindingClusterCloudStorage:input_type -> chalk.server.v1.DeleteBindingClusterCloudStorageRequest
	94,  // 150: chalk.server.v1.CloudComponentsService.CreateCloudComponentContainerRegistry:input_type -> chalk.server.v1.CreateCloudComponentContainerRegistryRequest
	96,  // 151: chalk.server.v1.CloudComponentsService.UpdateCloudComponentContainerRegistry:input_type -> chalk.server.v1.UpdateCloudComponentContainerRegistryRequest
	98,  // 152: chalk.server.v1.CloudComponentsService.GetCloudComponentContainerRegistry:input_type -> chalk.server.v1.GetCloudComponentContainerRegistryRequest
	102, // 153: chalk.server.v1.CloudComponentsService.ListCloudComponentContainerRegistry:input_type -> chalk.server.v1.ListCloudComponentContainerRegistryRequest
	100, // 154: chalk.server.v1.CloudComponentsService.DeleteCloudComponentContainerRegistry:input_type -> chalk.server.v1.DeleteCloudComponentContainerRegistryRequest
	104, // 155: chalk.server.v1.CloudComponentsService.CreateBindingClusterContainerRegistry:input_type -> chalk.server.v1.CreateBindingClusterContainerRegistryRequest
	106, // 156: chalk.server.v1.CloudComponentsService.GetBindingClusterContainerRegistry:input_type -> chalk.server.v1.GetBindingClusterContainerRegistryRequest
	108, // 157: chalk.server.v1.CloudComponentsService.ListBindingClusterContainerRegistry:input_type -> chalk.server.v1.ListBindingClusterContainerRegistryRequest
	110, // 158: chalk.server.v1.CloudComponentsService.DeleteBindingClusterContainerRegistry:input_type -> chalk.server.v1.DeleteBindingClusterContainerRegistryRequest
	112, // 159: chalk.server.v1.CloudComponentsService.CreateBindingClusterGateway:input_type -> chalk.server.v1.CreateBindingClusterGatewayRequest
	116, // 160: chalk.server.v1.CloudComponentsService.GetBindingClusterGateway:input_type -> chalk.server.v1.GetBindingClusterGatewayRequest
	118, // 161: chalk.server.v1.CloudComponentsService.ListBindingClusterGateway:input_type -> chalk.server.v1.ListBindingClusterGatewayRequest
	114, // 162: chalk.server.v1.CloudComponentsService.DeleteBindingClusterGateway:input_type -> chalk.server.v1.DeleteBindingClusterGatewayRequest
	120, // 163: chalk.server.v1.CloudComponentsService.CreateBindingServicesGateway:input_type -> chalk.server.v1.CreateBindingServicesGatewayRequest
	124, // 164: chalk.server.v1.CloudComponentsService.GetBindingServicesGateway:input_type -> chalk.server.v1.GetBindingServicesGatewayRequest
	126, // 165: chalk.server.v1.CloudComponentsService.ListBindingServicesGateway:input_type -> chalk.server.v1.ListBindingServicesGatewayRequest
	122, // 166: chalk.server.v1.CloudComponentsService.DeleteBindingServicesGateway:input_type -> chalk.server.v1.DeleteBindingServicesGatewayRequest
	128, // 167: chalk.server.v1.CloudComponentsService.CreateBindingPrivateGateway:input_type -> chalk.server.v1.CreateBindingPrivateGatewayRequest
	132, // 168: chalk.server.v1.CloudComponentsService.GetBindingPrivateGateway:input_type -> chalk.server.v1.GetBindingPrivateGatewayRequest
	134, // 169: chalk.server.v1.CloudComponentsService.ListBindingPrivateGateway:input_type -> chalk.server.v1.ListBindingPrivateGatewayRequest
	130, // 170: chalk.server.v1.CloudComponentsService.DeleteBindingPrivateGateway:input_type -> chalk.server.v1.DeleteBindingPrivateGatewayRequest
	136, // 171: chalk.server.v1.CloudComponentsService.CreateBindingClusterBackgroundPersistenceDeployment:input_type -> chalk.server.v1.CreateBindingClusterBackgroundPersistenceDeploymentRequest
	140, // 172: chalk.server.v1.CloudComponentsService.GetBindingClusterBackgroundPersistenceDeployment:input_type -> chalk.server.v1.GetBindingClusterBackgroundPersistenceDeploymentRequest
	142, // 173: chalk.server.v1.CloudComponentsService.ListBindingClusterBackgroundPersistenceDeployment:input_type -> chalk.server.v1.ListBindingClusterBackgroundPersistenceDeploymentRequest
	138, // 174: chalk.server.v1.CloudComponentsService.DeleteBindingClusterBackgroundPersistenceDeployment:input_type -> chalk.server.v1.DeleteBindingClusterBackgroundPersistenceDeploymentRequest
	144, // 175: chalk.server.v1.CloudComponentsService.CreateBindingClusterTelemetryDeployment:input_type -> chalk.server.v1.CreateBindingClusterTelemetryDeploymentRequest
	148, // 176: chalk.server.v1.CloudComponentsService.GetBindingClusterTelemetryDeployment:input_type -> chalk.server.v1.GetBindingClusterTelemetryDeploymentRequest
	150, // 177: chalk.server.v1.CloudComponentsService.ListBindingClusterTelemetryDeployment:input_type -> chalk.server.v1.ListBindingClusterTelemetryDeploymentRequest
	146, // 178: chalk.server.v1.CloudComponentsService.DeleteBindingClusterTelemetryDeployment:input_type -> chalk.server.v1.DeleteBindingClusterTelemetryDeploymentRequest
	152, // 179: chalk.server.v1.CloudComponentsService.CreateBindingEnvironmentGateway:input_type -> chalk.server.v1.CreateBindingEnvironmentGatewayRequest
	156, // 180: chalk.server.v1.CloudComponentsService.GetBindingEnvironmentGateway:input_type -> chalk.server.v1.GetBindingEnvironmentGatewayRequest
	158, // 181: chalk.server.v1.CloudComponentsService.ListBindingEnvironmentGateway:input_type -> chalk.server.v1.ListBindingEnvironmentGatewayRequest
	154, // 182: chalk.server.v1.CloudComponentsService.DeleteBindingEnvironmentGateway:input_type -> chalk.server.v1.DeleteBindingEnvironmentGatewayRequest
	160, // 183: chalk.server.v1.CloudComponentsService.CreateBindingEnvironmentBackgroundPersistenceDeployment:input_type -> chalk.server.v1.CreateBindingEnvironmentBackgroundPersistenceDeploymentRequest
	164, // 184: chalk.server.v1.CloudComponentsService.GetBindingEnvironmentBackgroundPersistenceDeployment:input_type -> chalk.server.v1.GetBindingEnvironmentBackgroundPersistenceDeploymentRequest
	166, // 185: chalk.server.v1.CloudComponentsService.ListBindingEnvironmentBackgroundPersistenceDeployment:input_type -> chalk.server.v1.ListBindingEnvironmentBackgroundPersistenceDeploymentRequest
	162, // 186: chalk.server.v1.CloudComponentsService.DeleteBindingEnvironmentBackgroundPersistenceDeployment:input_type -> chalk.server.v1.DeleteBindingEnvironmentBackgroundPersistenceDeploymentRequest
	9,   // 187: chalk.server.v1.CloudComponentsService.CreateCloudComponentVpc:output_type -> chalk.server.v1.CreateCloudComponentVpcResponse
	11,  // 188: chalk.server.v1.CloudComponentsService.GetCloudComponentVpc:output_type -> chalk.server.v1.GetCloudComponentVpcResponse
	15,  // 189: chalk.server.v1.CloudComponentsService.ListCloudComponentVpc:output_type -> chalk.server.v1.ListCloudComponentVpcResponse
	13,  // 190: chalk.server.v1.CloudComponentsService.DeleteCloudComponentVpc:output_type -> chalk.server.v1.DeleteCloudComponentVpcResponse
	51,  // 191: chalk.server.v1.CloudComponentsService.CreateCloudComponentCluster:output_type -> chalk.server.v1.CreateCloudComponentClusterResponse
	67,  // 192: chalk.server.v1.CloudComponentsService.CreateRecoverClusterTarget:output_type -> chalk.server.v1.CreateRecoverClusterTargetResponse
	172, // 193: chalk.server.v1.CloudComponentsService.ListRecoveryClusterTargets:output_type -> chalk.server.v1.ListRecoveryClusterTargetsResponse
	174, // 194: chalk.server.v1.CloudComponentsService.ActivateRecoveryClusterTarget:output_type -> chalk.server.v1.ActivateRecoveryClusterTargetResponse
	176, // 195: chalk.server.v1.CloudComponentsService.DeactivateRecoveryClusterTarget:output_type -> chalk.server.v1.DeactivateRecoveryClusterTargetResponse
	53,  // 196: chalk.server.v1.CloudComponentsService.UpdateCloudComponentCluster:output_type -> chalk.server.v1.UpdateCloudComponentClusterResponse
	55,  // 197: chalk.server.v1.CloudComponentsService.GetCloudComponentCluster:output_type -> chalk.server.v1.GetCloudComponentClusterResponse
	61,  // 198: chalk.server.v1.CloudComponentsService.ListCloudComponentCluster:output_type -> chalk.server.v1.ListCloudComponentClusterResponse
	64,  // 199: chalk.server.v1.CloudComponentsService.ListServerlessClusters:output_type -> chalk.server.v1.ListServerlessClustersResponse
	57,  // 200: chalk.server.v1.CloudComponentsService.DeleteCloudComponentCluster:output_type -> chalk.server.v1.DeleteCloudComponentClusterResponse
	59,  // 201: chalk.server.v1.CloudComponentsService.TestClusterConnection:output_type -> chalk.server.v1.TestClusterConnectionResponse
	69,  // 202: chalk.server.v1.CloudComponentsService.CreateCloudComponentStorage:output_type -> chalk.server.v1.CreateCloudComponentStorageResponse
	71,  // 203: chalk.server.v1.CloudComponentsService.GetCloudComponentStorage:output_type -> chalk.server.v1.GetCloudComponentStorageResponse
	77,  // 204: chalk.server.v1.CloudComponentsService.ListCloudComponentStorage:output_type -> chalk.server.v1.ListCloudComponentStorageResponse
	75,  // 205: chalk.server.v1.CloudComponentsService.UpdateCloudComponentStorage:output_type -> chalk.server.v1.UpdateCloudComponentStorageResponse
	73,  // 206: chalk.server.v1.CloudComponentsService.DeleteCloudComponentStorage:output_type -> chalk.server.v1.DeleteCloudComponentStorageResponse
	79,  // 207: chalk.server.v1.CloudComponentsService.CreateBindingEnvironmentCloudStorage:output_type -> chalk.server.v1.CreateBindingEnvironmentCloudStorageResponse
	81,  // 208: chalk.server.v1.CloudComponentsService.GetBindingEnvironmentCloudStorage:output_type -> chalk.server.v1.GetBindingEnvironmentCloudStorageResponse
	83,  // 209: chalk.server.v1.CloudComponentsService.ListBindingEnvironmentCloudStorage:output_type -> chalk.server.v1.ListBindingEnvironmentCloudStorageResponse
	85,  // 210: chalk.server.v1.CloudComponentsService.DeleteBindingEnvironmentCloudStorage:output_type -> chalk.server.v1.DeleteBindingEnvironmentCloudStorageResponse
	87,  // 211: chalk.server.v1.CloudComponentsService.CreateBindingClusterCloudStorage:output_type -> chalk.server.v1.CreateBindingClusterCloudStorageResponse
	89,  // 212: chalk.server.v1.CloudComponentsService.GetBindingClusterCloudStorage:output_type -> chalk.server.v1.GetBindingClusterCloudStorageResponse
	91,  // 213: chalk.server.v1.CloudComponentsService.ListBindingClusterCloudStorage:output_type -> chalk.server.v1.ListBindingClusterCloudStorageResponse
	93,  // 214: chalk.server.v1.CloudComponentsService.DeleteBindingClusterCloudStorage:output_type -> chalk.server.v1.DeleteBindingClusterCloudStorageResponse
	95,  // 215: chalk.server.v1.CloudComponentsService.CreateCloudComponentContainerRegistry:output_type -> chalk.server.v1.CreateCloudComponentContainerRegistryResponse
	97,  // 216: chalk.server.v1.CloudComponentsService.UpdateCloudComponentContainerRegistry:output_type -> chalk.server.v1.UpdateCloudComponentContainerRegistryResponse
	99,  // 217: chalk.server.v1.CloudComponentsService.GetCloudComponentContainerRegistry:output_type -> chalk.server.v1.GetCloudComponentContainerRegistryResponse
	103, // 218: chalk.server.v1.CloudComponentsService.ListCloudComponentContainerRegistry:output_type -> chalk.server.v1.ListCloudComponentContainerRegistryResponse
	101, // 219: chalk.server.v1.CloudComponentsService.DeleteCloudComponentContainerRegistry:output_type -> chalk.server.v1.DeleteCloudComponentContainerRegistryResponse
	105, // 220: chalk.server.v1.CloudComponentsService.CreateBindingClusterContainerRegistry:output_type -> chalk.server.v1.CreateBindingClusterContainerRegistryResponse
	107, // 221: chalk.server.v1.CloudComponentsService.GetBindingClusterContainerRegistry:output_type -> chalk.server.v1.GetBindingClusterContainerRegistryResponse
	109, // 222: chalk.server.v1.CloudComponentsService.ListBindingClusterContainerRegistry:output_type -> chalk.server.v1.ListBindingClusterContainerRegistryResponse
	111, // 223: chalk.server.v1.CloudComponentsService.DeleteBindingClusterContainerRegistry:output_type -> chalk.server.v1.DeleteBindingClusterContainerRegistryResponse
	113, // 224: chalk.server.v1.CloudComponentsService.CreateBindingClusterGateway:output_type -> chalk.server.v1.CreateBindingClusterGatewayResponse
	117, // 225: chalk.server.v1.CloudComponentsService.GetBindingClusterGateway:output_type -> chalk.server.v1.GetBindingClusterGatewayResponse
	119, // 226: chalk.server.v1.CloudComponentsService.ListBindingClusterGateway:output_type -> chalk.server.v1.ListBindingClusterGatewayResponse
	115, // 227: chalk.server.v1.CloudComponentsService.DeleteBindingClusterGateway:output_type -> chalk.server.v1.DeleteBindingClusterGatewayResponse
	121, // 228: chalk.server.v1.CloudComponentsService.CreateBindingServicesGateway:output_type -> chalk.server.v1.CreateBindingServicesGatewayResponse
	125, // 229: chalk.server.v1.CloudComponentsService.GetBindingServicesGateway:output_type -> chalk.server.v1.GetBindingServicesGatewayResponse
	127, // 230: chalk.server.v1.CloudComponentsService.ListBindingServicesGateway:output_type -> chalk.server.v1.ListBindingServicesGatewayResponse
	123, // 231: chalk.server.v1.CloudComponentsService.DeleteBindingServicesGateway:output_type -> chalk.server.v1.DeleteBindingServicesGatewayResponse
	129, // 232: chalk.server.v1.CloudComponentsService.CreateBindingPrivateGateway:output_type -> chalk.server.v1.CreateBindingPrivateGatewayResponse
	133, // 233: chalk.server.v1.CloudComponentsService.GetBindingPrivateGateway:output_type -> chalk.server.v1.GetBindingPrivateGatewayResponse
	135, // 234: chalk.server.v1.CloudComponentsService.ListBindingPrivateGateway:output_type -> chalk.server.v1.ListBindingPrivateGatewayResponse
	131, // 235: chalk.server.v1.CloudComponentsService.DeleteBindingPrivateGateway:output_type -> chalk.server.v1.DeleteBindingPrivateGatewayResponse
	137, // 236: chalk.server.v1.CloudComponentsService.CreateBindingClusterBackgroundPersistenceDeployment:output_type -> chalk.server.v1.CreateBindingClusterBackgroundPersistenceDeploymentResponse
	141, // 237: chalk.server.v1.CloudComponentsService.GetBindingClusterBackgroundPersistenceDeployment:output_type -> chalk.server.v1.GetBindingClusterBackgroundPersistenceDeploymentResponse
	143, // 238: chalk.server.v1.CloudComponentsService.ListBindingClusterBackgroundPersistenceDeployment:output_type -> chalk.server.v1.ListBindingClusterBackgroundPersistenceDeploymentResponse
	139, // 239: chalk.server.v1.CloudComponentsService.DeleteBindingClusterBackgroundPersistenceDeployment:output_type -> chalk.server.v1.DeleteBindingClusterBackgroundPersistenceDeploymentResponse
	145, // 240: chalk.server.v1.CloudComponentsService.CreateBindingClusterTelemetryDeployment:output_type -> chalk.server.v1.CreateBindingClusterTelemetryDeploymentResponse
	149, // 241: chalk.server.v1.CloudComponentsService.GetBindingClusterTelemetryDeployment:output_type -> chalk.server.v1.GetBindingClusterTelemetryDeploymentResponse
	151, // 242: chalk.server.v1.CloudComponentsService.ListBindingClusterTelemetryDeployment:output_type -> chalk.server.v1.ListBindingClusterTelemetryDeploymentResponse
	147, // 243: chalk.server.v1.CloudComponentsService.DeleteBindingClusterTelemetryDeployment:output_type -> chalk.server.v1.DeleteBindingClusterTelemetryDeploymentResponse
	153, // 244: chalk.server.v1.CloudComponentsService.CreateBindingEnvironmentGateway:output_type -> chalk.server.v1.CreateBindingEnvironmentGatewayResponse
	157, // 245: chalk.server.v1.CloudComponentsService.GetBindingEnvironmentGateway:output_type -> chalk.server.v1.GetBindingEnvironmentGatewayResponse
	159, // 246: chalk.server.v1.CloudComponentsService.ListBindingEnvironmentGateway:output_type -> chalk.server.v1.ListBindingEnvironmentGatewayResponse
	155, // 247: chalk.server.v1.CloudComponentsService.DeleteBindingEnvironmentGateway:output_type -> chalk.server.v1.DeleteBindingEnvironmentGatewayResponse
	161, // 248: chalk.server.v1.CloudComponentsService.CreateBindingEnvironmentBackgroundPersistenceDeployment:output_type -> chalk.server.v1.CreateBindingEnvironmentBackgroundPersistenceDeploymentResponse
	165, // 249: chalk.server.v1.CloudComponentsService.GetBindingEnvironmentBackgroundPersistenceDeployment:output_type -> chalk.server.v1.GetBindingEnvironmentBackgroundPersistenceDeploymentResponse
	167, // 250: chalk.server.v1.CloudComponentsService.ListBindingEnvironmentBackgroundPersistenceDeployment:output_type -> chalk.server.v1.ListBindingEnvironmentBackgroundPersistenceDeploymentResponse
	163, // 251: chalk.server.v1.CloudComponentsService.DeleteBindingEnvironmentBackgroundPersistenceDeployment:output_type -> chalk.server.v1.DeleteBindingEnvironmentBackgroundPersistenceDeploymentResponse
	187, // [187:252] is the sub-list for method output_type
	122, // [122:187] is the sub-list for method input_type
...
func file_chalk_server_v1_cloud_components_proto_init() {
	...
	file_chalk_server_v1_cloud_components_proto_msgTypes[37].OneofWrappers = []any{
	...
	file_chalk_server_v1_cloud_components_proto_msgTypes[43].OneofWrappers = []any{}
	file_chalk_server_v1_cloud_components_proto_msgTypes[44].OneofWrappers = []any{}
	file_chalk_server_v1_cloud_components_proto_msgTypes[45].OneofWrappers = []any{}
	file_chalk_server_v1_cloud_components_proto_msgTypes[53].OneofWrappers = []any{
		(*TestClusterConnectionRequest_Id)(nil),
		(*TestClusterConnectionRequest_Config)(nil),
	}
	file_chalk_server_v1_cloud_components_proto_msgTypes[60].OneofWrappers = []any{}
	file_chalk_server_v1_cloud_components_proto_msgTypes[61].OneofWrappers = []any{}
	file_chalk_server_v1_cloud_components_proto_msgTypes[102].OneofWrappers = []any{}
	file_chalk_server_v1_cloud_components_proto_msgTypes[163].OneofWrappers = []any{}
	type x struct{}
