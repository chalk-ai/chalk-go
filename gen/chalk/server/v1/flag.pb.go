...
func (FlagScope) Descriptor() protoreflect.EnumDescriptor {
	return file_chalk_server_v1_flag_proto_enumTypes[1].Descriptor()
}

func (FlagScope) Type() protoreflect.EnumType {
	return &file_chalk_server_v1_flag_proto_enumTypes[1]
}
...
var file_chalk_server_v1_flag_proto_rawDesc = []byte{
	...
	,
	...
	0x44, 0x10, 0x00, 0x12, 0x24, 0x0a, 0x20, 0x46, 0x45, 0x41, 0x54, 0x55, 0x52, 0x45, 0x5f, 0x46,
	0x4c, 0x41, 0x47, 0x5f, 0x46, 0x45, 0x41, 0x54, 0x55, 0x52, 0x45, 0x5f, 0x50, 0x45, 0x52, 0x4d,
	0x49, 0x53, 0x53, 0x49, 0x4f, 0x4e, 0x53, 0x10, 0x01, 0x2a, 0x58, 0x0a, 0x09, 0x46, 0x6c, 0x61,
...
var file_chalk_server_v1_flag_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
...
var file_chalk_server_v1_flag_proto_goTypes = []interface{}{
	...
	(FlagScope)(0),                  // 1: chalk.server.v1.FlagScope
	(*FeatureFlagValue)(nil),        // 2: chalk.server.v1.FeatureFlagValue
	(*GetFeatureFlagsRequest)(nil),  // 3: chalk.server.v1.GetFeatureFlagsRequest
	(*GetFeatureFlagsResponse)(nil), // 4: chalk.server.v1.GetFeatureFlagsResponse
	(*SetFeatureFlagRequest)(nil),   // 5: chalk.server.v1.SetFeatureFlagRequest
	(*SetFeatureFlagResponse)(nil),  // 6: chalk.server.v1.SetFeatureFlagResponse
}
var file_chalk_server_v1_flag_proto_depIdxs = []int32{
	...
	2, // 1: chalk.server.v1.GetFeatureFlagsResponse.flags:type_name -> chalk.server.v1.FeatureFlagValue
	0, // 2: chalk.server.v1.SetFeatureFlagRequest.flag:type_name -> chalk.server.v1.FeatureFlag
	1, // 3: chalk.server.v1.SetFeatureFlagRequest.scope:type_name -> chalk.server.v1.FlagScope
	3, // 4: chalk.server.v1.FeatureFlagService.GetFeatureFlags:input_type -> chalk.server.v1.GetFeatureFlagsRequest
	5, // 5: chalk.server.v1.FeatureFlagService.SetFeatureFlag:input_type -> chalk.server.v1.SetFeatureFlagRequest
	4, // 6: chalk.server.v1.FeatureFlagService.GetFeatureFlags:output_type -> chalk.server.v1.GetFeatureFlagsResponse
	6, // 7: chalk.server.v1.FeatureFlagService.SetFeatureFlag:output_type -> chalk.server.v1.SetFeatureFlagResponse
