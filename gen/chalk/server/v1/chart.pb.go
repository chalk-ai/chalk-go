...
func file_chalk_server_v1_chart_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chalk_server_v1_chart_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Series); i {
			case 0:
				return &v.state
			case 1:
		...
		file_chalk_server_v1_chart_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Chart); i {
			case 0:
				return &v.state
			case 1:
		...
		file_chalk_server_v1_chart_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Point); i {
			case 0:
				return &v.state
			case 1:
		...
		file_chalk_server_v1_chart_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_chalk_server_v1_chart_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*TimeSeriesChart); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
