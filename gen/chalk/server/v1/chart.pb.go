...
var file_chalk_server_v1_chart_proto_goTypes = []any{
	...
	(*v11.DenseTimeSeriesChart)(nil),         // 84: chalk.chart.v1.DenseTimeSeriesChart
	(*MetricIncident)(nil),                   // 85: chalk.server.v1.MetricIncident
	(v1.FilterKind)(0),                       // 86: chalk.artifacts.v1.FilterKind
	(v1.GroupByKind)(0),                      // 87: chalk.artifacts.v1.GroupByKind
	(v1.WindowFunctionKind)(0),               // 88: chalk.artifacts.v1.WindowFunctionKind
	(v1.MetricKind)(0),                       // 89: chalk.artifacts.v1.MetricKind
	(v1.MetricFormulaKind)(0),                // 90: chalk.artifacts.v1.MetricFormulaKind
	(v1.RawMetricValueKind)(0),               // 91: chalk.artifacts.v1.RawMetricValueKind
}
var file_chalk_server_v1_chart_proto_depIdxs = []int32{
	...
	79,  // 24: chalk.server.v1.CreateChartResponse.chart:type_name -> chalk.artifacts.v1.Chart
	22,  // 25: chalk.server.v1.UpdateMetricConfigRequest.update:type_name -> chalk.server.v1.UpdateMetricConfigOperation
	83,  // 26: chalk.server.v1.UpdateMetricConfigRequest.update_mask:type_name -> google.protobuf.FieldMask
	78,  // 27: chalk.server.v1.UpdateMetricConfigResponse.metric_config:type_name -> chalk.artifacts.v1.MetricConfig
	78,  // 28: chalk.server.v1.GetChartSnapshotRequest.metric_config:type_name -> chalk.artifacts.v1.MetricConfig
	75,  // 29: chalk.server.v1.GetChartSnapshotRequest.start_time:type_name -> google.protobuf.Timestamp
	75,  // 30: chalk.server.v1.GetChartSnapshotRequest.end_time:type_name -> google.protobuf.Timestamp
	0,   // 31: chalk.server.v1.GetChartSnapshotRequest.metrics_backend:type_name -> chalk.server.v1.ChartMetricsBackend
	76,  // 32: chalk.server.v1.GetChartSnapshotRequest.comparison_lookback_offset:type_name -> google.protobuf.Duration
	84,  // 33: chalk.server.v1.GetChartSnapshotResponse.charts:type_name -> chalk.chart.v1.DenseTimeSeriesChart
	75,  // 34: chalk.server.v1.GetChartSnapshotResponse.x_series:type_name -> google.protobuf.Timestamp
	76,  // 35: chalk.server.v1.GetChartSnapshotResponse.window_period:type_name -> google.protobuf.Duration
	0,   // 36: chalk.server.v1.GetChartSnapshotResponse.metrics_backend:type_name -> chalk.server.v1.ChartMetricsBackend
	31,  // 37: chalk.server.v1.GetChartSnapshotResponse.statistic:type_name -> chalk.server.v1.StatisticResult
	75,  // 38: chalk.server.v1.GetChartSnapshotByQueryRequest.start_time:type_name -> google.protobuf.Timestamp
	75,  // 39: chalk.server.v1.GetChartSnapshotByQueryRequest.end_time:type_name -> google.protobuf.Timestamp
	0,   // 40: chalk.server.v1.GetChartSnapshotByQueryRequest.metrics_backend:type_name -> chalk.server.v1.ChartMetricsBackend
	84,  // 41: chalk.server.v1.GetChartSnapshotByQueryResponse.charts:type_name -> chalk.chart.v1.DenseTimeSeriesChart
	75,  // 42: chalk.server.v1.GetChartSnapshotByQueryResponse.x_series:type_name -> google.protobuf.Timestamp
	76,  // 43: chalk.server.v1.GetChartSnapshotByQueryResponse.window_period:type_name -> google.protobuf.Duration
	78,  // 44: chalk.server.v1.GetChartSnapshotByQueryResponse.compiled_metric_config:type_name -> chalk.artifacts.v1.MetricConfig
	76,  // 45: chalk.server.v1.StatisticResult.comparison_lookback_offset:type_name -> google.protobuf.Duration
	79,  // 46: chalk.server.v1.GetChartResponse.chart:type_name -> chalk.artifacts.v1.Chart
	85,  // 47: chalk.server.v1.GetChartResponse.active_incidents:type_name -> chalk.server.v1.MetricIncident
	86,  // 48: chalk.server.v1.FilterOption.kind:type_name -> chalk.artifacts.v1.FilterKind
	37,  // 49: chalk.server.v1.FilterOption.namespaced_values:type_name -> chalk.server.v1.FilterOptionNamespace
	87,  // 50: chalk.server.v1.GroupOption.kind:type_name -> chalk.artifacts.v1.GroupByKind
	88,  // 51: chalk.server.v1.WindowFunctionOption.window_function:type_name -> chalk.artifacts.v1.WindowFunctionKind
	89,  // 52: chalk.server.v1.MetricOptions.kind:type_name -> chalk.artifacts.v1.MetricKind
	38,  // 53: chalk.server.v1.MetricOptions.filters:type_name -> chalk.server.v1.FilterOption
	39,  // 54: chalk.server.v1.MetricOptions.groups:type_name -> chalk.server.v1.GroupOption
	40,  // 55: chalk.server.v1.MetricOptions.window_functions:type_name -> chalk.server.v1.WindowFunctionOption
	1,   // 56: chalk.server.v1.MetricOptions.metric_kind_group:type_name -> chalk.server.v1.MetricKindGroup
	42,  // 57: chalk.server.v1.MetricFormulaFeatureOperandList.features:type_name -> chalk.server.v1.MetricFormulaFeatureOperandInput
	44,  // 58: chalk.server.v1.MetricFormulaDatasetOperandList.datasets:type_name -> chalk.server.v1.MetricFormulaDatasetOperandInput
	2,   // 59: chalk.server.v1.MetricFormulaOperand.kind:type_name -> chalk.server.v1.MetricFormulaOperandKind
	45,  // 60: chalk.server.v1.MetricFormulaOperand.dataset_operands:type_name -> chalk.server.v1.MetricFormulaDatasetOperandList
	43,  // 61: chalk.server.v1.MetricFormulaOperand.feature_operands:type_name -> chalk.server.v1.MetricFormulaFeatureOperandList
	90,  // 62: chalk.server.v1.MetricFormulaOption.kind:type_name -> chalk.artifacts.v1.MetricFormulaKind
	46,  // 63: chalk.server.v1.MetricFormulaOption.operands:type_name -> chalk.server.v1.MetricFormulaOperand
	41,  // 64: chalk.server.v1.GetChartOptionsResponse.metrics:type_name -> chalk.server.v1.MetricOptions
	47,  // 65: chalk.server.v1.GetChartOptionsResponse.formulas:type_name -> chalk.server.v1.MetricFormulaOption
	3,   // 66: chalk.server.v1.MetricHealthCheck.status:type_name -> chalk.server.v1.MetricHealthStatus
	50,  // 67: chalk.server.v1.SparkSeries.points:type_name -> chalk.server.v1.SparkPoint
	51,  // 68: chalk.server.v1.EntityMetrics.successful_requests:type_name -> chalk.server.v1.SparkSeries
	51,  // 69: chalk.server.v1.EntityMetrics.failed_requests:type_name -> chalk.server.v1.SparkSeries
	49,  // 70: chalk.server.v1.EntityMetrics.health:type_name -> chalk.server.v1.MetricHealthCheck
	52,  // 71: chalk.server.v1.GetFeatureMetricsResponse.metrics:type_name -> chalk.server.v1.EntityMetrics
	52,  // 72: chalk.server.v1.GetResolverMetricsResponse.metrics:type_name -> chalk.server.v1.EntityMetrics
	52,  // 73: chalk.server.v1.GetQueryMetricsResponse.metrics:type_name -> chalk.server.v1.EntityMetrics
	89,  // 74: chalk.server.v1.GetMetricOptionsRequest.metric_kind:type_name -> chalk.artifacts.v1.MetricKind
	41,  // 75: chalk.server.v1.GetMetricOptionsResponse.metric_options:type_name -> chalk.server.v1.MetricOptions
	90,  // 76: chalk.server.v1.GetFormulaOptionsRequest.formula_kind:type_name -> chalk.artifacts.v1.MetricFormulaKind
	47,  // 77: chalk.server.v1.GetFormulaOptionsResponse.formula_options:type_name -> chalk.server.v1.MetricFormulaOption
	91,  // 78: chalk.server.v1.RawMetricDescriptor.value_kind:type_name -> chalk.artifacts.v1.RawMetricValueKind
	63,  // 79: chalk.server.v1.ListRawMetricsResponse.metrics:type_name -> chalk.server.v1.RawMetricDescriptor
	75,  // 80: chalk.server.v1.RawMetricsQueryPoint.timestamp:type_name -> google.protobuf.Timestamp
	74,  // 81: chalk.server.v1.RawMetricsQuerySeries.labels:type_name -> chalk.server.v1.RawMetricsQuerySeries.LabelsEntry
	70,  // 82: chalk.server.v1.RawMetricsQuerySeries.points:type_name -> chalk.server.v1.RawMetricsQueryPoint
	75,  // 83: chalk.server.v1.QueryRawMetricsRequest.start_time:type_name -> google.protobuf.Timestamp
	75,  // 84: chalk.server.v1.QueryRawMetricsRequest.end_time:type_name -> google.protobuf.Timestamp
	76,  // 85: chalk.server.v1.QueryRawMetricsRequest.step:type_name -> google.protobuf.Duration
	71,  // 86: chalk.server.v1.QueryRawMetricsResponse.series:type_name -> chalk.server.v1.RawMetricsQuerySeries
	64,  // 87: chalk.server.v1.ChartsService.ListRawMetrics:input_type -> chalk.server.v1.ListRawMetricsRequest
	66,  // 88: chalk.server.v1.ChartsService.GetRawMetricLabelNames:input_type -> chalk.server.v1.GetRawMetricLabelNamesRequest
	68,  // 89: chalk.server.v1.ChartsService.GetRawMetricLabelValues:input_type -> chalk.server.v1.GetRawMetricLabelValuesRequest
	72,  // 90: chalk.server.v1.ChartsService.QueryRawMetrics:input_type -> chalk.server.v1.QueryRawMetricsRequest
	12,  // 91: chalk.server.v1.ChartsService.ListCharts:input_type -> chalk.server.v1.ListChartsRequest
	16,  // 92: chalk.server.v1.ChartsService.ListChartAnnotations:input_type -> chalk.server.v1.ListChartAnnotationsRequest
	14,  // 93: chalk.server.v1.ChartsService.CreateChartAnnotation:input_type -> chalk.server.v1.CreateChartAnnotationRequest
	18,  // 94: chalk.server.v1.ChartsService.DeleteChartAnnotation:input_type -> chalk.server.v1.DeleteChartAnnotationRequest
	27,  // 95: chalk.server.v1.ChartsService.GetChartSnapshot:input_type -> chalk.server.v1.GetChartSnapshotRequest
	29,  // 96: chalk.server.v1.ChartsService.GetChartSnapshotByQuery:input_type -> chalk.server.v1.GetChartSnapshotByQueryRequest
	25,  // 97: chalk.server.v1.ChartsService.UpdateMetricConfig:input_type -> chalk.server.v1.UpdateMetricConfigRequest
	23,  // 98: chalk.server.v1.ChartsService.CreateChart:input_type -> chalk.server.v1.CreateChartRequest
	32,  // 99: chalk.server.v1.ChartsService.DeleteChart:input_type -> chalk.server.v1.DeleteChartRequest
	34,  // 100: chalk.server.v1.ChartsService.GetChart:input_type -> chalk.server.v1.GetChartRequest
	36,  // 101: chalk.server.v1.ChartsService.GetChartOptions:input_type -> chalk.server.v1.GetChartOptionsRequest
	53,  // 102: chalk.server.v1.ChartsService.GetFeatureMetrics:input_type -> chalk.server.v1.GetFeatureMetricsRequest
	55,  // 103: chalk.server.v1.ChartsService.GetResolverMetrics:input_type -> chalk.server.v1.GetResolverMetricsRequest
	57,  // 104: chalk.server.v1.ChartsService.GetQueryMetrics:input_type -> chalk.server.v1.GetQueryMetricsRequest
	59,  // 105: chalk.server.v1.ChartsService.GetMetricOptions:input_type -> chalk.server.v1.GetMetricOptionsRequest
	61,  // 106: chalk.server.v1.ChartsService.GetFormulaOptions:input_type -> chalk.server.v1.GetFormulaOptionsRequest
	20,  // 107: chalk.server.v1.ChartsService.ListChartsWithCronAlerts:input_type -> chalk.server.v1.ListChartsWithCronAlertsRequest
	65,  // 108: chalk.server.v1.ChartsService.ListRawMetrics:output_type -> chalk.server.v1.ListRawMetricsResponse
	67,  // 109: chalk.server.v1.ChartsService.GetRawMetricLabelNames:output_type -> chalk.server.v1.GetRawMetricLabelNamesResponse
	69,  // 110: chalk.server.v1.ChartsService.GetRawMetricLabelValues:output_type -> chalk.server.v1.GetRawMetricLabelValuesResponse
	73,  // 111: chalk.server.v1.ChartsService.QueryRawMetrics:output_type -> chalk.server.v1.QueryRawMetricsResponse
	13,  // 112: chalk.server.v1.ChartsService.ListCharts:output_type -> chalk.server.v1.ListChartsResponse
	17,  // 113: chalk.server.v1.ChartsService.ListChartAnnotations:output_type -> chalk.server.v1.ListChartAnnotationsResponse
	15,  // 114: chalk.server.v1.ChartsService.CreateChartAnnotation:output_type -> chalk.server.v1.CreateChartAnnotationResponse
	19,  // 115: chalk.server.v1.ChartsService.DeleteChartAnnotation:output_type -> chalk.server.v1.DeleteChartAnnotationResponse
	28,  // 116: chalk.server.v1.ChartsService.GetChartSnapshot:output_type -> chalk.server.v1.GetChartSnapshotResponse
	30,  // 117: chalk.server.v1.ChartsService.GetChartSnapshotByQuery:output_type -> chalk.server.v1.GetChartSnapshotByQueryResponse
	26,  // 118: chalk.server.v1.ChartsService.UpdateMetricConfig:output_type -> chalk.server.v1.UpdateMetricConfigResponse
	24,  // 119: chalk.server.v1.ChartsService.CreateChart:output_type -> chalk.server.v1.CreateChartResponse
	33,  // 120: chalk.server.v1.ChartsService.DeleteChart:output_type -> chalk.server.v1.DeleteChartResponse
	35,  // 121: chalk.server.v1.ChartsService.GetChart:output_type -> chalk.server.v1.GetChartResponse
	48,  // 122: chalk.server.v1.ChartsService.GetChartOptions:output_type -> chalk.server.v1.GetChartOptionsResponse
	54,  // 123: chalk.server.v1.ChartsService.GetFeatureMetrics:output_type -> chalk.server.v1.GetFeatureMetricsResponse
	56,  // 124: chalk.server.v1.ChartsService.GetResolverMetrics:output_type -> chalk.server.v1.GetResolverMetricsResponse
	58,  // 125: chalk.server.v1.ChartsService.GetQueryMetrics:output_type -> chalk.server.v1.GetQueryMetricsResponse
	60,  // 126: chalk.server.v1.ChartsService.GetMetricOptions:output_type -> chalk.server.v1.GetMetricOptionsResponse
	62,  // 127: chalk.server.v1.ChartsService.GetFormulaOptions:output_type -> chalk.server.v1.GetFormulaOptionsResponse
	21,  // 128: chalk.server.v1.ChartsService.ListChartsWithCronAlerts:output_type -> chalk.server.v1.ListChartsWithCronAlertsResponse
