...
const file_chalk_server_v1_team_proto_rawDesc = "" +
	...
	"\x12ArchiveEnvironment\x12*.chalk.server.v1.ArchiveEnvironmentRequest\x1a+.chalk.server.v1.ArchiveEnvironmentResponse\"\t\x80}\x1a\x8a\xd3\x0e\x02\b\x02\x12l\n" +
	"\x0eDeactivateUser\x12&.chalk.server.v1.DeactivateUserRequest\x1a'.chalk.server.v1.DeactivateUserResponse\"\t\x80}\b\x8a\xd3\x0e\x02\b\x02\x12l\n" +
	"\x0eReactivateUser\x12&.chalk.server.v1.ReactivateUserRequest\x1a'.chalk.server.v1.ReactivateUserResponse\"\t\x80}\a\x8a\xd3\x0e\x02\b\x02B\xb9\x01\n" +
...
var file_chalk_server_v1_team_proto_msgTypes = make([]protoimpl.MessageInfo, 62)
var file_chalk_server_v1_team_proto_goTypes = []any{
	...
	(*DeactivateUserRequest)(nil),            // 54: chalk.server.v1.DeactivateUserRequest
	(*DeactivateUserResponse)(nil),           // 55: chalk.server.v1.DeactivateUserResponse
	(*ReactivateUserRequest)(nil),            // 56: chalk.server.v1.ReactivateUserRequest
	(*ReactivateUserResponse)(nil),           // 57: chalk.server.v1.ReactivateUserResponse
	nil,                                      // 58: chalk.server.v1.Team.SpecConfigJsonEntry
	nil,                                      // 59: chalk.server.v1.UpdateEnvironmentOperation.AdditionalEnvVarsEntry
	nil,                                      // 60: chalk.server.v1.CreateServiceTokenRequest.FeatureTagToPermissionEntry
	nil,                                      // 61: chalk.server.v1.UpdateServiceTokenRequest.FeatureTagToPermissionEntry
	(*Environment)(nil),                      // 62: chalk.server.v1.Environment
	(*v1.Agent)(nil),                         // 63: chalk.auth.v1.Agent
	(*v1.DisplayAgent)(nil),                  // 64: chalk.auth.v1.DisplayAgent
	(*fieldmaskpb.FieldMask)(nil),            // 65: google.protobuf.FieldMask
	(v1.Permission)(0),                       // 66: chalk.auth.v1.Permission
	(*v1.CustomClaim)(nil),                   // 67: chalk.auth.v1.CustomClaim
	(v1.FeaturePermission)(0),                // 68: chalk.auth.v1.FeaturePermission
	(*v1.ServiceTokenAgent)(nil),             // 69: chalk.auth.v1.ServiceTokenAgent
	(*v1.FeaturePermissions)(nil),            // 70: chalk.auth.v1.FeaturePermissions
	(*v1.DisplayServiceTokenAgent)(nil),      // 71: chalk.auth.v1.DisplayServiceTokenAgent
	(*timestamppb.Timestamp)(nil),            // 72: google.protobuf.Timestamp
	(*structpb.Value)(nil),                   // 73: google.protobuf.Value
}
var file_chalk_server_v1_team_proto_depIdxs = []int32{
	62, // 0: chalk.server.v1.GetEnvResponse.environment:type_name -> chalk.server.v1.Environment
	62, // 1: chalk.server.v1.GetEnvironmentsResponse.environments:type_name -> chalk.server.v1.Environment
	63, // 2: chalk.server.v1.GetAgentResponse.agent:type_name -> chalk.auth.v1.Agent
	64, // 3: chalk.server.v1.GetDisplayAgentResponse.agent:type_name -> chalk.auth.v1.DisplayAgent
	9,  // 4: chalk.server.v1.Team.projects:type_name -> chalk.server.v1.Project
	58, // 5: chalk.server.v1.Team.spec_config_json:type_name -> chalk.server.v1.Team.SpecConfigJsonEntry
	62, // 6: chalk.server.v1.Project.environments:type_name -> chalk.server.v1.Environment
	...
	62, // 9: chalk.server.v1.CreateEnvironmentResponse.environment:type_name -> chalk.server.v1.Environment
	59, // 10: chalk.server.v1.UpdateEnvironmentOperation.additional_env_vars:type_name -> chalk.server.v1.UpdateEnvironmentOperation.AdditionalEnvVarsEntry
	16, // 11: chalk.server.v1.UpdateEnvironmentRequest.update:type_name -> chalk.server.v1.UpdateEnvironmentOperation
	65, // 12: chalk.server.v1.UpdateEnvironmentRequest.update_mask:type_name -> google.protobuf.FieldMask
	62, // 13: chalk.server.v1.UpdateEnvironmentResponse.environment:type_name -> chalk.server.v1.Environment
	8,  // 14: chalk.server.v1.GetTeamResponse.team:type_name -> chalk.server.v1.Team
	66, // 15: chalk.server.v1.CreateServiceTokenRequest.permissions:type_name -> chalk.auth.v1.Permission
	67, // 16: chalk.server.v1.CreateServiceTokenRequest.customer_claims:type_name -> chalk.auth.v1.CustomClaim
	60, // 17: chalk.server.v1.CreateServiceTokenRequest.feature_tag_to_permission:type_name -> chalk.server.v1.CreateServiceTokenRequest.FeatureTagToPermissionEntry
	68, // 18: chalk.server.v1.CreateServiceTokenRequest.default_permission:type_name -> chalk.auth.v1.FeaturePermission
	66, // 19: chalk.server.v1.CreateServiceTokenRequest.team_permissions:type_name -> chalk.auth.v1.Permission
	69, // 20: chalk.server.v1.CreateServiceTokenResponse.agent:type_name -> chalk.auth.v1.ServiceTokenAgent
	66, // 21: chalk.server.v1.PermissionDescription.id:type_name -> chalk.auth.v1.Permission
	66, // 22: chalk.server.v1.RoleDescription.permissions:type_name -> chalk.auth.v1.Permission
	70, // 23: chalk.server.v1.RoleDescription.feature_permissions:type_name -> chalk.auth.v1.FeaturePermissions
	25, // 24: chalk.server.v1.GetAvailablePermissionsResponse.permissions:type_name -> chalk.server.v1.PermissionDescription
	26, // 25: chalk.server.v1.GetAvailablePermissionsResponse.roles:type_name -> chalk.server.v1.RoleDescription
	66, // 26: chalk.server.v1.GetAvailablePermissionsResponse.available_service_token_permissions:type_name -> chalk.auth.v1.Permission
	70, // 27: chalk.server.v1.UpsertFeaturePermissionsRequest.permissions:type_name -> chalk.auth.v1.FeaturePermissions
	70, // 28: chalk.server.v1.UpsertFeaturePermissionsResponse.permissions:type_name -> chalk.auth.v1.FeaturePermissions
	71, // 29: chalk.server.v1.ListServiceTokensResponse.agents:type_name -> chalk.auth.v1.DisplayServiceTokenAgent
	66, // 30: chalk.server.v1.UpdateServiceTokenRequest.permissions:type_name -> chalk.auth.v1.Permission
	67, // 31: chalk.server.v1.UpdateServiceTokenRequest.customer_claims:type_name -> chalk.auth.v1.CustomClaim
	61, // 32: chalk.server.v1.UpdateServiceTokenRequest.feature_tag_to_permission:type_name -> chalk.server.v1.UpdateServiceTokenRequest.FeatureTagToPermissionEntry
	68, // 33: chalk.server.v1.UpdateServiceTokenRequest.default_permission:type_name -> chalk.auth.v1.FeaturePermission
	66, // 34: chalk.server.v1.UpdateServiceTokenRequest.team_permissions:type_name -> chalk.auth.v1.Permission
	71, // 35: chalk.server.v1.UpdateServiceTokenResponse.agent:type_name -> chalk.auth.v1.DisplayServiceTokenAgent
	72, // 36: chalk.server.v1.TeamInvite.created_at:type_name -> google.protobuf.Timestamp
	41, // 37: chalk.server.v1.ListTeamInvitesResponse.invites:type_name -> chalk.server.v1.TeamInvite
	46, // 38: chalk.server.v1.UserPermissions.user_roles:type_name -> chalk.server.v1.UserRoleAssignment
	66, // 39: chalk.server.v1.UserPermissions.user_permissions:type_name -> chalk.auth.v1.Permission
	72, // 40: chalk.server.v1.User.deactivated_at:type_name -> google.protobuf.Timestamp
	45, // 41: chalk.server.v1.EnvironmentPermissions.scim_roles:type_name -> chalk.server.v1.ScimGroupRoleAssignment
	47, // 42: chalk.server.v1.EnvironmentPermissions.user_permissions:type_name -> chalk.server.v1.UserPermissions
	26, // 43: chalk.server.v1.GetTeamPermissionsResponse.roles:type_name -> chalk.server.v1.RoleDescription
	44, // 44: chalk.server.v1.GetTeamPermissionsResponse.scim_groups:type_name -> chalk.server.v1.ScimGroup
	49, // 45: chalk.server.v1.GetTeamPermissionsResponse.environment_permissions:type_name -> chalk.server.v1.EnvironmentPermissions
	48, // 46: chalk.server.v1.GetTeamPermissionsResponse.team_members:type_name -> chalk.server.v1.User
	73, // 47: chalk.server.v1.Team.SpecConfigJsonEntry.value:type_name -> google.protobuf.Value
	68, // 48: chalk.server.v1.CreateServiceTokenRequest.FeatureTagToPermissionEntry.value:type_name -> chalk.auth.v1.FeaturePermission
	68, // 49: chalk.server.v1.UpdateServiceTokenRequest.FeatureTagToPermissionEntry.value:type_name -> chalk.auth.v1.FeaturePermission
	0,  // 50: chalk.server.v1.TeamService.GetEnv:input_type -> chalk.server.v1.GetEnvRequest
	2,  // 51: chalk.server.v1.TeamService.GetEnvironments:input_type -> chalk.server.v1.GetEnvironmentsRequest
	4,  // 52: chalk.server.v1.TeamService.GetAgent:input_type -> chalk.server.v1.GetAgentRequest
	6,  // 53: chalk.server.v1.TeamService.GetDisplayAgent:input_type -> chalk.server.v1.GetDisplayAgentRequest
	19, // 54: chalk.server.v1.TeamService.GetTeam:input_type -> chalk.server.v1.GetTeamRequest
	10, // 55: chalk.server.v1.TeamService.CreateTeam:input_type -> chalk.server.v1.CreateTeamRequest
	12, // 56: chalk.server.v1.TeamService.CreateProject:input_type -> chalk.server.v1.CreateProjectRequest
	14, // 57: chalk.server.v1.TeamService.CreateEnvironment:input_type -> chalk.server.v1.CreateEnvironmentRequest
	17, // 58: chalk.server.v1.TeamService.UpdateEnvironment:input_type -> chalk.server.v1.UpdateEnvironmentRequest
	27, // 59: chalk.server.v1.TeamService.GetAvailablePermissions:input_type -> chalk.server.v1.GetAvailablePermissionsRequest
	21, // 60: chalk.server.v1.TeamService.CreateServiceToken:input_type -> chalk.server.v1.CreateServiceTokenRequest
	23, // 61: chalk.server.v1.TeamService.DeleteServiceToken:input_type -> chalk.server.v1.DeleteServiceTokenRequest
	31, // 62: chalk.server.v1.TeamService.ListServiceTokens:input_type -> chalk.server.v1.ListServiceTokensRequest
	33, // 63: chalk.server.v1.TeamService.UpdateServiceToken:input_type -> chalk.server.v1.UpdateServiceTokenRequest
	37, // 64: chalk.server.v1.TeamService.InviteTeamMember:input_type -> chalk.server.v1.InviteTeamMemberRequest
	39, // 65: chalk.server.v1.TeamService.ExpireTeamInvite:input_type -> chalk.server.v1.ExpireTeamInviteRequest
	42, // 66: chalk.server.v1.TeamService.ListTeamInvites:input_type -> chalk.server.v1.ListTeamInvitesRequest
	29, // 67: chalk.server.v1.TeamService.UpsertFeaturePermissions:input_type -> chalk.server.v1.UpsertFeaturePermissionsRequest
	35, // 68: chalk.server.v1.TeamService.UpdateScimGroupSettings:input_type -> chalk.server.v1.UpdateScimGroupSettingsRequest
	50, // 69: chalk.server.v1.TeamService.GetTeamPermissions:input_type -> chalk.server.v1.GetTeamPermissionsRequest
	52, // 70: chalk.server.v1.TeamService.ArchiveEnvironment:input_type -> chalk.server.v1.ArchiveEnvironmentRequest
	54, // 71: chalk.server.v1.TeamService.DeactivateUser:input_type -> chalk.server.v1.DeactivateUserRequest
	56, // 72: chalk.server.v1.TeamService.ReactivateUser:input_type -> chalk.server.v1.ReactivateUserRequest
	1,  // 73: chalk.server.v1.TeamService.GetEnv:output_type -> chalk.server.v1.GetEnvResponse
	3,  // 74: chalk.server.v1.TeamService.GetEnvironments:output_type -> chalk.server.v1.GetEnvironmentsResponse
	5,  // 75: chalk.server.v1.TeamService.GetAgent:output_type -> chalk.server.v1.GetAgentResponse
	7,  // 76: chalk.server.v1.TeamService.GetDisplayAgent:output_type -> chalk.server.v1.GetDisplayAgentResponse
	20, // 77: chalk.server.v1.TeamService.GetTeam:output_type -> chalk.server.v1.GetTeamResponse
	11, // 78: chalk.server.v1.TeamService.CreateTeam:output_type -> chalk.server.v1.CreateTeamResponse
	13, // 79: chalk.server.v1.TeamService.CreateProject:output_type -> chalk.server.v1.CreateProjectResponse
	15, // 80: chalk.server.v1.TeamService.CreateEnvironment:output_type -> chalk.server.v1.CreateEnvironmentResponse
	18, // 81: chalk.server.v1.TeamService.UpdateEnvironment:output_type -> chalk.server.v1.UpdateEnvironmentResponse
	28, // 82: chalk.server.v1.TeamService.GetAvailablePermissions:output_type -> chalk.server.v1.GetAvailablePermissionsResponse
	22, // 83: chalk.server.v1.TeamService.CreateServiceToken:output_type -> chalk.server.v1.CreateServiceTokenResponse
	24, // 84: chalk.server.v1.TeamService.DeleteServiceToken:output_type -> chalk.server.v1.DeleteServiceTokenResponse
	32, // 85: chalk.server.v1.TeamService.ListServiceTokens:output_type -> chalk.server.v1.ListServiceTokensResponse
	34, // 86: chalk.server.v1.TeamService.UpdateServiceToken:output_type -> chalk.server.v1.UpdateServiceTokenResponse
	38, // 87: chalk.server.v1.TeamService.InviteTeamMember:output_type -> chalk.server.v1.InviteTeamMemberResponse
	40, // 88: chalk.server.v1.TeamService.ExpireTeamInvite:output_type -> chalk.server.v1.ExpireTeamInviteResponse
	43, // 89: chalk.server.v1.TeamService.ListTeamInvites:output_type -> chalk.server.v1.ListTeamInvitesResponse
	30, // 90: chalk.server.v1.TeamService.UpsertFeaturePermissions:output_type -> chalk.server.v1.UpsertFeaturePermissionsResponse
	36, // 91: chalk.server.v1.TeamService.UpdateScimGroupSettings:output_type -> chalk.server.v1.UpdateScimGroupSettingsResponse
	51, // 92: chalk.server.v1.TeamService.GetTeamPermissions:output_type -> chalk.server.v1.GetTeamPermissionsResponse
	53, // 93: chalk.server.v1.TeamService.ArchiveEnvironment:output_type -> chalk.server.v1.ArchiveEnvironmentResponse
	55, // 94: chalk.server.v1.TeamService.DeactivateUser:output_type -> chalk.server.v1.DeactivateUserResponse
	57, // 95: chalk.server.v1.TeamService.ReactivateUser:output_type -> chalk.server.v1.ReactivateUserResponse
