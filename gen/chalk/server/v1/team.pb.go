...
var file_chalk_server_v1_team_proto_rawDesc = []byte{
	...
	0x73, 0x69, 0x6f, 0x6e, 0x73, 0x32, 0x93, 0x0a, 0x0a, 0x0b, 0x54, 0x65, 0x61, 0x6d, 0x53, 0x65,
	...
	0x90, 0x02, 0x01, 0x12, 0x5a, 0x0a, 0x0a, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x65, 0x61,
	...
	0x61, 0x6d, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x03, 0x80, 0x7d, 0x1a, 0x12,
	...
	0x03, 0x80, 0x7d, 0x1a, 0x12, 0x6f, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x45, 0x6e,
	...
	0x22, 0x03, 0x80, 0x7d, 0x1a, 0x12, 0x72, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x53,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x03, 0x80, 0x7d, 0x15, 0x12, 0x84, 0x01, 0x0a, 0x17, 0x47, 0x65,
	0x74, 0x41, 0x76, 0x61, 0x69, 0x6c, 0x61, 0x62, 0x6c, 0x65, 0x50, 0x65, 0x72, 0x6d, 0x69, 0x73,
	0x73, 0x69, 0x6f, 0x6e, 0x73, 0x12, 0x2f, 0x2e, 0x63, 0x68, 0x61, 0x6c, 0x6b, 0x2e, 0x73, 0x65,
	...
	0x12, 0x72, 0x0a, 0x12, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
...
var file_chalk_server_v1_team_proto_msgTypes = make([]protoimpl.MessageInfo, 29)
var file_chalk_server_v1_team_proto_goTypes = []interface{}{
	...
	nil,                                      // 28: chalk.server.v1.CreateServiceTokenRequest.FeatureTagToPermissionEntry
	(*Environment)(nil),                      // 29: chalk.server.v1.Environment
	(*v1.Agent)(nil),                         // 30: chalk.auth.v1.Agent
	(*v1.DisplayAgent)(nil),                  // 31: chalk.auth.v1.DisplayAgent
	(v1.Permission)(0),                       // 32: chalk.auth.v1.Permission
	(*v1.CustomClaim)(nil),                   // 33: chalk.auth.v1.CustomClaim
	(*v1.ServiceTokenAgent)(nil),             // 34: chalk.auth.v1.ServiceTokenAgent
	(*v1.FeaturePermissions)(nil),            // 35: chalk.auth.v1.FeaturePermissions
	(v1.FeaturePermission)(0),                // 36: chalk.auth.v1.FeaturePermission
}
var file_chalk_server_v1_team_proto_depIdxs = []int32{
	29, // 0: chalk.server.v1.GetEnvResponse.environment:type_name -> chalk.server.v1.Environment
	29, // 1: chalk.server.v1.GetEnvironmentsResponse.environments:type_name -> chalk.server.v1.Environment
	30, // 2: chalk.server.v1.GetAgentResponse.agent:type_name -> chalk.auth.v1.Agent
	31, // 3: chalk.server.v1.GetDisplayAgentResponse.agent:type_name -> chalk.auth.v1.DisplayAgent
	9,  // 4: chalk.server.v1.Team.projects:type_name -> chalk.server.v1.Project
	29, // 5: chalk.server.v1.Project.environments:type_name -> chalk.server.v1.Environment
	...
	29, // 8: chalk.server.v1.CreateEnvironmentResponse.environment:type_name -> chalk.server.v1.Environment
	8,  // 9: chalk.server.v1.GetTeamResponse.team:type_name -> chalk.server.v1.Team
	32, // 10: chalk.server.v1.CreateServiceTokenRequest.permissions:type_name -> chalk.auth.v1.Permission
	33, // 11: chalk.server.v1.CreateServiceTokenRequest.customer_claims:type_name -> chalk.auth.v1.CustomClaim
	28, // 12: chalk.server.v1.CreateServiceTokenRequest.feature_tag_to_permission:type_name -> chalk.server.v1.CreateServiceTokenRequest.FeatureTagToPermissionEntry
	34, // 13: chalk.server.v1.CreateServiceTokenResponse.agent:type_name -> chalk.auth.v1.ServiceTokenAgent
	32, // 14: chalk.server.v1.PermissionDescription.id:type_name -> chalk.auth.v1.Permission
	32, // 15: chalk.server.v1.RoleDescription.permissions:type_name -> chalk.auth.v1.Permission
	35, // 16: chalk.server.v1.RoleDescription.feature_permissions:type_name -> chalk.auth.v1.FeaturePermissions
	...
	35, // 19: chalk.server.v1.UpsertFeaturePermissionsRequest.permissions:type_name -> chalk.auth.v1.FeaturePermissions
	35, // 20: chalk.server.v1.UpsertFeaturePermissionsResponse.permissions:type_name -> chalk.auth.v1.FeaturePermissions
	36, // 21: chalk.server.v1.CreateServiceTokenRequest.FeatureTagToPermissionEntry.value:type_name -> chalk.auth.v1.FeaturePermission
	0,  // 22: chalk.server.v1.TeamService.GetEnv:input_type -> chalk.server.v1.GetEnvRequest
	2,  // 23: chalk.server.v1.TeamService.GetEnvironments:input_type -> chalk.server.v1.GetEnvironmentsRequest
	4,  // 24: chalk.server.v1.TeamService.GetAgent:input_type -> chalk.server.v1.GetAgentRequest
	6,  // 25: chalk.server.v1.TeamService.GetDisplayAgent:input_type -> chalk.server.v1.GetDisplayAgentRequest
	16, // 26: chalk.server.v1.TeamService.GetTeam:input_type -> chalk.server.v1.GetTeamRequest
	10, // 27: chalk.server.v1.TeamService.CreateTeam:input_type -> chalk.server.v1.CreateTeamRequest
	12, // 28: chalk.server.v1.TeamService.CreateProject:input_type -> chalk.server.v1.CreateProjectRequest
	14, // 29: chalk.server.v1.TeamService.CreateEnvironment:input_type -> chalk.server.v1.CreateEnvironmentRequest
	18, // 30: chalk.server.v1.TeamService.CreateServiceToken:input_type -> chalk.server.v1.CreateServiceTokenRequest
	24, // 31: chalk.server.v1.TeamService.GetAvailablePermissions:input_type -> chalk.server.v1.GetAvailablePermissionsRequest
	20, // 32: chalk.server.v1.TeamService.DeleteServiceToken:input_type -> chalk.server.v1.DeleteServiceTokenRequest
	26, // 33: chalk.server.v1.TeamService.UpsertFeaturePermissions:input_type -> chalk.server.v1.UpsertFeaturePermissionsRequest
	1,  // 34: chalk.server.v1.TeamService.GetEnv:output_type -> chalk.server.v1.GetEnvResponse
	3,  // 35: chalk.server.v1.TeamService.GetEnvironments:output_type -> chalk.server.v1.GetEnvironmentsResponse
	5,  // 36: chalk.server.v1.TeamService.GetAgent:output_type -> chalk.server.v1.GetAgentResponse
	7,  // 37: chalk.server.v1.TeamService.GetDisplayAgent:output_type -> chalk.server.v1.GetDisplayAgentResponse
	17, // 38: chalk.server.v1.TeamService.GetTeam:output_type -> chalk.server.v1.GetTeamResponse
	11, // 39: chalk.server.v1.TeamService.CreateTeam:output_type -> chalk.server.v1.CreateTeamResponse
	13, // 40: chalk.server.v1.TeamService.CreateProject:output_type -> chalk.server.v1.CreateProjectResponse
	15, // 41: chalk.server.v1.TeamService.CreateEnvironment:output_type -> chalk.server.v1.CreateEnvironmentResponse
	19, // 42: chalk.server.v1.TeamService.CreateServiceToken:output_type -> chalk.server.v1.CreateServiceTokenResponse
	25, // 43: chalk.server.v1.TeamService.GetAvailablePermissions:output_type -> chalk.server.v1.GetAvailablePermissionsResponse
	21, // 44: chalk.server.v1.TeamService.DeleteServiceToken:output_type -> chalk.server.v1.DeleteServiceTokenResponse
	27, // 45: chalk.server.v1.TeamService.UpsertFeaturePermissions:output_type -> chalk.server.v1.UpsertFeaturePermissionsResponse
