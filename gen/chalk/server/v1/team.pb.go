...
var file_chalk_server_v1_team_proto_rawDesc = []byte{
	...
	0x0b, 0x74, 0x65, 0x61, 0x6d, 0x4d, 0x65, 0x6d, 0x62, 0x65, 0x72, 0x73, 0x32, 0x8b, 0x11, 0x0a,
	...
	0x1a, 0x8a, 0xd3, 0x0e, 0x02, 0x08, 0x02, 0x12, 0x75, 0x0a, 0x11, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x6e, 0x73, 0x65, 0x22, 0x09, 0x80, 0x7d, 0x1a, 0x8a, 0xd3, 0x0e, 0x02, 0x08, 0x02, 0x12, 0x84,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x03, 0x80, 0x7d, 0x02, 0x42, 0xb9, 0x01, 0x0a, 0x13, 0x63,
...
var file_chalk_server_v1_team_proto_msgTypes = make([]protoimpl.MessageInfo, 52)
var file_chalk_server_v1_team_proto_goTypes = []any{
	...
	nil,                                      // 49: chalk.server.v1.Team.SpecConfigJsonEntry
	nil,                                      // 50: chalk.server.v1.CreateServiceTokenRequest.FeatureTagToPermissionEntry
	nil,                                      // 51: chalk.server.v1.UpdateServiceTokenRequest.FeatureTagToPermissionEntry
	(*Environment)(nil),                      // 52: chalk.server.v1.Environment
	(*v1.Agent)(nil),                         // 53: chalk.auth.v1.Agent
	(*v1.DisplayAgent)(nil),                  // 54: chalk.auth.v1.DisplayAgent
	(v1.Permission)(0),                       // 55: chalk.auth.v1.Permission
	(*v1.CustomClaim)(nil),                   // 56: chalk.auth.v1.CustomClaim
	(*v1.ServiceTokenAgent)(nil),             // 57: chalk.auth.v1.ServiceTokenAgent
	(*v1.FeaturePermissions)(nil),            // 58: chalk.auth.v1.FeaturePermissions
	(*v1.DisplayServiceTokenAgent)(nil),      // 59: chalk.auth.v1.DisplayServiceTokenAgent
	(*timestamppb.Timestamp)(nil),            // 60: google.protobuf.Timestamp
	(*structpb.Value)(nil),                   // 61: google.protobuf.Value
	(v1.FeaturePermission)(0),                // 62: chalk.auth.v1.FeaturePermission
}
var file_chalk_server_v1_team_proto_depIdxs = []int32{
	52, // 0: chalk.server.v1.GetEnvResponse.environment:type_name -> chalk.server.v1.Environment
	52, // 1: chalk.server.v1.GetEnvironmentsResponse.environments:type_name -> chalk.server.v1.Environment
	53, // 2: chalk.server.v1.GetAgentResponse.agent:type_name -> chalk.auth.v1.Agent
	54, // 3: chalk.server.v1.GetDisplayAgentResponse.agent:type_name -> chalk.auth.v1.DisplayAgent
	9,  // 4: chalk.server.v1.Team.projects:type_name -> chalk.server.v1.Project
	49, // 5: chalk.server.v1.Team.spec_config_json:type_name -> chalk.server.v1.Team.SpecConfigJsonEntry
	52, // 6: chalk.server.v1.Project.environments:type_name -> chalk.server.v1.Environment
	...
	52, // 9: chalk.server.v1.CreateEnvironmentResponse.environment:type_name -> chalk.server.v1.Environment
	8,  // 10: chalk.server.v1.GetTeamResponse.team:type_name -> chalk.server.v1.Team
	55, // 11: chalk.server.v1.CreateServiceTokenRequest.permissions:type_name -> chalk.auth.v1.Permission
	56, // 12: chalk.server.v1.CreateServiceTokenRequest.customer_claims:type_name -> chalk.auth.v1.CustomClaim
	50, // 13: chalk.server.v1.CreateServiceTokenRequest.feature_tag_to_permission:type_name -> chalk.server.v1.CreateServiceTokenRequest.FeatureTagToPermissionEntry
	57, // 14: chalk.server.v1.CreateServiceTokenResponse.agent:type_name -> chalk.auth.v1.ServiceTokenAgent
	55, // 15: chalk.server.v1.PermissionDescription.id:type_name -> chalk.auth.v1.Permission
	55, // 16: chalk.server.v1.RoleDescription.permissions:type_name -> chalk.auth.v1.Permission
	58, // 17: chalk.server.v1.RoleDescription.feature_permissions:type_name -> chalk.auth.v1.FeaturePermissions
	...
	55, // 20: chalk.server.v1.GetAvailablePermissionsResponse.available_service_token_permissions:type_name -> chalk.auth.v1.Permission
	58, // 21: chalk.server.v1.UpsertFeaturePermissionsRequest.permissions:type_name -> chalk.auth.v1.FeaturePermissions
	58, // 22: chalk.server.v1.UpsertFeaturePermissionsResponse.permissions:type_name -> chalk.auth.v1.FeaturePermissions
	59, // 23: chalk.server.v1.ListServiceTokensResponse.agents:type_name -> chalk.auth.v1.DisplayServiceTokenAgent
	55, // 24: chalk.server.v1.UpdateServiceTokenRequest.permissions:type_name -> chalk.auth.v1.Permission
	56, // 25: chalk.server.v1.UpdateServiceTokenRequest.customer_claims:type_name -> chalk.auth.v1.CustomClaim
	51, // 26: chalk.server.v1.UpdateServiceTokenRequest.feature_tag_to_permission:type_name -> chalk.server.v1.UpdateServiceTokenRequest.FeatureTagToPermissionEntry
	59, // 27: chalk.server.v1.UpdateServiceTokenResponse.agent:type_name -> chalk.auth.v1.DisplayServiceTokenAgent
	60, // 28: chalk.server.v1.TeamInvite.created_at:type_name -> google.protobuf.Timestamp
	...
	55, // 31: chalk.server.v1.UserPermissions.user_permissions:type_name -> chalk.auth.v1.Permission
	60, // 32: chalk.server.v1.User.deactivated_at:type_name -> google.protobuf.Timestamp
	...
	61, // 39: chalk.server.v1.Team.SpecConfigJsonEntry.value:type_name -> google.protobuf.Value
	62, // 40: chalk.server.v1.CreateServiceTokenRequest.FeatureTagToPermissionEntry.value:type_name -> chalk.auth.v1.FeaturePermission
	62, // 41: chalk.server.v1.UpdateServiceTokenRequest.FeatureTagToPermissionEntry.value:type_name -> chalk.auth.v1.FeaturePermission
	...
	16, // 46: chalk.server.v1.TeamService.GetTeam:input_type -> chalk.server.v1.GetTeamRequest
	10, // 47: chalk.server.v1.TeamService.CreateTeam:input_type -> chalk.server.v1.CreateTeamRequest
	12, // 48: chalk.server.v1.TeamService.CreateProject:input_type -> chalk.server.v1.CreateProjectRequest
	14, // 49: chalk.server.v1.TeamService.CreateEnvironment:input_type -> chalk.server.v1.CreateEnvironmentRequest
	24, // 50: chalk.server.v1.TeamService.GetAvailablePermissions:input_type -> chalk.server.v1.GetAvailablePermissionsRequest
	18, // 51: chalk.server.v1.TeamService.CreateServiceToken:input_type -> chalk.server.v1.CreateServiceTokenRequest
	20, // 52: chalk.server.v1.TeamService.DeleteServiceToken:input_type -> chalk.server.v1.DeleteServiceTokenRequest
	28, // 53: chalk.server.v1.TeamService.ListServiceTokens:input_type -> chalk.server.v1.ListServiceTokensRequest
	30, // 54: chalk.server.v1.TeamService.UpdateServiceToken:input_type -> chalk.server.v1.UpdateServiceTokenRequest
	34, // 55: chalk.server.v1.TeamService.InviteTeamMember:input_type -> chalk.server.v1.InviteTeamMemberRequest
	36, // 56: chalk.server.v1.TeamService.ExpireTeamInvite:input_type -> chalk.server.v1.ExpireTeamInviteRequest
	39, // 57: chalk.server.v1.TeamService.ListTeamInvites:input_type -> chalk.server.v1.ListTeamInvitesRequest
	26, // 58: chalk.server.v1.TeamService.UpsertFeaturePermissions:input_type -> chalk.server.v1.UpsertFeaturePermissionsRequest
	32, // 59: chalk.server.v1.TeamService.UpdateScimGroupSettings:input_type -> chalk.server.v1.UpdateScimGroupSettingsRequest
	47, // 60: chalk.server.v1.TeamService.GetTeamPermissions:input_type -> chalk.server.v1.GetTeamPermissionsRequest
	1,  // 61: chalk.server.v1.TeamService.GetEnv:output_type -> chalk.server.v1.GetEnvResponse
	3,  // 62: chalk.server.v1.TeamService.GetEnvironments:output_type -> chalk.server.v1.GetEnvironmentsResponse
	5,  // 63: chalk.server.v1.TeamService.GetAgent:output_type -> chalk.server.v1.GetAgentResponse
	7,  // 64: chalk.server.v1.TeamService.GetDisplayAgent:output_type -> chalk.server.v1.GetDisplayAgentResponse
	17, // 65: chalk.server.v1.TeamService.GetTeam:output_type -> chalk.server.v1.GetTeamResponse
	11, // 66: chalk.server.v1.TeamService.CreateTeam:output_type -> chalk.server.v1.CreateTeamResponse
	13, // 67: chalk.server.v1.TeamService.CreateProject:output_type -> chalk.server.v1.CreateProjectResponse
	15, // 68: chalk.server.v1.TeamService.CreateEnvironment:output_type -> chalk.server.v1.CreateEnvironmentResponse
	25, // 69: chalk.server.v1.TeamService.GetAvailablePermissions:output_type -> chalk.server.v1.GetAvailablePermissionsResponse
	19, // 70: chalk.server.v1.TeamService.CreateServiceToken:output_type -> chalk.server.v1.CreateServiceTokenResponse
	21, // 71: chalk.server.v1.TeamService.DeleteServiceToken:output_type -> chalk.server.v1.DeleteServiceTokenResponse
	29, // 72: chalk.server.v1.TeamService.ListServiceTokens:output_type -> chalk.server.v1.ListServiceTokensResponse
	31, // 73: chalk.server.v1.TeamService.UpdateServiceToken:output_type -> chalk.server.v1.UpdateServiceTokenResponse
	35, // 74: chalk.server.v1.TeamService.InviteTeamMember:output_type -> chalk.server.v1.InviteTeamMemberResponse
	37, // 75: chalk.server.v1.TeamService.ExpireTeamInvite:output_type -> chalk.server.v1.ExpireTeamInviteResponse
	40, // 76: chalk.server.v1.TeamService.ListTeamInvites:output_type -> chalk.server.v1.ListTeamInvitesResponse
	27, // 77: chalk.server.v1.TeamService.UpsertFeaturePermissions:output_type -> chalk.server.v1.UpsertFeaturePermissionsResponse
	33, // 78: chalk.server.v1.TeamService.UpdateScimGroupSettings:output_type -> chalk.server.v1.UpdateScimGroupSettingsResponse
	48, // 79: chalk.server.v1.TeamService.GetTeamPermissions:output_type -> chalk.server.v1.GetTeamPermissionsResponse
