...
func (x *ShardPerformanceSummary) GetShardId() int32 {
	if x != nil {
		return x.ShardId
	}
	return 0
...
type ListOfflineQueryShardPerformanceSummariesPageToken struct {
	...
	ShardIdHwm int32 `protobuf:"varint,2,opt,name=shard_id_hwm,json=shardIdHwm,proto3" json:"shard_id_hwm,omitempty"`
}
...
func (x *ListOfflineQueryShardPerformanceSummariesPageToken) GetShardIdHwm() int32 {
	if x != nil {
		return x.ShardIdHwm
	}
	return 0
...
func (x *ListOfflineQueryShardPerformanceSummariesRequest) GetLimit() int32 {
	if x != nil {
		return x.Limit
	}
	return 0
...
var file_chalk_server_v1_performance_summary_proto_rawDesc = []byte{
	...
	0x64, 0x5f, 0x68, 0x77, 0x6d, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0a, 0x73, 0x68, 0x61,
