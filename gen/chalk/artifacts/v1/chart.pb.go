...
const file_chalk_artifacts_v1_chart_proto_rawDesc = "" +
	"\n" +
	"\x1echalk/artifacts/v1/chart.proto\x12\x12chalk.artifacts.v1\"\x86\x03\n" +
	...
	"\bgroup_by\x18\x05 \x03(\x0e2\x1f.chalk.artifacts.v1.GroupByKindR\agroupByB\a\n" +
	"\x05_name\"\xab\x02\n" +
	...
	"\x0fgraph_generated\x18\x06 \x01(\bR\x0egraphGenerated\"\xee\x01\n" +
	"\x05Chart\x12\x0e\n" +
	...
	"+METRIC_KIND_FEATURE_INTERMEDIATE_NULL_RATIO\x10**\xa3\x04\n" +
	"\n" +
	"FilterKind\x12\x1b\n" +
	...
	"\x14FILTER_KIND_POD_NAME\x10\x11*~\n" +
	...
	"$WINDOW_FUNCTION_KIND_ALL_PERCENTILES\x10\f*\xe7\x03\n" +
