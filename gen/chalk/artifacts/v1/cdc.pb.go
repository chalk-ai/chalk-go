...
var file_chalk_artifacts_v1_cdc_proto_goTypes = []interface{}{
...
func file_chalk_artifacts_v1_cdc_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chalk_artifacts_v1_cdc_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CDCTableReference); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_chalk_artifacts_v1_cdc_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CDCSource); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
