...
var file_chalk_artifacts_v1_deployment_proto_goTypes = []interface{}{
...
func file_chalk_artifacts_v1_deployment_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chalk_artifacts_v1_deployment_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
