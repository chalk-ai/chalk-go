...
type DatasetSampleFilter struct {
	...
	// Types that are valid to be assigned to LowerBoundFilter:
	//
	...
	// Types that are valid to be assigned to UpperBoundFilter:
	//
...
func (x *DatasetSampleFilter) GetLowerBoundFilter() isDatasetSampleFilter_LowerBoundFilter {
	if x != nil {
		return x.LowerBoundFilter
	}
	return nil
}
...
func (x *DatasetSampleFilter) GetLowerBound() *timestamppb.Timestamp {
	if x != nil {
		if x, ok := x.LowerBoundFilter.(*DatasetSampleFilter_LowerBound); ok {
			return x.LowerBound
		}
	}
	return nil
...
func (x *DatasetSampleFilter) GetLowerBoundDelta() *durationpb.Duration {
	if x != nil {
		if x, ok := x.LowerBoundFilter.(*DatasetSampleFilter_LowerBoundDelta); ok {
...
func (x *DatasetSampleFilter) GetUpperBoundFilter() isDatasetSampleFilter_UpperBoundFilter {
	if x != nil {
		return x.UpperBoundFilter
	}
	return nil
}
...
func (x *DatasetSampleFilter) GetUpperBound() *timestamppb.Timestamp {
	if x != nil {
		if x, ok := x.UpperBoundFilter.(*DatasetSampleFilter_UpperBound); ok {
			return x.UpperBound
		}
	}
	return nil
...
func (x *DatasetSampleFilter) GetUpperBoundDelta() *durationpb.Duration {
	if x != nil {
		if x, ok := x.UpperBoundFilter.(*DatasetSampleFilter_UpperBoundDelta); ok {
...
const file_chalk_common_v1_dataset_response_proto_rawDesc = "" +
	"\n" +
	"&chalk/common/v1/dataset_response.proto\x12\x0fchalk.common.v1\x1a!chalk/common/v1/chalk_error.proto\x1a\"chalk/common/v1/query_status.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"\x87\x03\n" +
	"\x13DatasetSampleFilter\x12=\n" +
	"\vlower_bound\x18\x01 \x01(\v2\x1a.google.protobuf.TimestampH\x00R\n" +
	"lowerBound\x12G\n" +
	"\x11lower_bound_delta\x18\x04 \x01(\v2\x19.google.protobuf.DurationH\x00R\x0flowerBoundDelta\x12=\n" +
	"\vupper_bound\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampH\x01R\n" +
	"upperBound\x12G\n" +
	"\x11upper_bound_delta\x18\x05 \x01(\v2\x19.google.protobuf.DurationH\x01R\x0fupperBoundDelta\x12$\n" +
	"\vmax_samples\x18\x03 \x01(\x05H\x02R\n" +
	"maxSamples\x88\x01\x01B\x14\n" +
	"\x12lower_bound_filterB\x14\n" +
	"\x12upper_bound_filterB\x0e\n" +
	...
	"\rdashboard_url\x18\x0f \x01(\tH\aR\fdashboardUrl\x88\x01\x01\x12\x1e\n" +
	"\bnum_rows\x18\x10 \x01(\x03H\bR\anumRows\x88\x01\x01\x12>\n" +
	"\n" +
	"created_at\x18e \x01(\v2\x1a.google.protobuf.TimestampH\tR\tcreatedAt\x88\x01\x01\x12>\n" +
	"\n" +
	"started_at\x18f \x01(\v2\x1a.google.protobuf.TimestampH\n" +
	"R\tstartedAt\x88\x01\x01\x12D\n" +
	"\rterminated_at\x18g \x01(\v2\x1a.google.protobuf.TimestampH\vR\fterminatedAt\x88\x01\x01B\x0f\n" +
	"\r_dataset_nameB\r\n" +
	"\v_dataset_idB\x11\n" +
