...
type OnlineQueryContext struct {
	...
	QueryContext              map[string]*structpb.Value `protobuf:"bytes,11,rep,name=query_context,json=queryContext,proto3" json:"query_context,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"` // Query context is a dictionary of JSON-serializable values that can be used in resolvers
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
