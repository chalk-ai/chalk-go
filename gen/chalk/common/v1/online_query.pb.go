...
func (x *OnlineQueryBulkRequest) GetInputs() isOnlineQueryBulkRequest_Inputs {
	if x != nil {
		return x.Inputs
	}
	return nil
...
func (x *OnlineQueryBulkRequest) GetInputsFeather() []byte {
	if x != nil {
		if x, ok := x.Inputs.(*OnlineQueryBulkRequest_InputsFeather); ok {
...
func (x *OnlineQueryBulkRequest) GetInputsSql() string {
	if x != nil {
		if x, ok := x.Inputs.(*OnlineQueryBulkRequest_InputsSql); ok {
			return x.InputsSql
		}
	}
	return ""
...
const file_chalk_common_v1_online_query_proto_rawDesc = "" +
	...
	"\x0einputs_feather\x18\x01 \x01(\fH\x00R\rinputsFeather\x12\x1f\n" +
	"\n" +
	"inputs_sql\x18\b \x01(\tH\x00R\tinputsSql\x125\n" +
