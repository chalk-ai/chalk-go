...
const file_chalk_common_v2_execute_plan_proto_rawDesc = "" +
	"\n" +
	"\"chalk/common/v2/execute_plan.proto\x12\x0fchalk.common.v2\x1a!chalk/common/v1/chalk_error.proto\x1a\x1echalk/common/v2/metadata.proto\x1a\x1dchalk/common/v2/options.proto\x1a\x1bchalk/common/v2/table.proto\x1a$chalk/expression/v1/expression.proto\"\xdf\x03\n" +
	"\x12ExecutePlanRequest\x12P\n" +
	"\x10lazy_frame_calls\x18\x01 \x01(\v2$.chalk.expression.v1.LogicalExprNodeH\x00R\x0elazyFrameCalls\x12G\n" +
