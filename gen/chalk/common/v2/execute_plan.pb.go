...
type ExecutePlanRequest struct {
	...
	Tables           map[string]*Table            `protobuf:"bytes,2,rep,name=tables,proto3" json:"tables,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
func (x *ExecutePlanRequest) GetDataFramePlan() *v11.DataFramePlan {
	if x != nil {
		if x, ok := x.Payload.(*ExecutePlanRequest_DataFramePlan); ok {
...
const file_chalk_common_v2_execute_plan_proto_rawDesc = "" +
	"\n" +
	"\"chalk/common/v2/execute_plan.proto\x12\x0fchalk.common.v2\x1a!chalk/common/v1/chalk_error.proto\x1a\x1echalk/common/v2/metadata.proto\x1a\x1dchalk/common/v2/options.proto\x1a\x1bchalk/common/v2/table.proto\x1a\"chalk/dataframe/v1/dataframe.proto\x1a$chalk/expression/v1/expression.proto\"\xac\x04\n" +
	"\x12ExecutePlanRequest\x12P\n" +
	"\x10lazy_frame_calls\x18\x01 \x01(\v2$.chalk.expression.v1.LogicalExprNodeH\x00R\x0elazyFrameCalls\x12K\n" +
	"\x0fdata_frame_plan\x18\x03 \x01(\v2!.chalk.dataframe.v1.DataFramePlanH\x00R\rdataFramePlan\x12G\n" +
	"\x06tables\x18\x02 \x03(\v2/.chalk.common.v2.ExecutePlanRequest.TablesEntryR\x06tables\x12S\n" +
	"\x11execution_options\x18\n" +
	" \x01(\v2!.chalk.common.v2.ExecutionOptionsH\x01R\x10executionOptions\x88\x01\x01\x12P\n" +
	"\x10planning_options\x18\v \x01(\v2 .chalk.common.v2.PlanningOptionsH\x02R\x0fplanningOptions\x88\x01\x01\x1aQ\n" +
