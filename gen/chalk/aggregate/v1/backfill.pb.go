...
func (x *CronAggregateBackfill) GetTarget() AggregateBackfillTarget {
	if x != nil {
		return x.Target
	}
...
const file_chalk_aggregate_v1_backfill_proto_rawDesc = "" +
	...
	"\bschedule\x18\x04 \x01(\tR\bschedule\x12\x1f\n" +
	"\bfilename\x18\f \x01(\tH\x00R\bfilename\x88\x01\x01\x12\x1b\n" +
