...
type PlanAggregateBackfillResponse struct {
	...
	Backfill *AggregateBackfill           `protobuf:"bytes,5,opt,name=backfill,proto3" json:"backfill,omitempty"`
...
func (x *PlanAggregateBackfillResponse) GetBackfill() *AggregateBackfill {
	if x != nil {
		return x.Backfill
	}
	return nil
...
var file_chalk_aggregate_v1_service_proto_rawDesc = []byte{
	...
	0x61, 0x6d, 0x73, 0x22, 0xcf, 0x02, 0x0a, 0x1d, 0x50, 0x6c, 0x61, 0x6e, 0x41, 0x67, 0x67, 0x72,
	...
	0x6d, 0x73, 0x52, 0x06, 0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x12, 0x41, 0x0a, 0x08, 0x62, 0x61,
	0x63, 0x6b, 0x66, 0x69, 0x6c, 0x6c, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x25, 0x2e, 0x63,
	...
	0x69, 0x6c, 0x6c, 0x52, 0x08, 0x62, 0x61, 0x63, 0x6b, 0x66, 0x69, 0x6c, 0x6c, 0x12, 0x16, 0x0a,
	0x06, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x06, 0x65,
	0x72, 0x72, 0x6f, 0x72, 0x73, 0x22, 0x39, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x41, 0x67, 0x67, 0x72,
	...
	0x72, 0x73, 0x32, 0x93, 0x02, 0x0a, 0x10, 0x41, 0x67, 0x67, 0x72, 0x65, 0x67, 0x61, 0x74, 0x65,
	...
	0xd3, 0x0e, 0x02, 0x08, 0x02, 0x90, 0x02, 0x01, 0x42, 0xd1, 0x01, 0x0a, 0x16, 0x63, 0x6f, 0x6d,
...
var file_chalk_aggregate_v1_service_proto_goTypes = []any{
	...
	(*AggregateBackfill)(nil),             // 7: chalk.aggregate.v1.AggregateBackfill
}
var file_chalk_aggregate_v1_service_proto_depIdxs = []int32{
	...
	7, // 4: chalk.aggregate.v1.PlanAggregateBackfillResponse.backfill:type_name -> chalk.aggregate.v1.AggregateBackfill
	5, // 5: chalk.aggregate.v1.GetAggregatesResponse.series:type_name -> chalk.aggregate.v1.AggregateTimeSeries
	...
	1, // 8: chalk.aggregate.v1.AggregateService.PlanAggregateBackfill:output_type -> chalk.aggregate.v1.PlanAggregateBackfillResponse
	3, // 9: chalk.aggregate.v1.AggregateService.GetAggregates:output_type -> chalk.aggregate.v1.GetAggregatesResponse
