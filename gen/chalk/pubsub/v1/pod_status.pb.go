...
type PodStatusPubSub_ResourceRequirements struct {
	...
	// More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
	// +optional
	Limits map[string]*PodStatusPubSub_Quantity `protobuf:"bytes,1,rep,name=limits,proto3" json:"limits,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	// Requests describes the minimum amount of compute resources required.
	// If Requests is omitted for a container, it defaults to Limits if that is explicitly specified,
	// otherwise to an implementation-defined value. Requests cannot exceed Limits.
	// More info: https://kubernetes.io/docs/concepts/configuration/manage-resources-containers/
	// +optional
	Requests      map[string]*PodStatusPubSub_Quantity `protobuf:"bytes,2,rep,name=requests,proto3" json:"requests,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_chalk_pubsub_v1_pod_status_proto_rawDesc = "" +
	"\n" +
	" chalk/pubsub/v1/pod_status.proto\x12\x0fchalk.pubsub.v1\x1a\x1cgen_bq_schema/bq_field.proto\x1a\x1cgen_bq_schema/bq_table.proto\"\x845\n" +
	"\x0fPodStatusPubSub\x12\x12\n" +
	...
	"\x11pod_template_hash\x18\x06 \x01(\tR\x0fpodTemplateHash\x12B\n" +
	"\x06status\x18\a \x01(\v2*.chalk.pubsub.v1.PodStatusPubSub.PodStatusR\x06status\x12<\n" +
	"\x04spec\x18\b \x01(\v2(.chalk.pubsub.v1.PodStatusPubSub.PodSpecR\x04spec\x12=\n" +
	"\x12creation_timestamp\x18\x12 \x01(\x03B\x0e\xea?\v\x12\tTIMESTAMPR\x11creationTimestamp\x12=\n" +
	"\x12deletion_timestamp\x18\x13 \x01(\x03B\x0e\xea?\v\x12\tTIMESTAMPR\x11deletionTimestamp\x12=\n" +
	"\x12observed_timestamp\x18\x14 \x01(\x03B\x0e\xea?\v\x12\tTIMESTAMPR\x11observedTimestamp\x12D\n" +
	"\x06labels\x18\x15 \x03(\v2,.chalk.pubsub.v1.PodStatusPubSub.LabelsEntryR\x06labels\x12S\n" +
	"\vannotations\x18\x16 \x03(\v21.chalk.pubsub.v1.PodStatusPubSub.AnnotationsEntryR\vannotations\x12\x18\n" +
	...
	"\x1d_resource_claim_template_name\x1a|\n" +
	"\x10PodResourceClaim\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12I\n" +
	"\x06source\x18\x02 \x01(\v2,.chalk.pubsub.v1.PodStatusPubSub.ClaimSourceH\x00R\x06source\x88\x01\x01B\t\n" +
	"\a_source\x1a\xd8\r\n" +
	"\aPodSpec\x12A\n" +
	"\avolumes\x18\x01 \x03(\v2'.chalk.pubsub.v1.PodStatusPubSub.VolumeR\avolumes\x12S\n" +
	"\x0finit_containers\x18\x14 \x03(\v2*.chalk.pubsub.v1.PodStatusPubSub.ContainerR\x0einitContainers\x12J\n" +
	"\n" +
	"containers\x18\x02 \x03(\v2*.chalk.pubsub.v1.PodStatusPubSub.ContainerR\n" +
	"containers\x12*\n" +
	...
	"\n" +
	"dns_policy\x18\x06 \x01(\tH\x03R\tdnsPolicy\x88\x01\x01\x12_\n" +
	"\rnode_selector\x18\a \x03(\v2:.chalk.pubsub.v1.PodStatusPubSub.PodSpec.NodeSelectorEntryR\fnodeSelector\x125\n" +
	...
	"\n" +
	"host_users\x18% \x01(\bH\x0fR\thostUsers\x88\x01\x01\x12Z\n" +
	"\x0fresource_claims\x18' \x03(\v21.chalk.pubsub.v1.PodStatusPubSub.PodResourceClaimR\x0eresourceClaims\x1a?\n" +
	...
	"\v_host_users\x1a\xc5\x02\n" +
	"\x0eContainerState\x12U\n" +
	"\awaiting\x18\x01 \x01(\v26.chalk.pubsub.v1.PodStatusPubSub.ContainerStateWaitingH\x00R\awaiting\x88\x01\x01\x12U\n" +
	"\arunning\x18\x02 \x01(\v26.chalk.pubsub.v1.PodStatusPubSub.ContainerStateRunningH\x01R\arunning\x88\x01\x01\x12^\n" +
	"\n" +
	"terminated\x18\x03 \x01(\v29.chalk.pubsub.v1.PodStatusPubSub.ContainerStateTerminatedH\x02R\n" +
	...
	"\b_runningB\r\n" +
	"\v_terminated\x1aF\n" +
	"\x15ContainerStateRunning\x12-\n" +
	"\n" +
	"started_at\x18\x01 \x01(\x03B\x0e\xea?\v\x12\tTIMESTAMPR\tstartedAt\x1a\xf4\x02\n" +
	...
	"\amessage\x18\x04 \x01(\tH\x02R\amessage\x88\x01\x01\x122\n" +
	"\n" +
	"started_at\x18\x05 \x01(\x03B\x0e\xea?\v\x12\tTIMESTAMPH\x03R\tstartedAt\x88\x01\x01\x124\n" +
	"\vfinished_at\x18\x06 \x01(\x03B\x0e\xea?\v\x12\tTIMESTAMPH\x04R\n" +
	...
	"\x05value\x18\x02 \x01(\tR\x05value\x1a\xd6\x05\n" +
	"\tContainer\x12\x12\n" +
	...
	"workingDir\x88\x01\x01\x129\n" +
	"\x03env\x18\a \x03(\v2'.chalk.pubsub.v1.PodStatusPubSub.EnvVarR\x03env\x12X\n" +
	"\tresources\x18\b \x01(\v25.chalk.pubsub.v1.PodStatusPubSub.ResourceRequirementsH\x02R\tresources\x88\x01\x01\x12*\n" +
	...
	"\a_reasonB\n" +
	"\n" +
	"\b_message\x1a\x97\x03\n" +
	"\x0fContainerStatus\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x12J\n" +
	"\x05state\x18\x02 \x01(\v2/.chalk.pubsub.v1.PodStatusPubSub.ContainerStateH\x00R\x05state\x88\x01\x01\x12S\n" +
	"\n" +
	"last_state\x18\x03 \x01(\v2/.chalk.pubsub.v1.PodStatusPubSub.ContainerStateH\x01R\tlastState\x88\x01\x01\x12\x19\n" +
	...
	"\a_string\x1a\xa0\x03\n" +
	"\x14ResourceRequirements\x12Y\n" +
	"\x06limits\x18\x01 \x03(\v2A.chalk.pubsub.v1.PodStatusPubSub.ResourceRequirements.LimitsEntryR\x06limits\x12_\n" +
	"\brequests\x18\x02 \x03(\v2C.chalk.pubsub.v1.PodStatusPubSub.ResourceRequirements.RequestsEntryR\brequests\x1ad\n" +
	"\vLimitsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12?\n" +
	"\x05value\x18\x02 \x01(\v2).chalk.pubsub.v1.PodStatusPubSub.QuantityR\x05value:\x028\x01\x1af\n" +
	"\rRequestsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12?\n" +
	"\x05value\x18\x02 \x01(\v2).chalk.pubsub.v1.PodStatusPubSub.QuantityR\x05value:\x028\x01\x1a\x87\x02\n" +
	"\fPodCondition\x12\x12\n" +
	"\x04type\x18\x01 \x01(\tR\x04type\x12\x16\n" +
	"\x06status\x18\x02 \x01(\tR\x06status\x126\n" +
	"\x0flast_probe_time\x18\x03 \x01(\x03B\x0e\xea?\v\x12\tTIMESTAMPR\rlastProbeTime\x12@\n" +
	"\x14last_transition_time\x18\x04 \x01(\x03B\x0e\xea?\v\x12\tTIMESTAMPR\x12lastTransitionTime\x12\x1b\n" +
	...
	"\x03_ip\x1a\x8e\a\n" +
	"\tPodStatus\x12\x19\n" +
	"\x05phase\x18\x01 \x01(\tH\x00R\x05phase\x88\x01\x01\x12M\n" +
	"\n" +
	"conditions\x18\x02 \x03(\v2-.chalk.pubsub.v1.PodStatusPubSub.PodConditionR\n" +
	"conditions\x12\x1d\n" +
	...
	"\ahost_ip\x18\x05 \x01(\tH\x04R\x06hostIp\x88\x01\x01\x12B\n" +
	"\bhost_ips\x18\x10 \x03(\v2'.chalk.pubsub.v1.PodStatusPubSub.HostIPR\ahostIps\x12\x1a\n" +
	"\x06pod_ip\x18\x06 \x01(\tH\x05R\x05podIp\x88\x01\x01\x122\n" +
	"\n" +
	"start_time\x18\a \x01(\x03B\x0e\xea?\v\x12\tTIMESTAMPH\x06R\tstartTime\x88\x01\x01\x12h\n" +
	"\x17init_container_statuses\x18\n" +
	" \x03(\v20.chalk.pubsub.v1.PodStatusPubSub.ContainerStatusR\x15initContainerStatuses\x12_\n" +
	"\x12container_statuses\x18\b \x03(\v20.chalk.pubsub.v1.PodStatusPubSub.ContainerStatusR\x11containerStatuses\x12 \n" +
	"\tqos_class\x18\t \x01(\tH\aR\bqosClass\x88\x01\x01\x12r\n" +
	"\x1cephemeral_container_statuses\x18\r \x03(\v20.chalk.pubsub.v1.PodStatusPubSub.ContainerStatusR\x1aephemeralContainerStatuses\x12\x1b\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\tR\x05value:\x028\x01:\x0f\xea?\f\n" +
	"\n" +
	"pod_statusB\xbe\x01\n" +
	"\x13com.chalk.pubsub.v1B\x0ePodStatusProtoP\x01Z9github.com/chalk-ai/chalk-go/gen/chalk/pubsub/v1;pubsubv1\xa2\x02\x03CPX\xaa\x02\x0fChalk.Pubsub.V1\xca\x02\x0fChalk\\Pubsub\\V1\xe2\x02\x1bChalk\\Pubsub\\V1\\GPBMetadata\xea\x02\x11Chalk::Pubsub::V1b\x06proto3"

var (
	file_chalk_pubsub_v1_pod_status_proto_rawDescOnce sync.Once
	file_chalk_pubsub_v1_pod_status_proto_rawDescData []byte
)

func file_chalk_pubsub_v1_pod_status_proto_rawDescGZIP() []byte {
	file_chalk_pubsub_v1_pod_status_proto_rawDescOnce.Do(func() {
		file_chalk_pubsub_v1_pod_status_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chalk_pubsub_v1_pod_status_proto_rawDesc), len(file_chalk_pubsub_v1_pod_status_proto_rawDesc)))
	})
...
func file_chalk_pubsub_v1_pod_status_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chalk_pubsub_v1_pod_status_proto_rawDesc), len(file_chalk_pubsub_v1_pod_status_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   0,
