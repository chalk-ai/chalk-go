...
func file_chalk_manager_v1_status_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chalk_manager_v1_status_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_chalk_manager_v1_status_proto_msgTypes[1].Exporter = func(v any, i int) any {
