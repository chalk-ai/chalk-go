...
const file_chalk_auth_v1_displayagent_proto_rawDesc = "" +
	"\n" +
	" chalk/auth/v1/displayagent.proto\x12\rchalk.auth.v1\x1a%chalk/auth/v1/featurepermission.proto\x1a\x1fchalk/auth/v1/permissions.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"b\n" +
	"\x11DisplayPermission\x12\x12\n" +
	"\x04name\x18\x01 \x01(\tR\x04name\x129\n" +
	"\n" +
	"permission\x18\x02 \x01(\x0e2\x19.chalk.auth.v1.PermissionR\n" +
	"permission\"\xf7\x01\n" +
	"\x1dDisplayEnvironmentPermissions\x12%\n" +
	"\x0eenvironment_id\x18\x01 \x01(\tR\renvironmentId\x12)\n" +
	"\x10environment_name\x18\x02 \x01(\tR\x0fenvironmentName\x12\x1d\n" +
	"\n" +
	"project_id\x18\x03 \x01(\tR\tprojectId\x12!\n" +
	"\fproject_name\x18\x04 \x01(\tR\vprojectName\x12B\n" +
	"\vpermissions\x18\x05 \x03(\v2 .chalk.auth.v1.DisplayPermissionR\vpermissions\"\x88\x03\n" +
	"\x10DisplayUserAgent\x12\x1f\n" +
	"\tclient_id\x18\x01 \x01(\tB\x02\x18\x01R\bclientId\x12\x17\n" +
	"\auser_id\x18\x02 \x01(\tR\x06userId\x12\x17\n" +
	"\ateam_id\x18\x03 \x01(\tR\x06teamId\x12j\n" +
	"\x1apermissions_by_environment\x18\x04 \x03(\v2,.chalk.auth.v1.DisplayEnvironmentPermissionsR\x18permissionsByEnvironment\x12\"\n" +
	"\fimpersonated\x18\x05 \x01(\bR\fimpersonated\x12\x12\n" +
	"\x04name\x18\x06 \x01(\tR\x04name\x12\x14\n" +
	"\x05email\x18\a \x01(\tR\x05email\x12\x1b\n" +
	"\tteam_name\x18\b \x01(\tR\bteamName\x12J\n" +
	"\x0fcustomer_claims\x18\t \x03(\v2!.chalk.auth.v1.DisplayCustomClaimR\x0ecustomerClaims\">\n" +
	"\x12DisplayCustomClaim\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x16\n" +
	"\x06values\x18\x02 \x03(\tR\x06values\"\x91\x05\n" +
	"\x18DisplayServiceTokenAgent\x12\x0e\n" +
	...
	"\x0eenvironment_id\x18\x05 \x01(\tR\renvironmentId\x12B\n" +
	"\vpermissions\x18\x06 \x03(\v2 .chalk.auth.v1.DisplayPermissionR\vpermissions\x12\x12\n" +
	...
	" \x01(\tR\x0fenvironmentName\x12J\n" +
	"\x0fcustomer_claims\x18\v \x03(\v2!.chalk.auth.v1.DisplayCustomClaimR\x0ecustomerClaims\x12R\n" +
	"\x13feature_permissions\x18\f \x01(\v2!.chalk.auth.v1.FeaturePermissionsR\x12featurePermissions\x129\n" +
	"\n" +
	"created_at\x18\r \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt\x12K\n" +
	"\x10team_permissions\x18\x0e \x03(\v2 .chalk.auth.v1.DisplayPermissionR\x0fteamPermissions\"\x92\x02\n" +
	"\x12DisplayEngineAgent\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x17\n" +
	"\ateam_id\x18\x02 \x01(\tR\x06teamId\x12\x1d\n" +
	"\n" +
	"project_id\x18\x03 \x01(\tR\tprojectId\x12%\n" +
	"\x0eenvironment_id\x18\x04 \x01(\tR\renvironmentId\x12\"\n" +
	"\fimpersonated\x18\x05 \x01(\bR\fimpersonated\x12\x1b\n" +
	"\tteam_name\x18\x06 \x01(\tR\bteamName\x12!\n" +
	"\fproject_name\x18\a \x01(\tR\vprojectName\x12)\n" +
	"\x10environment_name\x18\b \x01(\tR\x0fenvironmentName\"\x14\n" +
	"\x12DisplayTenantAgent\"\x1d\n" +
	"\x1bDisplayMetadataServiceAgent\"\xa8\x03\n" +
	"\fDisplayAgent\x12@\n" +
	"\n" +
	"user_agent\x18\x01 \x01(\v2\x1f.chalk.auth.v1.DisplayUserAgentH\x00R\tuserAgent\x12Y\n" +
	"\x13service_token_agent\x18\x02 \x01(\v2'.chalk.auth.v1.DisplayServiceTokenAgentH\x00R\x11serviceTokenAgent\x12F\n" +
	"\fengine_agent\x18\x03 \x01(\v2!.chalk.auth.v1.DisplayEngineAgentH\x00R\vengineAgent\x12F\n" +
	"\ftenant_agent\x18\x04 \x01(\v2!.chalk.auth.v1.DisplayTenantAgentH\x00R\vtenantAgent\x12b\n" +
	"\x16metadata_service_agent\x18\x05 \x01(\v2*.chalk.auth.v1.DisplayMetadataServiceAgentH\x00R\x14metadataServiceAgentB\a\n" +
	"\x05agentB\xb3\x01\n" +
	"\x11com.chalk.auth.v1B\x11DisplayagentProtoP\x01Z5github.com/chalk-ai/chalk-go/gen/chalk/auth/v1;authv1\xa2\x02\x03CAX\xaa\x02\rChalk.Auth.V1\xca\x02\rChalk\\Auth\\V1\xe2\x02\x19Chalk\\Auth\\V1\\GPBMetadata\xea\x02\x0fChalk::Auth::V1b\x06proto3"

var (
	file_chalk_auth_v1_displayagent_proto_rawDescOnce sync.Once
	file_chalk_auth_v1_displayagent_proto_rawDescData []byte
)

func file_chalk_auth_v1_displayagent_proto_rawDescGZIP() []byte {
	file_chalk_auth_v1_displayagent_proto_rawDescOnce.Do(func() {
		file_chalk_auth_v1_displayagent_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chalk_auth_v1_displayagent_proto_rawDesc), len(file_chalk_auth_v1_displayagent_proto_rawDesc)))
	})
...
func file_chalk_auth_v1_displayagent_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chalk_auth_v1_displayagent_proto_rawDesc), len(file_chalk_auth_v1_displayagent_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   0,
