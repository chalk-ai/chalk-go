...
const file_chalk_auth_v1_featurepermission_proto_rawDesc = "" +
	...
	"\x04tags\x18\x01 \x03(\v2+.chalk.auth.v1.FeaturePermissions.TagsEntryR\x04tags\x12T\n" +
	"\x12default_permission\x18\x02 \x01(\x0e2 .chalk.auth.v1.FeaturePermissionH\x00R\x11defaultPermission\x88\x01\x01\x1aY\n" +
	"\tTagsEntry\x12\x10\n" +
