...
const file_chalk_auth_v1_permissions_proto_rawDesc = "" +
	"\n" +
	"\x1fchalk/auth/v1/permissions.proto\x12\rchalk.auth.v1\x1a\x1dchalk/utils/v1/encoding.proto\x1a google/protobuf/descriptor.proto*\xf6\n" +
	"\n" +
	"\n" +
	"Permission\x12\x1a\n" +
