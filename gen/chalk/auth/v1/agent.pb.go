...
var file_chalk_auth_v1_agent_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x42, 0xac, 0x01, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x63, 0x68, 0x61, 0x6c,
	0x6b, 0x2e, 0x61, 0x75, 0x74, 0x68, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x41, 0x67, 0x65, 0x6e, 0x74,
...
var file_chalk_auth_v1_agent_proto_depIdxs = []int32{
	...
	2,  // 2: chalk.auth.v1.EnvironmentPermissions.customer_claims:type_name -> chalk.auth.v1.CustomClaim
	8,  // 3: chalk.auth.v1.UserAgent.permissions_by_environment:type_name -> chalk.auth.v1.UserAgent.PermissionsByEnvironmentEntry
	9,  // 4: chalk.auth.v1.ServiceTokenAgent.permissions:type_name -> chalk.auth.v1.Permission
	2,  // 5: chalk.auth.v1.ServiceTokenAgent.customer_claims:type_name -> chalk.auth.v1.CustomClaim
	10, // 6: chalk.auth.v1.ServiceTokenAgent.feature_permissions:type_name -> chalk.auth.v1.FeaturePermissions
	1,  // 7: chalk.auth.v1.Agent.user_agent:type_name -> chalk.auth.v1.UserAgent
	3,  // 8: chalk.auth.v1.Agent.service_token_agent:type_name -> chalk.auth.v1.ServiceTokenAgent
	4,  // 9: chalk.auth.v1.Agent.engine_agent:type_name -> chalk.auth.v1.EngineAgent
	6,  // 10: chalk.auth.v1.Agent.tenant_agent:type_name -> chalk.auth.v1.TenantAgent
	5,  // 11: chalk.auth.v1.Agent.metadata_service_agent:type_name -> chalk.auth.v1.MetadataServiceAgent
	0,  // 12: chalk.auth.v1.UserAgent.PermissionsByEnvironmentEntry.value:type_name -> chalk.auth.v1.EnvironmentPermissions
