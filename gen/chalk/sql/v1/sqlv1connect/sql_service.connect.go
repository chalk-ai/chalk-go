...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/chalk-ai/chalk-go/v2/gen/chalk/sql/v1"
	http "net/http"
	strings "strings"
)
...
const (
	...
	SqlServiceName = "chalk.sql.v1.SqlService"
)
...
const (
	...
	// ExecuteSqlQuery RPC.
	SqlServiceExecuteSqlQueryProcedure = "/chalk.sql.v1.SqlService/ExecuteSqlQuery"
	// SqlServicePlanSqlQueryProcedure is the fully-qualified name of the SqlService's PlanSqlQuery RPC.
	SqlServicePlanSqlQueryProcedure = "/chalk.sql.v1.SqlService/PlanSqlQuery"
)

// SqlServiceClient is a client for the chalk.sql.v1.SqlService service.
...
// NewSqlServiceClient constructs a client for the chalk.sql.v1.SqlService service. By default, it
...
func NewSqlServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) SqlServiceClient {
	...
	sqlServiceMethods := v1.File_chalk_sql_v1_sql_service_proto.Services().ByName("SqlService").Methods()
...
// ExecuteSqlQuery calls chalk.sql.v1.SqlService.ExecuteSqlQuery.
...
// PlanSqlQuery calls chalk.sql.v1.SqlService.PlanSqlQuery.
...
// SqlServiceHandler is an implementation of the chalk.sql.v1.SqlService service.
...
func NewSqlServiceHandler(svc SqlServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	return "/chalk.sql.v1.SqlService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedSqlServiceHandler) ExecuteSqlQuery(context.Context, *connect.Request[v1.ExecuteSqlQueryRequest]) (*connect.Response[v1.ExecuteSqlQueryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chalk.sql.v1.SqlService.ExecuteSqlQuery is not implemented"))
}
...
func (UnimplementedSqlServiceHandler) PlanSqlQuery(context.Context, *connect.Request[v1.PlanSqlQueryRequest]) (*connect.Response[v1.PlanSqlQueryResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("chalk.sql.v1.SqlService.PlanSqlQuery is not implemented"))
}
