...
type DatabaseSource struct {
	...
	// Permission tags associated with a datasource access used for datasource RBAC (akin to Feature Tags). These permission tags are
	// NOT THE SAME as Rouiting Tags (SQLSourceGroupTags and Resolver Tags)
...
func (x *DatabaseSource) GetTags() []string {
	if x != nil {
		return x.Tags
	}
	return nil
...
const file_chalk_graph_v2_sources_proto_rawDesc = "" +
	...
	"\aoptions\x18\x03 \x03(\v2+.chalk.graph.v2.DatabaseSource.OptionsEntryR\aoptions\x12\x12\n" +
	"\x04tags\x18\x04 \x03(\tR\x04tags\x1aR\n" +
