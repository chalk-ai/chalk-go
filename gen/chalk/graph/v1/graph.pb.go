...
const file_chalk_graph_v1_graph_proto_rawDesc = "" +
	...
	"GraphProtoP\x01Z7github.com/chalk-ai/chalk-go/gen/chalk/graph/v1;graphv1\xa2\x02\x03CGX\xaa\x02\x0eChalk.Graph.V1\xca\x02\x0eChalk\\Graph\\V1\xe2\x02\x1aChalk\\Graph\\V1\\GPBMetadata\xea\x02\x10Chalk::Graph::V1P\x03b\x06proto3"
...
var file_chalk_graph_v1_graph_proto_depIdxs = []int32{
	...
	8,   // 187: chalk.graph.v1.IncrementalSettings.mode:type_name -> chalk.graph.v1.IncrementalMode
	98,  // 188: chalk.graph.v1.IncrementalSettings.lookback_period:type_name -> google.protobuf.Duration
	9,   // 189: chalk.graph.v1.IncrementalSettings.timestamp_mode:type_name -> chalk.graph.v1.IncrementalTimestampMode
	66,  // 190: chalk.graph.v1.SQLResolverCommentDict.incremental:type_name -> chalk.graph.v1.IncrementalSettings
	7,   // 191: chalk.graph.v1.SQLResolverCommentDict.count:type_name -> chalk.graph.v1.Finalizer
	70,  // 192: chalk.graph.v1.SQLResolverCommentDict.cron:type_name -> chalk.graph.v1.Schedule
	91,  // 193: chalk.graph.v1.SQLResolverCommentDict.fields:type_name -> chalk.graph.v1.SQLResolverCommentDict.FieldsEntry
	67,  // 194: chalk.graph.v1.SQLResolverInfo.override_comment_dict:type_name -> chalk.graph.v1.SQLResolverCommentDict
	51,  // 195: chalk.graph.v1.CronFilterWithFeatureArgs.filter:type_name -> chalk.graph.v1.FunctionReference
	20,  // 196: chalk.graph.v1.CronFilterWithFeatureArgs.args:type_name -> chalk.graph.v1.FeatureReference
	98,  // 197: chalk.graph.v1.Schedule.duration:type_name -> google.protobuf.Duration
	51,  // 198: chalk.graph.v1.Schedule.filter:type_name -> chalk.graph.v1.FunctionReference
	51,  // 199: chalk.graph.v1.Schedule.sample:type_name -> chalk.graph.v1.FunctionReference
	103, // 200: chalk.graph.v1.FeatureValidation.min_arrow:type_name -> chalk.arrow.v1.ScalarValue
	103, // 201: chalk.graph.v1.FeatureValidation.max_arrow:type_name -> chalk.arrow.v1.ScalarValue
	103, // 202: chalk.graph.v1.FeatureValidation.min_length_arrow:type_name -> chalk.arrow.v1.ScalarValue
	103, // 203: chalk.graph.v1.FeatureValidation.max_length_arrow:type_name -> chalk.arrow.v1.ScalarValue
	103, // 204: chalk.graph.v1.FeatureValidation.contains:type_name -> chalk.arrow.v1.ScalarValue
	20,  // 205: chalk.graph.v1.StrictValidation.feature:type_name -> chalk.graph.v1.FeatureReference
	71,  // 206: chalk.graph.v1.StrictValidation.validations:type_name -> chalk.graph.v1.FeatureValidation
	60,  // 207: chalk.graph.v1.FeatureEncoder.global_function_reference:type_name -> chalk.graph.v1.FunctionGlobalCapturedFunction
	60,  // 208: chalk.graph.v1.FeatureDecoder.global_function_reference:type_name -> chalk.graph.v1.FunctionGlobalCapturedFunction
	76,  // 209: chalk.graph.v1.RichClassType.params:type_name -> chalk.graph.v1.RichClassType
	76,  // 210: chalk.graph.v1.FeatureRichType.class_type:type_name -> chalk.graph.v1.RichClassType
	74,  // 211: chalk.graph.v1.FeatureRichTypeInfo.encoder:type_name -> chalk.graph.v1.FeatureEncoder
	75,  // 212: chalk.graph.v1.FeatureRichTypeInfo.decoder:type_name -> chalk.graph.v1.FeatureDecoder
	77,  // 213: chalk.graph.v1.FeatureRichTypeInfo.rich_type:type_name -> chalk.graph.v1.FeatureRichType
	98,  // 214: chalk.graph.v1.LRUCacheConfig.ttl:type_name -> google.protobuf.Duration
	79,  // 215: chalk.graph.v1.OnlineStoreConfig.lru_cache:type_name -> chalk.graph.v1.LRUCacheConfig
	100, // 216: chalk.graph.v1.OnlineStoreConfig.source_file_reference:type_name -> chalk.graph.v1.SourceFileReference
	98,  // 217: chalk.graph.v1.NamedQuery.StalenessEntry.value:type_name -> google.protobuf.Duration
	17,  // 218: chalk.graph.v1.NamedQuery.ResourceGroupsEntry.value:type_name -> chalk.graph.v1.NamedQueryResourceGroups
	42,  // 219: chalk.graph.v1.StreamResolver.FeatureExpressionsEntry.value:type_name -> chalk.graph.v1.FeatureExpression
	42,  // 220: chalk.graph.v1.StreamResolverMessageProducerParsed.TransformationsEntry.value:type_name -> chalk.graph.v1.FeatureExpression
	103, // 221: chalk.graph.v1.FunctionGlobalCapturedEnum.MemberMapEntry.value:type_name -> chalk.arrow.v1.ScalarValue
