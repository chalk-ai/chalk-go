...
const (
	StreamingDeduplicationStage_STREAMING_DEDUPLICATION_STAGE_UNSPECIFIED     StreamingDeduplicationStage = 0
	StreamingDeduplicationStage_STREAMING_DEDUPLICATION_STAGE_PARSED_MESSAGE  StreamingDeduplicationStage = 1
	StreamingDeduplicationStage_STREAMING_DEDUPLICATION_STAGE_OUTPUT_FEATURES StreamingDeduplicationStage = 2
)

// Enum value maps for StreamingDeduplicationStage.
var (
	StreamingDeduplicationStage_name = map[int32]string{
		0: "STREAMING_DEDUPLICATION_STAGE_UNSPECIFIED",
		1: "STREAMING_DEDUPLICATION_STAGE_PARSED_MESSAGE",
		2: "STREAMING_DEDUPLICATION_STAGE_OUTPUT_FEATURES",
	}
	StreamingDeduplicationStage_value = map[string]int32{
		"STREAMING_DEDUPLICATION_STAGE_UNSPECIFIED":     0,
		"STREAMING_DEDUPLICATION_STAGE_PARSED_MESSAGE":  1,
		"STREAMING_DEDUPLICATION_STAGE_OUTPUT_FEATURES": 2,
	}
)

func (x StreamingDeduplicationStage) Enum() *StreamingDeduplicationStage {
	p := new(StreamingDeduplicationStage)
	*p = x
	return p
}

func (x StreamingDeduplicationStage) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}
...
type Graph struct {
	...
	MaterializedFeatureViews []*MaterializedFeatureView `protobuf:"bytes,15,rep,name=materialized_feature_views,json=materializedFeatureViews,proto3" json:"materialized_feature_views,omitempty"`
...
func (x *Graph) GetMaterializedFeatureViews() []*MaterializedFeatureView {
	if x != nil {
		return x.MaterializedFeatureViews
	}
	return nil
}

type MaterializedFeatureView struct {
	state          protoimpl.MessageState `protogen:"open.v1"`
	...
	// Crontab string or duration string (e.g. "1d", "*/5 * * * *").
	UpdateCadence           string                 `protobuf:"bytes,3,opt,name=update_cadence,json=updateCadence,proto3" json:"update_cadence,omitempty"`
...
func (x *MaterializedFeatureView) Reset() {
	*x = MaterializedFeatureView{}
	mi := &file_chalk_graph_v1_graph_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *MaterializedFeatureView) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MaterializedFeatureView) ProtoMessage() {}

func (x *MaterializedFeatureView) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_graph_v1_graph_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MaterializedFeatureView.ProtoReflect.Descriptor instead.
func (*MaterializedFeatureView) Descriptor() ([]byte, []int) {
	return file_chalk_graph_v1_graph_proto_rawDescGZIP(), []int{1}
}

func (x *MaterializedFeatureView) GetNamespaces() []string {
	if x != nil {
		return x.Namespaces
	}
	return nil
...
func (x *MaterializedFeatureView) GetTimeResolution() *durationpb.Duration {
	if x != nil {
...
func (x *MaterializedFeatureView) GetUpdateCadence() string {
	if x != nil {
...
func (x *MaterializedFeatureView) GetLowerBound() *timestamppb.Timestamp {
	if x != nil {
		return x.LowerBound
	}
	return nil
...
func (x *MaterializedFeatureView) GetLookbackRetentionPeriod() *durationpb.Duration {
	if x != nil {
...
func (x *MaterializedFeatureView) GetSourceFileReference() *SourceFileReference {
	if x != nil {
...
type OverlayGraph struct {
	...
	CapturedGlobalValues  []*CapturedGlobalValue `protobuf:"bytes,5,rep,name=captured_global_values,json=capturedGlobalValues,proto3" json:"captured_global_values,omitempty"`
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *OverlayGraph) GetCapturedGlobalValues() []*CapturedGlobalValue {
	if x != nil {
		return x.CapturedGlobalValues
	}
	return nil
...
type ModelReference struct {
	...
	// Feature relations declared on the model reference (input features ->
	// output feature). Carried so the metadata store can persist the same
	// columns the legacy GraphQL apply path wrote.
	Relations []*ModelRelation `protobuf:"bytes,6,rep,name=relations,proto3" json:"relations,omitempty"`
	// FQNs of resolvers that use this model reference.
	Resolvers     []string `protobuf:"bytes,7,rep,name=resolvers,proto3" json:"resolvers,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type NamedQuery struct {
	...
	// Scopes preplanning by environment and resource group. Keyed by environment
	// id, or "__all__" for groups that apply in every environment. An engine
	// preplans this query iff its CHALK_RESOURCE_GROUP is in the "__all__" entry
	// or in the entry for its environment; an environment with no matching entry
	// does not preplan the query. Empty means every resource group in every
	// environment plans it.
	ResourceGroups map[string]*NamedQueryResourceGroups `protobuf:"bytes,16,rep,name=resource_groups,json=resourceGroups,proto3" json:"resource_groups,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	unknownFields  protoimpl.UnknownFields
	sizeCache      protoimpl.SizeCache
}
...
func (x *NamedQuery) GetResourceGroups() map[string]*NamedQueryResourceGroups {
	if x != nil {
...
type NamedQueryResourceGroups struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *NamedQueryResourceGroups) Reset() {
	*x = NamedQueryResourceGroups{}
	mi := &file_chalk_graph_v1_graph_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *NamedQueryResourceGroups) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NamedQueryResourceGroups) ProtoMessage() {}

func (x *NamedQueryResourceGroups) ProtoReflect() protoreflect.Message {
	mi := &file_chalk_graph_v1_graph_proto_msgTypes[6]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NamedQueryResourceGroups.ProtoReflect.Descriptor instead.
func (*NamedQueryResourceGroups) Descriptor() ([]byte, []int) {
	return file_chalk_graph_v1_graph_proto_rawDescGZIP(), []int{6}
}

func (x *NamedQueryResourceGroups) GetGroups() []string {
	if x != nil {
		return x.Groups
	}
	return nil
...
type FeatureType struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// When adding a variant here, also add a matching case to
	// `getFeatureInfo` in `go-api-server/builder/deployment_index.go`, or
	// the variant will be skipped at index time and absent from the
	// Algolia index — and thus from every product surface that queries it.
	//
...
type WindowedFeatureType struct {
	...
	// Mirrors ScalarFeatureType.no_display: set on the redundant default-version
	// alias of a versioned windowed feature so the dashboard drops it instead of
	// rendering a duplicate row.
	NoDisplay bool `protobuf:"varint,8,opt,name=no_display,json=noDisplay,proto3" json:"no_display,omitempty"`
	// Mirrors ScalarFeatureType.version: structured version metadata for a
	// versioned windowed feature so consumers can identify the default vs.
	// non-default versions (and render the version count) without parsing the
	// `@N` suffix out of the name.
	Version       *VersionInfo `protobuf:"bytes,9,opt,name=version,proto3" json:"version,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WindowedFeatureType) GetNoDisplay() bool {
	if x != nil {
		return x.NoDisplay
	}
	return false
...
func (x *WindowedFeatureType) GetVersion() *VersionInfo {
	if x != nil {
		return x.Version
	}
	return nil
...
type WindowAggregation struct {
	...
	AggregateOnFeatures   []*FeatureReference `protobuf:"bytes,17,rep,name=aggregate_on_features,json=aggregateOnFeatures,proto3" json:"aggregate_on_features,omitempty"`
	CacheAggregatedValues *bool               `protobuf:"varint,18,opt,name=cache_aggregated_values,json=cacheAggregatedValues,proto3,oneof" json:"cache_aggregated_values,omitempty"`
	// Expression-valued projections, e.g. `_.amount * _.fx_rate` in
	// `_.txns[_.amount * _.fx_rate, ...].sum()`. Mutually exclusive with
	// aggregate_on/aggregate_on_features. Engines without expression-projection
	...
	// written by the user as a lambda. Unlike every other aggregation the step is not implied by
	// `aggregation`, so it has to travel with the rule; and unlike `aggregate_on_expressions` it is
	// not a projection, so it is a separate field rather than a reuse of that one (a history_fold
	// populates `aggregate_on_features`, with which those are mutually exclusive).
	FoldStep *v11.LogicalExprNode `protobuf:"bytes,21,opt,name=fold_step,json=foldStep,proto3,oneof" json:"fold_step,omitempty"`
...
func (x *WindowAggregation) GetAggregateOnFeatures() []*FeatureReference {
	if x != nil {
...
func (x *WindowAggregation) GetCacheAggregatedValues() bool {
	if x != nil && x.CacheAggregatedValues != nil {
		return *x.CacheAggregatedValues
	}
	return false
}

func (x *WindowAggregation) GetAggregateOnExpressions() []*v11.LogicalExprNode {
	if x != nil {
...
func (x *WindowAggregation) GetFoldStep() *v11.LogicalExprNode {
	if x != nil {
		return x.FoldStep
	}
	return nil
...
func (x *WindowAggregation) GetFoldInitialValue() *v11.LogicalExprNode {
	if x != nil {
...
type DeduplicationStrategy struct {
	...
	// Where the deduplication expr is applied
	DeduplicationStage StreamingDeduplicationStage `protobuf:"varint,3,opt,name=deduplication_stage,json=deduplicationStage,proto3,enum=chalk.graph.v1.StreamingDeduplicationStage" json:"deduplication_stage,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *DeduplicationStrategy) GetDeduplicationStage() StreamingDeduplicationStage {
	if x != nil {
		return x.DeduplicationStage
	}
	return StreamingDeduplicationStage_STREAMING_DEDUPLICATION_STAGE_UNSPECIFIED
}
...
type StreamResolver struct {
	...
	// Reference to the resolver's source by (source_type, name). Superseded by source_full: a
	// reference cannot uniquely identify a source because every source field is customer-overridable,
	// so two sources sharing (source_type, name) -- or even (source_type, name, topic) -- can differ.
	// Prefer source_full. Still written for engines that predate it; not marked [deprecated] yet
	// because readers (Go KEDA/diff) still consume it -- deprecate once they migrate to source_full.
	...
	CustomerMetricsTags   []string               `protobuf:"bytes,28,rep,name=customer_metrics_tags,json=customerMetricsTags,proto3" json:"customer_metrics_tags,omitempty"`
	// Mat-agg feature FQNs this resolver must NOT update, even when
	// `update_aggregates=true`. The planner drops these from the per-namespace
	// filtered_aggs set in NewBatchPlanner._update_query_for_streaming_aggs.
	// Used by the Mercury Kinesis->Kafka migration so the v2 (Kafka) resolver
	// doesn't bump the v1 implicit-pkey count, which is invisible to the
	// cross-version isolation gate (the v1 count references only an unversioned pkey).
	ExcludedAggregationFqns []string `protobuf:"bytes,29,rep,name=excluded_aggregation_fqns,json=excludedAggregationFqns,proto3" json:"excluded_aggregation_fqns,omitempty"`
	// The resolver's complete source, embedded rather than referenced. The full source is the only
	// sound identity (all source fields are customer-overridable), so consumers must bind from this
	// when present instead of resolving source_v2 against the shared stream_sources_v2 list. Unset on
	// graphs from older clients -- fall back to source_v2 then.
	SourceFull    *v2.StreamSource `protobuf:"bytes,30,opt,name=source_full,json=sourceFull,proto3" json:"source_full,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StreamResolver) GetCustomerMetricsTags() []string {
	if x != nil {
		return x.CustomerMetricsTags
	}
	return nil
}

func (x *StreamResolver) GetExcludedAggregationFqns() []string {
	if x != nil {
		return x.ExcludedAggregationFqns
	}
	return nil
}

func (x *StreamResolver) GetSourceFull() *v2.StreamSource {
	if x != nil {
		return x.SourceFull
	}
	return nil
...
type StreamResolverMessageProducerParsed struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Superseded by send_to_full (a reference cannot uniquely identify a source). Still written for
	// older engines; not marked [deprecated] yet since readers still consume it.
	...
	// Controls the key on outbound sink messages. Currently only "pass_through"
	// (copy the incoming source message key) is supported; unset preserves the
	// legacy behavior of producing without a key.
	MessageKey *string `protobuf:"bytes,5,opt,name=message_key,json=messageKey,proto3,oneof" json:"message_key,omitempty"`
	// The producer's complete destination source, embedded rather than referenced. Prefer over
	// send_to; unset on graphs from older clients.
	SendToFull    *v2.StreamSource `protobuf:"bytes,6,opt,name=send_to_full,json=sendToFull,proto3,oneof" json:"send_to_full,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *StreamResolverMessageProducerParsed) GetMessageKey() string {
...
func (x *StreamResolverMessageProducerParsed) GetSendToFull() *v2.StreamSource {
	if x != nil {
		return x.SendToFull
	}
	return nil
...
type FunctionReferenceCapturedGlobal struct {
	...
	//	*FunctionReferenceCapturedGlobal_ValueRef
...
func (x *FunctionReferenceCapturedGlobal) GetValueRef() *FunctionGlobalCapturedValueRef {
	if x != nil {
		if x, ok := x.CapturedGlobal.(*FunctionReferenceCapturedGlobal_ValueRef); ok {
			return x.ValueRef
		}
	}
	return nil
...
type FunctionReferenceCapturedGlobal_ValueRef struct {
	ValueRef *FunctionGlobalCapturedValueRef `protobuf:"bytes,12,opt,name=value_ref,json=valueRef,proto3,oneof"`
}
...
func (*FunctionReferenceCapturedGlobal_ValueRef) isFunctionReferenceCapturedGlobal_CapturedGlobal() {}
...
type FunctionGlobalCapturedValueRef struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
...
func (x *FunctionGlobalCapturedValueRef) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
type CapturedGlobalValue struct {
	state         protoimpl.MessageState           `protogen:"open.v1"`
	Id            string                           `protobuf:"bytes,1,opt,name=id,proto3" json:"id,omitempty"`
	Value         *FunctionReferenceCapturedGlobal `protobuf:"bytes,2,opt,name=value,proto3" json:"value,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *CapturedGlobalValue) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
func (x *CapturedGlobalValue) GetValue() *FunctionReferenceCapturedGlobal {
	if x != nil {
		return x.Value
	}
	return nil
...
func (x *FeatureRichTypeInfo) Reset() {
	*x = FeatureRichTypeInfo{}
	mi := &file_chalk_graph_v1_graph_proto_msgTypes[68]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FeatureRichTypeInfo) Descriptor() ([]byte, []int) {
	return file_chalk_graph_v1_graph_proto_rawDescGZIP(), []int{68}
}
...
func (x *LRUCacheConfig) Reset() {
	*x = LRUCacheConfig{}
	mi := &file_chalk_graph_v1_graph_proto_msgTypes[69]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LRUCacheConfig) Descriptor() ([]byte, []int) {
	return file_chalk_graph_v1_graph_proto_rawDescGZIP(), []int{69}
}
...
func (x *OnlineStoreConfig) Reset() {
	*x = OnlineStoreConfig{}
	mi := &file_chalk_graph_v1_graph_proto_msgTypes[70]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OnlineStoreConfig) Descriptor() ([]byte, []int) {
	return file_chalk_graph_v1_graph_proto_rawDescGZIP(), []int{70}
}
...
const file_chalk_graph_v1_graph_proto_rawDesc = "" +
	...
	"\x0eupdate_cadence\x18\x03 \x01(\tR\rupdateCadence\x12@\n" +
	...
	"\x17generated_sql_resolvers\x18\x04 \x03(\v2\x1f.chalk.graph.v1.SQLResolverInfoR\x15generatedSqlResolvers\x12Y\n" +
	"\x16captured_global_values\x18\x05 \x03(\v2#.chalk.graph.v1.CapturedGlobalValueR\x14capturedGlobalValues\"\xec\x02\n" +
	...
	"\x15source_file_reference\x18\x05 \x01(\v2#.chalk.graph.v1.SourceFileReferenceH\x01R\x13sourceFileReference\x88\x01\x01\x12;\n" +
	"\trelations\x18\x06 \x03(\v2\x1d.chalk.graph.v1.ModelRelationR\trelations\x12\x1c\n" +
	"\tresolvers\x18\a \x03(\tR\tresolversB\f\n" +
	"\n" +
	"identifierB\x18\n" +
	"\x16_source_file_reference\"]\n" +
	"\rModelRelation\x12%\n" +
	"\x0einput_features\x18\x01 \x03(\tR\rinputFeatures\x12%\n" +
	"\x0eoutput_feature\x18\x02 \x01(\tR\routputFeature\"\xd8\t\n" +
	"\n" +
	"NamedQuery\x12\x12\n" +
	...
	"\x17valid_plan_not_required\x18\x0f \x01(\bH\x05R\x14validPlanNotRequired\x88\x01\x01\x12W\n" +
	"\x0fresource_groups\x18\x10 \x03(\v2..chalk.graph.v1.NamedQuery.ResourceGroupsEntryR\x0eresourceGroups\x1a7\n" +
	"\tMetaEntry\x12\x10\n" +
	...
	"\x03key\x18\x01 \x01(\tR\x03key\x12>\n" +
	"\x05value\x18\x02 \x01(\v2(.chalk.graph.v1.NamedQueryResourceGroupsR\x05value:\x028\x01B\x10\n" +
	"\x0e_query_versionB\x0e\n" +
	"\f_descriptionB\b\n" +
	"\x06_ownerB\x10\n" +
	"\x0e_deployment_idB\x18\n" +
	"\x16_source_file_referenceB\x1a\n" +
	"\x18_valid_plan_not_required\"2\n" +
	"\x18NamedQueryResourceGroups\x12\x16\n" +
	"\x06groups\x18\x01 \x03(\tR\x06groups\"\xf7\x03\n" +
	"\n" +
	"FeatureSet\x12\x12\n" +
	...
	"\x13auxiliary_namespace\x18\a \x01(\tH\x00R\x12auxiliaryNamespace\x88\x01\x01\x12\x1d\n" +
	"\n" +
	...
	"\vaggregation\x18\x04 \x01(\tR\vaggregation\x12L\n" +
	"\faggregate_on\x18\x05 \x01(\v2 .chalk.graph.v1.FeatureReferenceB\x02\x18\x01H\x00R\vaggregateOn\x88\x01\x01\x128\n" +
	"\n" +
	...
	"\x13deduplication_stage\x18\x03 \x01(\x0e2+.chalk.graph.v1.StreamingDeduplicationStageR\x12deduplicationStage\"\xbc\x04\n" +
	"\tParseInfo\x12H\n" +
	...
	"\x16deduplication_strategy\x18\x1b \x01(\v2%.chalk.graph.v1.DeduplicationStrategyH\x06R\x15deduplicationStrategy\x88\x01\x01\x122\n" +
	"\x15customer_metrics_tags\x18\x1c \x03(\tR\x13customerMetricsTags\x12:\n" +
	"\x19excluded_aggregation_fqns\x18\x1d \x03(\tR\x17excludedAggregationFqns\x12=\n" +
	"\vsource_full\x18\x1e \x01(\v2\x1c.chalk.graph.v2.StreamSourceR\n" +
	"sourceFull\x1ah\n" +
	...
	"\vmessage_key\x18\x05 \x01(\tH\x01R\n" +
	"messageKey\x88\x01\x01\x12C\n" +
	"\fsend_to_full\x18\x06 \x01(\v2\x1c.chalk.graph.v2.StreamSourceH\x02R\n" +
	"sendToFull\x88\x01\x01\x1ae\n" +
	...
	"\x05proto\x18\v \x01(\v2+.chalk.graph.v1.FunctionGlobalCapturedProtoH\x00R\x05proto\x12M\n" +
	"\tvalue_ref\x18\f \x01(\v2..chalk.graph.v1.FunctionGlobalCapturedValueRefH\x00R\bvalueRef\x12S\n" +
	...
	"\a_module\"0\n" +
	"\x1eFunctionGlobalCapturedValueRef\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\"l\n" +
	"\x13CapturedGlobalValue\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12E\n" +
	"\x05value\x18\x02 \x01(\v2/.chalk.graph.v1.FunctionReferenceCapturedGlobalR\x05value\"\xd5\x01\n" +
	...
	"\x17ACCELERATE_PYTHON_NEVER\x10\x03*\xb1\x01\n" +
	"\x1bStreamingDeduplicationStage\x12-\n" +
	")STREAMING_DEDUPLICATION_STAGE_UNSPECIFIED\x10\x00\x120\n" +
	",STREAMING_DEDUPLICATION_STAGE_PARSED_MESSAGE\x10\x01\x121\n" +
	"-STREAMING_DEDUPLICATION_STAGE_OUTPUT_FEATURES\x10\x02*\x8a\x01\n" +
...
var file_chalk_graph_v1_graph_proto_msgTypes = make([]protoimpl.MessageInfo, 82)
var file_chalk_graph_v1_graph_proto_goTypes = []any{
	...
	(*NamedQueryResourceGroups)(nil),            // 17: chalk.graph.v1.NamedQueryResourceGroups
	(*FeatureSet)(nil),                          // 18: chalk.graph.v1.FeatureSet
	(*FeatureType)(nil),                         // 19: chalk.graph.v1.FeatureType
	(*FeatureReference)(nil),                    // 20: chalk.graph.v1.FeatureReference
	(*DataFrameType)(nil),                       // 21: chalk.graph.v1.DataFrameType
	(*GroupByFeatureType)(nil),                  // 22: chalk.graph.v1.GroupByFeatureType
	(*ScalarFeatureType)(nil),                   // 23: chalk.graph.v1.ScalarFeatureType
	(*HasOneFeatureType)(nil),                   // 24: chalk.graph.v1.HasOneFeatureType
	(*HasManyFeatureType)(nil),                  // 25: chalk.graph.v1.HasManyFeatureType
	(*FeatureTimeFeatureType)(nil),              // 26: chalk.graph.v1.FeatureTimeFeatureType
	(*WindowedFeatureType)(nil),                 // 27: chalk.graph.v1.WindowedFeatureType
	(*WindowAggregation)(nil),                   // 28: chalk.graph.v1.WindowAggregation
	(*BackfillTagSet)(nil),                      // 29: chalk.graph.v1.BackfillTagSet
	(*WindowInfo)(nil),                          // 30: chalk.graph.v1.WindowInfo
	(*FeatureInput)(nil),                        // 31: chalk.graph.v1.FeatureInput
	(*ResolverInput)(nil),                       // 32: chalk.graph.v1.ResolverInput
	(*ResolverOutput)(nil),                      // 33: chalk.graph.v1.ResolverOutput
	(*ResolverAsSymbolicValue)(nil),             // 34: chalk.graph.v1.ResolverAsSymbolicValue
	(*ResolverSymbolicValueOutputs)(nil),        // 35: chalk.graph.v1.ResolverSymbolicValueOutputs
	(*ResolverOutputSymbolicValue)(nil),         // 36: chalk.graph.v1.ResolverOutputSymbolicValue
	(*ConversionError)(nil),                     // 37: chalk.graph.v1.ConversionError
	(*Resolver)(nil),                            // 38: chalk.graph.v1.Resolver
	(*SinkResolver)(nil),                        // 39: chalk.graph.v1.SinkResolver
	(*DeduplicationStrategy)(nil),               // 40: chalk.graph.v1.DeduplicationStrategy
	(*ParseInfo)(nil),                           // 41: chalk.graph.v1.ParseInfo
	(*FeatureExpression)(nil),                   // 42: chalk.graph.v1.FeatureExpression
	(*StreamResolver)(nil),                      // 43: chalk.graph.v1.StreamResolver
	(*StreamMessageHeaderEqualityCheck)(nil),    // 44: chalk.graph.v1.StreamMessageHeaderEqualityCheck
	(*StreamHeaderFilter)(nil),                  // 45: chalk.graph.v1.StreamHeaderFilter
	(*StreamResolverMessageProducerParsed)(nil), // 46: chalk.graph.v1.StreamResolverMessageProducerParsed
	(*ResolverState)(nil),                       // 47: chalk.graph.v1.ResolverState
	(*StreamResolverParam)(nil),                 // 48: chalk.graph.v1.StreamResolverParam
	(*StreamResolverParamMessageWindow)(nil),    // 49: chalk.graph.v1.StreamResolverParamMessageWindow
	(*StreamResolverParamMessage)(nil),          // 50: chalk.graph.v1.StreamResolverParamMessage
	(*FunctionReference)(nil),                   // 51: chalk.graph.v1.FunctionReference
	(*FunctionReferenceCapturedGlobal)(nil),     // 52: chalk.graph.v1.FunctionReferenceCapturedGlobal
	(*FunctionGlobalCapturedBuiltin)(nil),       // 53: chalk.graph.v1.FunctionGlobalCapturedBuiltin
	(*FunctionGlobalCapturedVariable)(nil),      // 54: chalk.graph.v1.FunctionGlobalCapturedVariable
	(*FunctionGlobalCapturedStruct)(nil),        // 55: chalk.graph.v1.FunctionGlobalCapturedStruct
	(*FunctionGlobalCapturedEnum)(nil),          // 56: chalk.graph.v1.FunctionGlobalCapturedEnum
	(*FunctionGlobalCapturedFeatureClass)(nil),  // 57: chalk.graph.v1.FunctionGlobalCapturedFeatureClass
	(*FunctionGlobalCapturedModule)(nil),        // 58: chalk.graph.v1.FunctionGlobalCapturedModule
	(*FunctionGlobalCapturedModuleMember)(nil),  // 59: chalk.graph.v1.FunctionGlobalCapturedModuleMember
	(*FunctionGlobalCapturedFunction)(nil),      // 60: chalk.graph.v1.FunctionGlobalCapturedFunction
	(*FunctionGlobalCapturedValueRef)(nil),      // 61: chalk.graph.v1.FunctionGlobalCapturedValueRef
	(*CapturedGlobalValue)(nil),                 // 62: chalk.graph.v1.CapturedGlobalValue
	(*FunctionGlobalCapturedProto)(nil),         // 63: chalk.graph.v1.FunctionGlobalCapturedProto
	(*SourceFileReference)(nil),                 // 64: chalk.graph.v1.SourceFileReference
	(*StreamKey)(nil),                           // 65: chalk.graph.v1.StreamKey
	(*SQLResolverSettings)(nil),                 // 66: chalk.graph.v1.SQLResolverSettings
	(*IncrementalSettings)(nil),                 // 67: chalk.graph.v1.IncrementalSettings
	(*SQLResolverCommentDict)(nil),              // 68: chalk.graph.v1.SQLResolverCommentDict
	(*SQLResolverInfo)(nil),                     // 69: chalk.graph.v1.SQLResolverInfo
	(*CronFilterWithFeatureArgs)(nil),           // 70: chalk.graph.v1.CronFilterWithFeatureArgs
	(*Schedule)(nil),                            // 71: chalk.graph.v1.Schedule
	(*FeatureValidation)(nil),                   // 72: chalk.graph.v1.FeatureValidation
	(*VersionInfo)(nil),                         // 73: chalk.graph.v1.VersionInfo
	(*StrictValidation)(nil),                    // 74: chalk.graph.v1.StrictValidation
	(*FeatureEncoder)(nil),                      // 75: chalk.graph.v1.FeatureEncoder
	(*FeatureDecoder)(nil),                      // 76: chalk.graph.v1.FeatureDecoder
	(*RichClassType)(nil),                       // 77: chalk.graph.v1.RichClassType
	(*FeatureRichType)(nil),                     // 78: chalk.graph.v1.FeatureRichType
	(*FeatureRichTypeInfo)(nil),                 // 79: chalk.graph.v1.FeatureRichTypeInfo
	(*LRUCacheConfig)(nil),                      // 80: chalk.graph.v1.LRUCacheConfig
	(*OnlineStoreConfig)(nil),                   // 81: chalk.graph.v1.OnlineStoreConfig
	nil,                                         // 82: chalk.graph.v1.NamedQuery.MetaEntry
	nil,                                         // 83: chalk.graph.v1.NamedQuery.StalenessEntry
	nil,                                         // 84: chalk.graph.v1.NamedQuery.PlannerOptionsEntry
	nil,                                         // 85: chalk.graph.v1.NamedQuery.ResourceGroupsEntry
	nil,                                         // 86: chalk.graph.v1.StreamResolver.FeatureExpressionsEntry
	nil,                                         // 87: chalk.graph.v1.StreamResolverMessageProducerParsed.TransformationsEntry
	nil,                                         // 88: chalk.graph.v1.FunctionGlobalCapturedEnum.MemberMapEntry
	nil,                                         // 89: chalk.graph.v1.SQLResolverSettings.FieldsRootFqnEntry
	nil,                                         // 90: chalk.graph.v1.SQLResolverSettings.EscapedParamNameToFqnEntry
	nil,                                         // 91: chalk.graph.v1.SQLResolverSettings.FieldTypesEntry
	nil,                                         // 92: chalk.graph.v1.SQLResolverCommentDict.FieldsEntry
	(*DatabaseSource)(nil),                      // 93: chalk.graph.v1.DatabaseSource
	(*StreamSource)(nil),                        // 94: chalk.graph.v1.StreamSource
	(*v2.DatabaseSource)(nil),                   // 95: chalk.graph.v2.DatabaseSource
	(*v2.DatabaseSourceGroup)(nil),              // 96: chalk.graph.v2.DatabaseSourceGroup
	(*v2.StreamSource)(nil),                     // 97: chalk.graph.v2.StreamSource
	(*v1.SymbolicValue)(nil),                    // 98: chalk.symbolic_value.v1.SymbolicValue
	(*durationpb.Duration)(nil),                 // 99: google.protobuf.Duration
	(*timestamppb.Timestamp)(nil),               // 100: google.protobuf.Timestamp
	(*v11.LogicalExprNode)(nil),                 // 101: chalk.expression.v1.LogicalExprNode
	(*v12.ArrowType)(nil),                       // 102: chalk.arrow.v1.ArrowType
	(*v12.ScalarValue)(nil),                     // 103: chalk.arrow.v1.ScalarValue
	(*v13.Location)(nil),                        // 104: chalk.lsp.v1.Location
	(*DatabaseSourceReference)(nil),             // 105: chalk.graph.v1.DatabaseSourceReference
	(*v2.DatabaseSourceReference)(nil),          // 106: chalk.graph.v2.DatabaseSourceReference
	(*v14.DataFramePlan)(nil),                   // 107: chalk.dataframe.v1.DataFramePlan
	(*StreamSourceReference)(nil),               // 108: chalk.graph.v1.StreamSourceReference
	(*v2.StreamSourceReference)(nil),            // 109: chalk.graph.v2.StreamSourceReference
	(*emptypb.Empty)(nil),                       // 110: google.protobuf.Empty
	(*v13.Range)(nil),                           // 111: chalk.lsp.v1.Range
}
var file_chalk_graph_v1_graph_proto_depIdxs = []int32{
	18,  // 0: chalk.graph.v1.Graph.feature_sets:type_name -> chalk.graph.v1.FeatureSet
	38,  // 1: chalk.graph.v1.Graph.resolvers:type_name -> chalk.graph.v1.Resolver
	43,  // 2: chalk.graph.v1.Graph.stream_resolvers:type_name -> chalk.graph.v1.StreamResolver
	39,  // 3: chalk.graph.v1.Graph.sink_resolvers:type_name -> chalk.graph.v1.SinkResolver
	93,  // 4: chalk.graph.v1.Graph.database_sources:type_name -> chalk.graph.v1.DatabaseSource
	94,  // 5: chalk.graph.v1.Graph.stream_sources:type_name -> chalk.graph.v1.StreamSource
	16,  // 6: chalk.graph.v1.Graph.named_queries:type_name -> chalk.graph.v1.NamedQuery
	95,  // 7: chalk.graph.v1.Graph.database_sources_v2:type_name -> chalk.graph.v2.DatabaseSource
	96,  // 8: chalk.graph.v1.Graph.database_source_groups:type_name -> chalk.graph.v2.DatabaseSourceGroup
	97,  // 9: chalk.graph.v1.Graph.stream_sources_v2:type_name -> chalk.graph.v2.StreamSource
	14,  // 10: chalk.graph.v1.Graph.model_references:type_name -> chalk.graph.v1.ModelReference
	81,  // 11: chalk.graph.v1.Graph.online_store_configs:type_name -> chalk.graph.v1.OnlineStoreConfig
	62,  // 12: chalk.graph.v1.Graph.captured_global_values:type_name -> chalk.graph.v1.CapturedGlobalValue
	98,  // 13: chalk.graph.v1.Graph.symbolic_value_explicits:type_name -> chalk.symbolic_value.v1.SymbolicValue
	12,  // 14: chalk.graph.v1.Graph.materialized_feature_views:type_name -> chalk.graph.v1.MaterializedFeatureView
	99,  // 15: chalk.graph.v1.MaterializedFeatureView.time_resolution:type_name -> google.protobuf.Duration
	100, // 16: chalk.graph.v1.MaterializedFeatureView.lower_bound:type_name -> google.protobuf.Timestamp
	99,  // 17: chalk.graph.v1.MaterializedFeatureView.lookback_retention_period:type_name -> google.protobuf.Duration
	64,  // 18: chalk.graph.v1.MaterializedFeatureView.source_file_reference:type_name -> chalk.graph.v1.SourceFileReference
	...
	18,  // 20: chalk.graph.v1.OverlayGraph.feature_sets:type_name -> chalk.graph.v1.FeatureSet
	19,  // 21: chalk.graph.v1.OverlayGraph.feature_fields:type_name -> chalk.graph.v1.FeatureType
	38,  // 22: chalk.graph.v1.OverlayGraph.resolvers:type_name -> chalk.graph.v1.Resolver
	69,  // 23: chalk.graph.v1.OverlayGraph.generated_sql_resolvers:type_name -> chalk.graph.v1.SQLResolverInfo
	62,  // 24: chalk.graph.v1.OverlayGraph.captured_global_values:type_name -> chalk.graph.v1.CapturedGlobalValue
	100, // 25: chalk.graph.v1.ModelReference.as_of:type_name -> google.protobuf.Timestamp
	64,  // 26: chalk.graph.v1.ModelReference.source_file_reference:type_name -> chalk.graph.v1.SourceFileReference
	15,  // 27: chalk.graph.v1.ModelReference.relations:type_name -> chalk.graph.v1.ModelRelation
	82,  // 28: chalk.graph.v1.NamedQuery.meta:type_name -> chalk.graph.v1.NamedQuery.MetaEntry
	83,  // 29: chalk.graph.v1.NamedQuery.staleness:type_name -> chalk.graph.v1.NamedQuery.StalenessEntry
	84,  // 30: chalk.graph.v1.NamedQuery.planner_options:type_name -> chalk.graph.v1.NamedQuery.PlannerOptionsEntry
	64,  // 31: chalk.graph.v1.NamedQuery.source_file_reference:type_name -> chalk.graph.v1.SourceFileReference
	85,  // 32: chalk.graph.v1.NamedQuery.resource_groups:type_name -> chalk.graph.v1.NamedQuery.ResourceGroupsEntry
	19,  // 33: chalk.graph.v1.FeatureSet.features:type_name -> chalk.graph.v1.FeatureType
	99,  // 34: chalk.graph.v1.FeatureSet.max_staleness_duration:type_name -> google.protobuf.Duration
	23,  // 35: chalk.graph.v1.FeatureType.scalar:type_name -> chalk.graph.v1.ScalarFeatureType
	24,  // 36: chalk.graph.v1.FeatureType.has_one:type_name -> chalk.graph.v1.HasOneFeatureType
	25,  // 37: chalk.graph.v1.FeatureType.has_many:type_name -> chalk.graph.v1.HasManyFeatureType
	26,  // 38: chalk.graph.v1.FeatureType.feature_time:type_name -> chalk.graph.v1.FeatureTimeFeatureType
	27,  // 39: chalk.graph.v1.FeatureType.windowed:type_name -> chalk.graph.v1.WindowedFeatureType
	22,  // 40: chalk.graph.v1.FeatureType.group_by:type_name -> chalk.graph.v1.GroupByFeatureType
	20,  // 41: chalk.graph.v1.FeatureReference.path:type_name -> chalk.graph.v1.FeatureReference
	21,  // 42: chalk.graph.v1.FeatureReference.df:type_name -> chalk.graph.v1.DataFrameType
	20,  // 43: chalk.graph.v1.DataFrameType.required_columns:type_name -> chalk.graph.v1.FeatureReference
	20,  // 44: chalk.graph.v1.DataFrameType.optional_columns:type_name -> chalk.graph.v1.FeatureReference
	101, // 45: chalk.graph.v1.DataFrameType.filter:type_name -> chalk.expression.v1.LogicalExprNode
	102, // 46: chalk.graph.v1.GroupByFeatureType.arrow_type:type_name -> chalk.arrow.v1.ArrowType
	28,  // 47: chalk.graph.v1.GroupByFeatureType.aggregation:type_name -> chalk.graph.v1.WindowAggregation
	99,  // 48: chalk.graph.v1.GroupByFeatureType.window_durations:type_name -> google.protobuf.Duration
	101, // 49: chalk.graph.v1.GroupByFeatureType.expression:type_name -> chalk.expression.v1.LogicalExprNode
	103, // 50: chalk.graph.v1.GroupByFeatureType.default_value:type_name -> chalk.arrow.v1.ScalarValue
	72,  // 51: chalk.graph.v1.GroupByFeatureType.validations:type_name -> chalk.graph.v1.FeatureValidation
	99,  // 52: chalk.graph.v1.ScalarFeatureType.max_staleness_duration:type_name -> google.protobuf.Duration
	99,  // 53: chalk.graph.v1.ScalarFeatureType.offline_ttl_duration:type_name -> google.protobuf.Duration
	102, // 54: chalk.graph.v1.ScalarFeatureType.arrow_type:type_name -> chalk.arrow.v1.ArrowType
	73,  // 55: chalk.graph.v1.ScalarFeatureType.version:type_name -> chalk.graph.v1.VersionInfo
	30,  // 56: chalk.graph.v1.ScalarFeatureType.window_info:type_name -> chalk.graph.v1.WindowInfo
	103, // 57: chalk.graph.v1.ScalarFeatureType.default_value:type_name -> chalk.arrow.v1.ScalarValue
	101, // 58: chalk.graph.v1.ScalarFeatureType.expression:type_name -> chalk.expression.v1.LogicalExprNode
	72,  // 59: chalk.graph.v1.ScalarFeatureType.validations:type_name -> chalk.graph.v1.FeatureValidation
	20,  // 60: chalk.graph.v1.ScalarFeatureType.last_for:type_name -> chalk.graph.v1.FeatureReference
	1,   // 61: chalk.graph.v1.ScalarFeatureType.cache_strategy:type_name -> chalk.graph.v1.CacheStrategy
	79,  // 62: chalk.graph.v1.ScalarFeatureType.rich_type_info:type_name -> chalk.graph.v1.FeatureRichTypeInfo
	104, // 63: chalk.graph.v1.ScalarFeatureType.expression_definition_location:type_name -> chalk.lsp.v1.Location
	101, // 64: chalk.graph.v1.ScalarFeatureType.offline_expression:type_name -> chalk.expression.v1.LogicalExprNode
	101, // 65: chalk.graph.v1.HasOneFeatureType.join:type_name -> chalk.expression.v1.LogicalExprNode
	101, // 66: chalk.graph.v1.HasManyFeatureType.join:type_name -> chalk.expression.v1.LogicalExprNode
	99,  // 67: chalk.graph.v1.HasManyFeatureType.max_staleness_duration:type_name -> google.protobuf.Duration
	99,  // 68: chalk.graph.v1.WindowedFeatureType.window_durations:type_name -> google.protobuf.Duration
	73,  // 69: chalk.graph.v1.WindowedFeatureType.version:type_name -> chalk.graph.v1.VersionInfo
	20,  // 70: chalk.graph.v1.WindowAggregation.group_by:type_name -> chalk.graph.v1.FeatureReference
	99,  // 71: chalk.graph.v1.WindowAggregation.bucket_duration:type_name -> google.protobuf.Duration
	20,  // 72: chalk.graph.v1.WindowAggregation.aggregate_on:type_name -> chalk.graph.v1.FeatureReference
	102, // 73: chalk.graph.v1.WindowAggregation.arrow_type:type_name -> chalk.arrow.v1.ArrowType
	101, // 74: chalk.graph.v1.WindowAggregation.filters:type_name -> chalk.expression.v1.LogicalExprNode
	99,  // 75: chalk.graph.v1.WindowAggregation.backfill_lookback_duration:type_name -> google.protobuf.Duration
	100, // 76: chalk.graph.v1.WindowAggregation.backfill_start_time:type_name -> google.protobuf.Timestamp
	99,  // 77: chalk.graph.v1.WindowAggregation.continuous_buffer_duration:type_name -> google.protobuf.Duration
	100, // 78: chalk.graph.v1.WindowAggregation.bucket_start:type_name -> google.protobuf.Timestamp
	29,  // 79: chalk.graph.v1.WindowAggregation.backfill_tag_sets:type_name -> chalk.graph.v1.BackfillTagSet
	20,  // 80: chalk.graph.v1.WindowAggregation.aggregate_on_features:type_name -> chalk.graph.v1.FeatureReference
	101, // 81: chalk.graph.v1.WindowAggregation.aggregate_on_expressions:type_name -> chalk.expression.v1.LogicalExprNode
	101, // 82: chalk.graph.v1.WindowAggregation.fold_step:type_name -> chalk.expression.v1.LogicalExprNode
	101, // 83: chalk.graph.v1.WindowAggregation.fold_initial_value:type_name -> chalk.expression.v1.LogicalExprNode
	99,  // 84: chalk.graph.v1.WindowInfo.duration:type_name -> google.protobuf.Duration
	28,  // 85: chalk.graph.v1.WindowInfo.aggregation:type_name -> chalk.graph.v1.WindowAggregation
	20,  // 86: chalk.graph.v1.FeatureInput.feature:type_name -> chalk.graph.v1.FeatureReference
	103, // 87: chalk.graph.v1.FeatureInput.default_value:type_name -> chalk.arrow.v1.ScalarValue
	31,  // 88: chalk.graph.v1.ResolverInput.feature:type_name -> chalk.graph.v1.FeatureInput
	21,  // 89: chalk.graph.v1.ResolverInput.df:type_name -> chalk.graph.v1.DataFrameType
	47,  // 90: chalk.graph.v1.ResolverInput.state:type_name -> chalk.graph.v1.ResolverState
	20,  // 91: chalk.graph.v1.ResolverOutput.feature:type_name -> chalk.graph.v1.FeatureReference
	21,  // 92: chalk.graph.v1.ResolverOutput.df:type_name -> chalk.graph.v1.DataFrameType
	35,  // 93: chalk.graph.v1.ResolverAsSymbolicValue.success:type_name -> chalk.graph.v1.ResolverSymbolicValueOutputs
	37,  // 94: chalk.graph.v1.ResolverAsSymbolicValue.failure:type_name -> chalk.graph.v1.ConversionError
	36,  // 95: chalk.graph.v1.ResolverSymbolicValueOutputs.outputs:type_name -> chalk.graph.v1.ResolverOutputSymbolicValue
	98,  // 96: chalk.graph.v1.ResolverOutputSymbolicValue.root_ref:type_name -> chalk.symbolic_value.v1.SymbolicValue
	5,   // 97: chalk.graph.v1.Resolver.kind:type_name -> chalk.graph.v1.ResolverKind
	32,  // 98: chalk.graph.v1.Resolver.inputs:type_name -> chalk.graph.v1.ResolverInput
	33,  // 99: chalk.graph.v1.Resolver.outputs:type_name -> chalk.graph.v1.ResolverOutput
	105, // 100: chalk.graph.v1.Resolver.data_sources:type_name -> chalk.graph.v1.DatabaseSourceReference
	99,  // 101: chalk.graph.v1.Resolver.timeout_duration:type_name -> google.protobuf.Duration
	71,  // 102: chalk.graph.v1.Resolver.schedule:type_name -> chalk.graph.v1.Schedule
	101, // 103: chalk.graph.v1.Resolver.when:type_name -> chalk.expression.v1.LogicalExprNode
	70,  // 104: chalk.graph.v1.Resolver.cron_filter:type_name -> chalk.graph.v1.CronFilterWithFeatureArgs
	51,  // 105: chalk.graph.v1.Resolver.function:type_name -> chalk.graph.v1.FunctionReference
	6,   // 106: chalk.graph.v1.Resolver.resource_hint:type_name -> chalk.graph.v1.ResourceHint
	2,   // 107: chalk.graph.v1.Resolver.accelerate_python:type_name -> chalk.graph.v1.AcceleratePython
	34,  // 108: chalk.graph.v1.Resolver.converted:type_name -> chalk.graph.v1.ResolverAsSymbolicValue
	106, // 109: chalk.graph.v1.Resolver.data_sources_v2:type_name -> chalk.graph.v2.DatabaseSourceReference
	101, // 110: chalk.graph.v1.Resolver.static_operation:type_name -> chalk.expression.v1.LogicalExprNode
	107, // 111: chalk.graph.v1.Resolver.static_operation_dataframe:type_name -> chalk.dataframe.v1.DataFramePlan
	66,  // 112: chalk.graph.v1.Resolver.sql_settings:type_name -> chalk.graph.v1.SQLResolverSettings
	67,  // 113: chalk.graph.v1.Resolver.incremental_settings:type_name -> chalk.graph.v1.IncrementalSettings
	101, // 114: chalk.graph.v1.Resolver.underscore_expr:type_name -> chalk.expression.v1.LogicalExprNode
	101, // 115: chalk.graph.v1.Resolver.lazyframe_expr:type_name -> chalk.expression.v1.LogicalExprNode
	32,  // 116: chalk.graph.v1.SinkResolver.inputs:type_name -> chalk.graph.v1.ResolverInput
	99,  // 117: chalk.graph.v1.SinkResolver.debounce_duration:type_name -> google.protobuf.Duration
	99,  // 118: chalk.graph.v1.SinkResolver.max_delay_duration:type_name -> google.protobuf.Duration
	108, // 119: chalk.graph.v1.SinkResolver.stream_source:type_name -> chalk.graph.v1.StreamSourceReference
	105, // 120: chalk.graph.v1.SinkResolver.database_source:type_name -> chalk.graph.v1.DatabaseSourceReference
	109, // 121: chalk.graph.v1.SinkResolver.stream_source_v2:type_name -> chalk.graph.v2.StreamSourceReference
	106, // 122: chalk.graph.v1.SinkResolver.database_source_v2:type_name -> chalk.graph.v2.DatabaseSourceReference
	99,  // 123: chalk.graph.v1.SinkResolver.timeout_duration:type_name -> google.protobuf.Duration
	51,  // 124: chalk.graph.v1.SinkResolver.function:type_name -> chalk.graph.v1.FunctionReference
	101, // 125: chalk.graph.v1.DeduplicationStrategy.underscore_expr:type_name -> chalk.expression.v1.LogicalExprNode
	99,  // 126: chalk.graph.v1.DeduplicationStrategy.window:type_name -> google.protobuf.Duration
	3,   // 127: chalk.graph.v1.DeduplicationStrategy.deduplication_stage:type_name -> chalk.graph.v1.StreamingDeduplicationStage
	51,  // 128: chalk.graph.v1.ParseInfo.parse_function:type_name -> chalk.graph.v1.FunctionReference
	102, // 129: chalk.graph.v1.ParseInfo.parse_function_input_type:type_name -> chalk.arrow.v1.ArrowType
	102, // 130: chalk.graph.v1.ParseInfo.parse_function_output_type:type_name -> chalk.arrow.v1.ArrowType
	101, // 131: chalk.graph.v1.ParseInfo.underscore_expr:type_name -> chalk.expression.v1.LogicalExprNode
	101, // 132: chalk.graph.v1.FeatureExpression.underscore_expr:type_name -> chalk.expression.v1.LogicalExprNode
	48,  // 133: chalk.graph.v1.StreamResolver.params:type_name -> chalk.graph.v1.StreamResolverParam
	33,  // 134: chalk.graph.v1.StreamResolver.outputs:type_name -> chalk.graph.v1.ResolverOutput
	102, // 135: chalk.graph.v1.StreamResolver.explicit_schema:type_name -> chalk.arrow.v1.ArrowType
	65,  // 136: chalk.graph.v1.StreamResolver.keys:type_name -> chalk.graph.v1.StreamKey
	108, // 137: chalk.graph.v1.StreamResolver.source:type_name -> chalk.graph.v1.StreamSourceReference
	41,  // 138: chalk.graph.v1.StreamResolver.parse_info:type_name -> chalk.graph.v1.ParseInfo
	10,  // 139: chalk.graph.v1.StreamResolver.mode:type_name -> chalk.graph.v1.WindowMode
	99,  // 140: chalk.graph.v1.StreamResolver.timeout_duration:type_name -> google.protobuf.Duration
	51,  // 141: chalk.graph.v1.StreamResolver.function:type_name -> chalk.graph.v1.FunctionReference
	109, // 142: chalk.graph.v1.StreamResolver.source_v2:type_name -> chalk.graph.v2.StreamSourceReference
	86,  // 143: chalk.graph.v1.StreamResolver.feature_expressions:type_name -> chalk.graph.v1.StreamResolver.FeatureExpressionsEntry
	46,  // 144: chalk.graph.v1.StreamResolver.message_producer:type_name -> chalk.graph.v1.StreamResolverMessageProducerParsed
	4,   // 145: chalk.graph.v1.StreamResolver.message_format:type_name -> chalk.graph.v1.StreamMessageFormat
	45,  // 146: chalk.graph.v1.StreamResolver.header_filters:type_name -> chalk.graph.v1.StreamHeaderFilter
	40,  // 147: chalk.graph.v1.StreamResolver.deduplication_strategy:type_name -> chalk.graph.v1.DeduplicationStrategy
	97,  // 148: chalk.graph.v1.StreamResolver.source_full:type_name -> chalk.graph.v2.StreamSource
	44,  // 149: chalk.graph.v1.StreamHeaderFilter.equality_check:type_name -> chalk.graph.v1.StreamMessageHeaderEqualityCheck
	109, // 150: chalk.graph.v1.StreamResolverMessageProducerParsed.send_to:type_name -> chalk.graph.v2.StreamSourceReference
	87,  // 151: chalk.graph.v1.StreamResolverMessageProducerParsed.transformations:type_name -> chalk.graph.v1.StreamResolverMessageProducerParsed.TransformationsEntry
	97,  // 152: chalk.graph.v1.StreamResolverMessageProducerParsed.send_to_full:type_name -> chalk.graph.v2.StreamSource
	103, // 153: chalk.graph.v1.ResolverState.initial:type_name -> chalk.arrow.v1.ScalarValue
	102, // 154: chalk.graph.v1.ResolverState.arrow_type:type_name -> chalk.arrow.v1.ArrowType
	50,  // 155: chalk.graph.v1.StreamResolverParam.message:type_name -> chalk.graph.v1.StreamResolverParamMessage
	49,  // 156: chalk.graph.v1.StreamResolverParam.message_window:type_name -> chalk.graph.v1.StreamResolverParamMessageWindow
	47,  // 157: chalk.graph.v1.StreamResolverParam.state:type_name -> chalk.graph.v1.ResolverState
	102, // 158: chalk.graph.v1.StreamResolverParamMessageWindow.arrow_type:type_name -> chalk.arrow.v1.ArrowType
	102, // 159: chalk.graph.v1.StreamResolverParamMessage.arrow_type:type_name -> chalk.arrow.v1.ArrowType
	110, // 160: chalk.graph.v1.StreamResolverParamMessage.empty:type_name -> google.protobuf.Empty
	55,  // 161: chalk.graph.v1.StreamResolverParamMessage.struct:type_name -> chalk.graph.v1.FunctionGlobalCapturedStruct
	63,  // 162: chalk.graph.v1.StreamResolverParamMessage.proto:type_name -> chalk.graph.v1.FunctionGlobalCapturedProto
	52,  // 163: chalk.graph.v1.FunctionReference.captured_globals:type_name -> chalk.graph.v1.FunctionReferenceCapturedGlobal
	53,  // 164: chalk.graph.v1.FunctionReferenceCapturedGlobal.builtin:type_name -> chalk.graph.v1.FunctionGlobalCapturedBuiltin
	57,  // 165: chalk.graph.v1.FunctionReferenceCapturedGlobal.feature_class:type_name -> chalk.graph.v1.FunctionGlobalCapturedFeatureClass
	56,  // 166: chalk.graph.v1.FunctionReferenceCapturedGlobal.enum:type_name -> chalk.graph.v1.FunctionGlobalCapturedEnum
	58,  // 167: chalk.graph.v1.FunctionReferenceCapturedGlobal.module:type_name -> chalk.graph.v1.FunctionGlobalCapturedModule
	59,  // 168: chalk.graph.v1.FunctionReferenceCapturedGlobal.module_member:type_name -> chalk.graph.v1.FunctionGlobalCapturedModuleMember
	60,  // 169: chalk.graph.v1.FunctionReferenceCapturedGlobal.function:type_name -> chalk.graph.v1.FunctionGlobalCapturedFunction
	55,  // 170: chalk.graph.v1.FunctionReferenceCapturedGlobal.struct:type_name -> chalk.graph.v1.FunctionGlobalCapturedStruct
	54,  // 171: chalk.graph.v1.FunctionReferenceCapturedGlobal.variable:type_name -> chalk.graph.v1.FunctionGlobalCapturedVariable
	63,  // 172: chalk.graph.v1.FunctionReferenceCapturedGlobal.proto:type_name -> chalk.graph.v1.FunctionGlobalCapturedProto
	61,  // 173: chalk.graph.v1.FunctionReferenceCapturedGlobal.value_ref:type_name -> chalk.graph.v1.FunctionGlobalCapturedValueRef
	64,  // 174: chalk.graph.v1.FunctionReferenceCapturedGlobal.source_reference:type_name -> chalk.graph.v1.SourceFileReference
	102, // 175: chalk.graph.v1.FunctionGlobalCapturedStruct.pa_dtype:type_name -> chalk.arrow.v1.ArrowType
	88,  // 176: chalk.graph.v1.FunctionGlobalCapturedEnum.member_map:type_name -> chalk.graph.v1.FunctionGlobalCapturedEnum.MemberMapEntry
	102, // 177: chalk.graph.v1.FunctionGlobalCapturedEnum.bases:type_name -> chalk.arrow.v1.ArrowType
	52,  // 178: chalk.graph.v1.FunctionGlobalCapturedFunction.captured_globals:type_name -> chalk.graph.v1.FunctionReferenceCapturedGlobal
	52,  // 179: chalk.graph.v1.CapturedGlobalValue.value:type_name -> chalk.graph.v1.FunctionReferenceCapturedGlobal
	102, // 180: chalk.graph.v1.FunctionGlobalCapturedProto.pa_dtype:type_name -> chalk.arrow.v1.ArrowType
	111, // 181: chalk.graph.v1.SourceFileReference.range:type_name -> chalk.lsp.v1.Range
	20,  // 182: chalk.graph.v1.StreamKey.feature:type_name -> chalk.graph.v1.FeatureReference
	7,   // 183: chalk.graph.v1.SQLResolverSettings.finalizer:type_name -> chalk.graph.v1.Finalizer
	67,  // 184: chalk.graph.v1.SQLResolverSettings.incremental_settings:type_name -> chalk.graph.v1.IncrementalSettings
	89,  // 185: chalk.graph.v1.SQLResolverSettings.fields_root_fqn:type_name -> chalk.graph.v1.SQLResolverSettings.FieldsRootFqnEntry
	90,  // 186: chalk.graph.v1.SQLResolverSettings.escaped_param_name_to_fqn:type_name -> chalk.graph.v1.SQLResolverSettings.EscapedParamNameToFqnEntry
	91,  // 187: chalk.graph.v1.SQLResolverSettings.field_types:type_name -> chalk.graph.v1.SQLResolverSettings.FieldTypesEntry
	8,   // 188: chalk.graph.v1.IncrementalSettings.mode:type_name -> chalk.graph.v1.IncrementalMode
	99,  // 189: chalk.graph.v1.IncrementalSettings.lookback_period:type_name -> google.protobuf.Duration
	9,   // 190: chalk.graph.v1.IncrementalSettings.timestamp_mode:type_name -> chalk.graph.v1.IncrementalTimestampMode
	67,  // 191: chalk.graph.v1.SQLResolverCommentDict.incremental:type_name -> chalk.graph.v1.IncrementalSettings
	7,   // 192: chalk.graph.v1.SQLResolverCommentDict.count:type_name -> chalk.graph.v1.Finalizer
	71,  // 193: chalk.graph.v1.SQLResolverCommentDict.cron:type_name -> chalk.graph.v1.Schedule
	92,  // 194: chalk.graph.v1.SQLResolverCommentDict.fields:type_name -> chalk.graph.v1.SQLResolverCommentDict.FieldsEntry
	68,  // 195: chalk.graph.v1.SQLResolverInfo.override_comment_dict:type_name -> chalk.graph.v1.SQLResolverCommentDict
	51,  // 196: chalk.graph.v1.CronFilterWithFeatureArgs.filter:type_name -> chalk.graph.v1.FunctionReference
	20,  // 197: chalk.graph.v1.CronFilterWithFeatureArgs.args:type_name -> chalk.graph.v1.FeatureReference
	99,  // 198: chalk.graph.v1.Schedule.duration:type_name -> google.protobuf.Duration
	51,  // 199: chalk.graph.v1.Schedule.filter:type_name -> chalk.graph.v1.FunctionReference
	51,  // 200: chalk.graph.v1.Schedule.sample:type_name -> chalk.graph.v1.FunctionReference
	103, // 201: chalk.graph.v1.FeatureValidation.min_arrow:type_name -> chalk.arrow.v1.ScalarValue
	103, // 202: chalk.graph.v1.FeatureValidation.max_arrow:type_name -> chalk.arrow.v1.ScalarValue
	103, // 203: chalk.graph.v1.FeatureValidation.min_length_arrow:type_name -> chalk.arrow.v1.ScalarValue
	103, // 204: chalk.graph.v1.FeatureValidation.max_length_arrow:type_name -> chalk.arrow.v1.ScalarValue
	103, // 205: chalk.graph.v1.FeatureValidation.contains:type_name -> chalk.arrow.v1.ScalarValue
	20,  // 206: chalk.graph.v1.StrictValidation.feature:type_name -> chalk.graph.v1.FeatureReference
	72,  // 207: chalk.graph.v1.StrictValidation.validations:type_name -> chalk.graph.v1.FeatureValidation
	60,  // 208: chalk.graph.v1.FeatureEncoder.global_function_reference:type_name -> chalk.graph.v1.FunctionGlobalCapturedFunction
	60,  // 209: chalk.graph.v1.FeatureDecoder.global_function_reference:type_name -> chalk.graph.v1.FunctionGlobalCapturedFunction
	77,  // 210: chalk.graph.v1.RichClassType.params:type_name -> chalk.graph.v1.RichClassType
	77,  // 211: chalk.graph.v1.FeatureRichType.class_type:type_name -> chalk.graph.v1.RichClassType
	75,  // 212: chalk.graph.v1.FeatureRichTypeInfo.encoder:type_name -> chalk.graph.v1.FeatureEncoder
	76,  // 213: chalk.graph.v1.FeatureRichTypeInfo.decoder:type_name -> chalk.graph.v1.FeatureDecoder
	78,  // 214: chalk.graph.v1.FeatureRichTypeInfo.rich_type:type_name -> chalk.graph.v1.FeatureRichType
	99,  // 215: chalk.graph.v1.LRUCacheConfig.ttl:type_name -> google.protobuf.Duration
	80,  // 216: chalk.graph.v1.OnlineStoreConfig.lru_cache:type_name -> chalk.graph.v1.LRUCacheConfig
	64,  // 217: chalk.graph.v1.OnlineStoreConfig.source_file_reference:type_name -> chalk.graph.v1.SourceFileReference
	99,  // 218: chalk.graph.v1.NamedQuery.StalenessEntry.value:type_name -> google.protobuf.Duration
	17,  // 219: chalk.graph.v1.NamedQuery.ResourceGroupsEntry.value:type_name -> chalk.graph.v1.NamedQueryResourceGroups
	42,  // 220: chalk.graph.v1.StreamResolver.FeatureExpressionsEntry.value:type_name -> chalk.graph.v1.FeatureExpression
	42,  // 221: chalk.graph.v1.StreamResolverMessageProducerParsed.TransformationsEntry.value:type_name -> chalk.graph.v1.FeatureExpression
	103, // 222: chalk.graph.v1.FunctionGlobalCapturedEnum.MemberMapEntry.value:type_name -> chalk.arrow.v1.ScalarValue
...
func file_chalk_graph_v1_graph_proto_init() {
	...
	file_chalk_graph_v1_graph_proto_msgTypes[1].OneofWrappers = []any{}
	...
	file_chalk_graph_v1_graph_proto_msgTypes[68].OneofWrappers = []any{}
	file_chalk_graph_v1_graph_proto_msgTypes[70].OneofWrappers = []any{}
	type x struct{}
