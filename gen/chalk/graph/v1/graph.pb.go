...
const file_chalk_graph_v1_graph_proto_rawDesc = "" +
	...
	"\fsql_settings\x18\x18 \x01(\v2#.chalk.graph.v1.SQLResolverSettingsH\x04R\vsqlSettings\x88\x01\x01\x12*\n" +
	"\x0eresource_group\x18\x19 \x01(\tH\x05R\rresourceGroup\x88\x01\x01B\x0f\n" +
	"\r_machine_typeB\b\n" +
	"\x06_ownerB\x06\n" +
	"\x04_docB\v\n" +
	"\t_is_totalB\x0f\n" +
	"\r_sql_settingsB\x11\n" +
	"\x0f_resource_group\"\xc1\a\n" +
