...
const file_chalk_chart_v1_densetimeserieschart_proto_rawDesc = "" +
	"\n" +
	")chalk/chart/v1/densetimeserieschart.proto\x12\x0echalk.chart.v1\x1a\x1achalk/arrow/v1/arrow.proto\x1a\x1egoogle/protobuf/duration.proto\x1a\x1fgoogle/protobuf/timestamp.proto\"1\n" +
	"\n" +
	"DensePoint\x12\x19\n" +
	...
	"\n" +
	"group_tags\x18\x04 \x03(\v2\x18.chalk.chart.v1.GroupTagR\tgroupTags\"\xdc\x01\n" +
	"\x14DenseTimeSeriesChart\x12\x14\n" +
	"\x05title\x18\x01 \x01(\tR\x05title\x127\n" +
	"\x06series\x18\x02 \x03(\v2\x1f.chalk.chart.v1.DenseTimeSeriesR\x06series\x125\n" +
	"\bx_series\x18\x03 \x03(\v2\x1a.google.protobuf.TimestampR\axSeries\x12>\n" +
	"\rwindow_period\x18\x04 \x01(\v2\x19.google.protobuf.DurationR\fwindowPeriodB\xc2\x01\n" +
	"\x12com.chalk.chart.v1B\x19DensetimeserieschartProtoP\x01Z7github.com/chalk-ai/chalk-go/gen/chalk/chart/v1;chartv1\xa2\x02\x03CCX\xaa\x02\x0eChalk.Chart.V1\xca\x02\x0eChalk\\Chart\\V1\xe2\x02\x1aChalk\\Chart\\V1\\GPBMetadata\xea\x02\x10Chalk::Chart::V1b\x06proto3"

var (
	file_chalk_chart_v1_densetimeserieschart_proto_rawDescOnce sync.Once
	file_chalk_chart_v1_densetimeserieschart_proto_rawDescData []byte
)
...
func file_chalk_chart_v1_densetimeserieschart_proto_rawDescGZIP() []byte {
	file_chalk_chart_v1_densetimeserieschart_proto_rawDescOnce.Do(func() {
		file_chalk_chart_v1_densetimeserieschart_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_chalk_chart_v1_densetimeserieschart_proto_rawDesc), len(file_chalk_chart_v1_densetimeserieschart_proto_rawDesc)))
	})
...
func file_chalk_chart_v1_densetimeserieschart_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_chalk_chart_v1_densetimeserieschart_proto_rawDesc), len(file_chalk_chart_v1_densetimeserieschart_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   4,
			NumExtensions: 0,
			NumServices:   0,
