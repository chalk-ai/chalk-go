...
var file_chalk_lsp_v1_lsp_proto_goTypes = []interface{}{
...
func file_chalk_lsp_v1_lsp_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chalk_lsp_v1_lsp_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LSP); i {
			case 0:
				return &v.state
			case 1:
		...
		file_chalk_lsp_v1_lsp_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_lsp_v1_lsp_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_lsp_v1_lsp_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Range); i {
			case 0:
				return &v.state
			case 1:
		...
		file_chalk_lsp_v1_lsp_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_lsp_v1_lsp_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_lsp_v1_lsp_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_lsp_v1_lsp_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_lsp_v1_lsp_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_lsp_v1_lsp_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_lsp_v1_lsp_proto_msgTypes[10].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_lsp_v1_lsp_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_lsp_v1_lsp_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
	...
	file_chalk_lsp_v1_lsp_proto_msgTypes[2].OneofWrappers = []interface{}{}
	file_chalk_lsp_v1_lsp_proto_msgTypes[4].OneofWrappers = []interface{}{}
	type x struct{}
