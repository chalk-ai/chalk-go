		...
		},
		{
			...
			input: map[string]any{
				...
				"user.has_one": []omitHasOneRoot{
					{
						Id:  new("root_1"),
						Txn: &omitTxn{Id: new("txn_1"), Amount: new(100)},
					},
					{},
					{
						Id:  new("root_3"),
						Txn: &omitTxn{Id: new("txn_3")},
					},
				},
			},
		},
