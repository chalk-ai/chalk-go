...
import (
	...
	v1 "github.com/chalk-ai/chalk-go/internal/gen/chalk/graph/v1"
...
var file_chalk_server_v1_graph_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x03, 0x80, 0x7d, 0x0b, 0x42, 0xc3, 0x01, 0x0a, 0x13, 0x63, 0x6f,
...
var file_chalk_server_v1_graph_proto_goTypes = []interface{}{
...
func file_chalk_server_v1_graph_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_chalk_server_v1_graph_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_server_v1_graph_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_server_v1_graph_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_server_v1_graph_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_server_v1_graph_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_server_v1_graph_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_server_v1_graph_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_server_v1_graph_proto_msgTypes[7].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_server_v1_graph_proto_msgTypes[8].Exporter = func(v interface{}, i int) interface{} {
		...
		file_chalk_server_v1_graph_proto_msgTypes[9].Exporter = func(v interface{}, i int) interface{} {
	...
	file_chalk_server_v1_graph_proto_msgTypes[0].OneofWrappers = []interface{}{}
	file_chalk_server_v1_graph_proto_msgTypes[3].OneofWrappers = []interface{}{}
	file_chalk_server_v1_graph_proto_msgTypes[6].OneofWrappers = []interface{}{}
	file_chalk_server_v1_graph_proto_msgTypes[9].OneofWrappers = []interface{}{}
	type x struct{}
