...
type OfflineQueryRequestSerialized struct {
	...
	UnloadResolvers            []UnloadResolverSpecSerialized `json:"unload_resolvers,omitempty"`
	OverlayGraph               *string                        `json:"overlay_graph"`
}

// UnloadResolverSpecSerialized is the wire form of a resolver to unload. It matches
// chalkpy's encode_unload_resolvers output and CreateOfflineQueryJobRequest.unload_resolvers.
type UnloadResolverSpecSerialized struct {
	Fqn         string   `json:"fqn"`
